...
* [zigtools/zls](https://github.com/zigtools/zls) ⭐ 5,095 | 🐛 168 | 🌐 Zig | 📅 2026-08-14 - The @ziglang language server for all your Zig editor tooling needs, from autocomplete to goto-def! [installation](https://zigtools.org/zls/install/).
* [neurocyte/flow](https://github.com/neurocyte/flow) ⭐ 2,198 | 🐛 77 | 🌐 Zig | 📅 2026-08-29 - Flow Control - a programmer's text editor written in Zig.
...
* [mitchellh/zig-overlay](https://github.com/mitchellh/zig-overlay) ⭐ 542 | 🐛 10 | 🌐 Nix | 📅 2026-08-29 - Nix flake for the Zig compiler.
...
* [Cloudef/zig2nix](https://github.com/Cloudef/zig2nix) ⭐ 188 | 🐛 6 | 🌐 Zig | 📅 2026-08-29 - Flake for packaging, building and running Zig projects.
* [indaco/malt](https://github.com/indaco/malt) ⭐ 157 | 🐛 1 | 🌐 Zig | 📅 2026-08-29 - Homebrew's whole ecosystem, none of its weight: a single Zig binary with native post\_install and a themeable TUI and CLI.
...
* [ghostty](https://github.com/ghostty-org/ghostty) ⭐ 60,411 | 🐛 240 | 🌐 Zig | 📅 2026-08-28 - Modern terminal emulator written in Zig.
* [NilsIrl/dockerc](https://github.com/NilsIrl/dockerc) ⭐ 4,915 | 🐛 25 | 🌐 Zig | 📅 2025-01-02 - Container image to single executable compiler.
* [zmx](https://github.com/neurosnap/zmx) ⭐ 2,092 | 🐛 29 | 🌐 Zig | 📅 2026-08-27 - Session persistence for terminal processes.
...
* [dweiller/zimalloc](https://github.com/dweiller/zimalloc) ⭐ 48 | 🐛 7 | 🌐 Zig | 📅 2025-10-07 - A general purpose allocator for Zig, inspired by [mimalloc](https://github.com/microsoft/mimalloc) ⭐ 13,333 | 🐛 312 | 🌐 C | 📅 2026-08-28.
...
* [hello-algo-zig](https://github.com/codingonion/hello-algo-zig) ⭐ 82 | 🐛 0 | 🌐 Zig | 📅 2023-07-16 - Zig programming language codes for the famous public project [《Hello, Algorithm》|《 Hello，算法 》](https://github.com/krahets/hello-algo) ⭐ 129,666 | 🐛 42 | 🌐 Java | 📅 2026-08-17 about data structures and algorithms.
...
* [sam701/zig-cli](https://github.com/sam701/zig-cli) ⭐ 352 | 🐛 7 | 🌐 Zig | 📅 2026-06-11 - A simple package for building command line apps in Zig.
* [xcaeser/zli](https://github.com/xcaeser/zli) ⭐ 334 | 🐛 1 | 🌐 Zig | 📅 2026-08-19 - Zig command-line interfaces made easy. A blazing fast CLI framework. Build ergonomic, high-performance command-line tools with Zig.
...
* [ZigEmbeddedGroup/microzig](https://github.com/ZigEmbeddedGroup/microzig) ⭐ 2,266 | 🐛 79 | 🌐 Zig | 📅 2026-08-18 - Unified abstraction layer and HAL for several microcontrollers.
...
* [lupyuen/pinephone-nuttx](https://github.com/lupyuen/pinephone-nuttx) ⭐ 102 | 🐛 0 | 🌐 Zig | 📅 2026-08-29 - Apache NuttX RTOS for PinePhone. Apache NuttX is a lightweight Real-Time Operating System (RTOS) that runs on PINE64 PinePhone. [lupyuen.github.io/articles/what](https://lupyuen.github.io/articles/what).
...
* [Element 0](https://github.com/Element0Lang/element-0) ⭐ 29 | 🐛 3 | 🌐 Zig | 📅 2026-08-29 - A small embeddable Lisp dialect written in Zig.
...
* [zish](https://github.com/rotkonetworks/zish) ⭐ 7 | 🐛 0 | 🌐 Zig | 📅 2026-08-29 - An opinionated shell written in Zig.
...
* [sleep3r/mtproto.zig](https://github.com/sleep3r/mtproto.zig) ⭐ 1,483 | 🐛 0 | 🌐 Zig | 📅 2026-08-27 - High-performance Telegram MTProto proxy written in Zig.
...
* [muhammad-fiaz/httpx.zig](https://github.com/muhammad-fiaz/httpx.zig) ⭐ 86 | 🐛 5 | 🌐 Zig | 📅 2026-08-29 - Production-ready HTTP/1.x/2/3 client and server runtime for Zig with proxy support, concurrency, and protocol primitives.
...
* [lightpanda-io/browser](https://github.com/lightpanda-io/browser) ⭐ 34,307 | 🐛 99 | 🌐 Zig | 📅 2026-08-29 - Headless browser designed for AI and automation.
...
* [nurulhudaapon/zx](https://github.com/nurulhudaapon/zx) ⭐ 328 | 🐛 32 | 🌐 Zig | 📅 2026-08-13 - A full-stack web framework for Zig.
...
* [im-ng/zero](https://github.com/im-ng/zero) ⭐ 21 | 🐛 3 | 🌐 Zig | 📅 2026-08-29 - Simple and opinionated web framework written in Zig and aims to make microservices development in Zig easier.
...
* [blockblaz/ssz.zig](https://github.com/blockblaz/ssz.zig) ⭐ 34 | 🐛 16 | 🌐 Zig | 📅 2026-08-11 - A Zig implementation of the [SSZ serialization protocol](https://github.com/ethereum/eth2.0-specs/blob/dev/ssz/simple-serialize.md) ⭐ 3,958 | 🐛 64 | 🌐 Python | 📅 2026-08-28.
...
* [zwasm](https://github.com/zwasm/zwasm) ⭐ 170 | 🐛 52 | 🌐 Zig | 📅 2026-08-29 - From-scratch WebAssembly runtime in Zig. Full WebAssembly 3.0 with 100% spec conformance, WASI 0.1/0.2/0.3, and interpreter + JIT (arm64/x86\_64) + AOT backends.
...
* [tigerbeetle](https://github.com/tigerbeetle/tigerbeetle) ⭐ 16,925 | 🐛 107 | 🌐 Zig | 📅 2026-08-25 - The distributed financial accounting database designed for mission critical safety and performance. [tigerbeetle.com](https://tigerbeetle.com/).
...
* [seqor/seqor](https://github.com/seqor/seqor) ⭐ 59 | 🐛 1 | 🌐 Zig | 📅 2026-08-21 - Seqor is a cost-effective, Loki compatible database for logs.
...
* [zml](https://github.com/zml/zml) ⭐ 4,009 | 🐛 44 | 🌐 Zig | 📅 2026-08-29 - A high performance machine learning stack for Zig.
...
* [ggml-zig](https://github.com/codingonion/ggml-zig) - A replacement for [ggml: Tensor library for machine learning](https://github.com/ggerganov/ggml) ⭐ 15,256 | 🐛 351 | 🌐 C++ | 📅 2026-08-25 written in Zig.

### Large Language Model

* [nullclaw/nullclaw](https://github.com/nullclaw/nullclaw) ⭐ 8,052 | 🐛 93 | 🌐 Zig | 📅 2026-07-19 - Fastest, smallest, and fully autonomous AI assistant infrastructure written in Zig.
* [ddalcu/mlx-serve](https://github.com/ddalcu/mlx-serve) ⭐ 870 | 🐛 34 | 🌐 Zig | 📅 2026-08-29 - Native LLM inference server for Apple Silicon (MLX + GGUF) with OpenAI- and Anthropic-compatible APIs; ships MLX Core, a macOS menu-bar app. MIT.
...
* [EugenHotaj/zig\_gpt2](https://github.com/EugenHotaj/zig_gpt2) ⭐ 40 | 🐛 0 | 🌐 Zig | 📅 2023-07-24 - Neural Network Inference Engine in Zig. GPT2 inference engine written in Zig. The inference engine can run [NanoGPT](https://github.com/karpathy/nanoGPT) ⭐ 62,582 | 🐛 351 | 🌐 Python | 📅 2025-11-12.
...
* [anomalyco/opentui](https://github.com/anomalyco/opentui) ⭐ 13,176 | 🐛 138 | 🌐 TypeScript | 📅 2026-08-29 - A library for building terminal user interfaces.
* [rockorager/libvaxis](https://github.com/rockorager/libvaxis) ⭐ 1,981 | 🐛 35 | 🌐 Zig | 📅 2026-08-20 - Modern TUI library written in Zig.
...
* [meszmate/zigzag](https://github.com/meszmate/zigzag) ⭐ 532 | 🐛 1 | 🌐 Zig | 📅 2026-08-28 - The TUI Framework for Zig.
...
* [PixelGuys/Cubyz](https://github.com/PixelGuys/Cubyz) ⭐ 3,641 | 🐛 938 | 🌐 Zig | 📅 2026-08-28 - Voxel sandbox game with a large render distance, procedurally generated content and some cool graphical effects.
...
* [floooh/sokol-zig](https://github.com/floooh/sokol-zig) ⭐ 724 | 🐛 14 | 🌐 C | 📅 2026-08-28 - Zig bindings for the sokol headers.
...
* [raylib](https://github.com/raysan5/raylib/) ⭐ 34,498 | 🐛 13 | 🌐 C | 📅 2026-08-29 - A simple and easy-to-use library to enjoy videogames programming.
