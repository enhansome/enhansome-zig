...
* [zigtools/zls](https://github.com/zigtools/zls) ⭐ 5,077 | 🐛 158 | 🌐 Zig | 📅 2026-08-14 - The @ziglang language server for all your Zig editor tooling needs, from autocomplete to goto-def! [installation](https://zigtools.org/zls/install/).
* [neurocyte/flow](https://github.com/neurocyte/flow) ⭐ 2,179 | 🐛 81 | 🌐 Zig | 📅 2026-08-18 - Flow Control - a programmer's text editor written in Zig.
...
* [DonIsaac/zlint](https://github.com/DonIsaac/zlint) ⭐ 306 | 🐛 36 | 🌐 Zig | 📅 2026-08-17 - Linter for the Zig programming language.
* [KurtWagner/zlinter](https://github.com/KurtWagner/zlinter) ⭐ 90 | 🐛 9 | 🌐 Zig | 📅 2026-08-19 - Zig linter that is integrated from source into your `build.zig`.
...
* [sb2bg/marionette](https://github.com/sb2bg/marionette) ⭐ 74 | 🐛 1 | 🌐 Zig | 📅 2026-08-12 - Deterministic simulation testing for Zig with a `std.Io` implementation, letting you inject faults and replay failures from seeds.
...
* [justrach/nanobrew](https://github.com/justrach/nanobrew) ⭐ 1,104 | 🐛 8 | 🌐 Zig | 📅 2026-08-15 - A fast macOS package manager written in Zig.
...
* [mitchellh/zig-overlay](https://github.com/mitchellh/zig-overlay) ⭐ 537 | 🐛 10 | 🌐 Nix | 📅 2026-08-18 - Nix flake for the Zig compiler.
...
* [Cloudef/zig2nix](https://github.com/Cloudef/zig2nix) ⭐ 186 | 🐛 7 | 🌐 Zig | 📅 2026-08-19 - Flake for packaging, building and running Zig projects.
* [indaco/malt](https://github.com/indaco/malt) ⭐ 152 | 🐛 9 | 🌐 Zig | 📅 2026-08-18 - Homebrew's whole ecosystem, none of its weight: a single Zig binary with native post\_install and a themeable TUI and CLI.
...
* [asdf-community/asdf-zig](https://github.com/asdf-community/asdf-zig) ⭐ 81 | 🐛 0 | 🌐 Python | 📅 2026-08-14 - Zig plugin for the [asdf](https://github.com/asdf-vm/asdf) ⭐ 25,534 | 🐛 151 | 🌐 Go | 📅 2026-08-12 version manager.
...
* [ghostty](https://github.com/ghostty-org/ghostty) ⭐ 59,843 | 🐛 252 | 🌐 Zig | 📅 2026-08-19 - Modern terminal emulator written in Zig.
* [NilsIrl/dockerc](https://github.com/NilsIrl/dockerc) ⭐ 4,915 | 🐛 25 | 🌐 Zig | 📅 2025-01-02 - Container image to single executable compiler.
* [zmx](https://github.com/neurosnap/zmx) ⭐ 2,047 | 🐛 30 | 🌐 Zig | 📅 2026-08-19 - Session persistence for terminal processes.
* [Illusionna/LocalTransfer](https://github.com/Illusionna/LocalTransfer) ⭐ 563 | 🐛 0 | 🌐 Zig | 📅 2026-08-09 - A fast cross-platform HTTP file server.
...
* [zlist](https://github.com/here-Leslie-Lau/zlist) ⭐ 58 | 🐛 5 | 🌐 Zig | 📅 2026-08-18 - A simple, colorful alternative to ls built with Zig.
...
* [bare-devcontainer/templates](https://github.com/bare-devcontainer/templates/tree/main/src/zig) ⭐ 1 | 🐛 1 | 🌐 Shell | 📅 2026-08-19 - Security-focused Zig dev container with zls integration and a persistent build cache. The base image is available at [bare-devcontainer/images](https://github.com/bare-devcontainer/images/tree/main/zig) ⭐ 2 | 🐛 1 | 🌐 Dockerfile | 📅 2026-08-19.
...
* [andrewrk/poop](https://github.com/andrewrk/poop) ⭐ 2,026 | 🐛 29 | 🌐 Zig | 📅 2026-05-04 - CLI Performance Observer written in Zig.
...
* [dweiller/zimalloc](https://github.com/dweiller/zimalloc) ⭐ 48 | 🐛 7 | 🌐 Zig | 📅 2025-10-07 - A general purpose allocator for Zig, inspired by [mimalloc](https://github.com/microsoft/mimalloc) ⭐ 13,299 | 🐛 318 | 🌐 C | 📅 2026-08-19.
...
* [hello-algo-zig](https://github.com/codingonion/hello-algo-zig) ⭐ 82 | 🐛 0 | 🌐 Zig | 📅 2023-07-16 - Zig programming language codes for the famous public project [《Hello, Algorithm》|《 Hello，算法 》](https://github.com/krahets/hello-algo) ⭐ 129,470 | 🐛 42 | 🌐 Java | 📅 2026-08-17 about data structures and algorithms.
...
* [muhammad-fiaz/logly.zig](https://github.com/muhammad-fiaz/logly.zig) ⭐ 70 | 🐛 5 | 🌐 Zig | 📅 2026-08-07 - A modern, production-grade, high-performance structured logging library for Zig, built for speed and scalability.
...
* [ezequielramis/zimdjson](https://github.com/ezequielramis/zimdjson) ⭐ 171 | 🐛 8 | 🌐 Zig | 📅 2026-04-18 - Parsing gigabytes of JSON per second. Zig port of simdjson with fundamental features.
...
* [sam701/zig-toml](https://github.com/sam701/zig-toml) ⭐ 130 | 🐛 4 | 🌐 Zig | 📅 2026-08-07 - Zig TOML (v1.0.0) parser.
...
* [OrlovEvgeny/serde.zig](https://github.com/OrlovEvgeny/serde.zig) ⭐ 81 | 🐛 3 | 🌐 Zig | 📅 2026-08-11 - Comptime serialization framework for Zig supporting JSON, MessagePack, TOML, YAML, ZON, and CSV.
...
* [rockorager/zeit](https://github.com/rockorager/zeit) ⭐ 230 | 🐛 5 | 🌐 Zig | 📅 2026-08-17 - Generic date/time library, including time zone loading and conversion.
...
* [Hejsil/zig-clap](https://github.com/Hejsil/zig-clap) ⭐ 1,603 | 🐛 7 | 🌐 Zig | 📅 2026-06-13 - A simple and easy to use command line argument parser library for Zig.
* [sam701/zig-cli](https://github.com/sam701/zig-cli) ⭐ 349 | 🐛 7 | 🌐 Zig | 📅 2026-06-11 - A simple package for building command line apps in Zig.
* [xcaeser/zli](https://github.com/xcaeser/zli) ⭐ 332 | 🐛 1 | 🌐 Zig | 📅 2026-07-03 - Zig command-line interfaces made easy. A blazing fast CLI framework. Build ergonomic, high-performance command-line tools with Zig.
...
* [jiacai2050/zigcli](https://github.com/jiacai2050/zigcli) ⭐ 137 | 🐛 8 | 🌐 Zig | 📅 2026-07-19 - A toolkit for building command lines programs in Zig.
...
* [mitchellh/libxev](https://github.com/mitchellh/libxev) ⭐ 3,559 | 🐛 56 | 🌐 Zig | 📅 2026-07-17 - A cross-platform, high-performance event loop that provides abstractions for non-blocking IO, timers, events, and more and works on Linux (io\_uring or epoll), macOS (kqueue), and WebAssembly + WASI. Available as both a Zig and C API.
...
* [ZigEmbeddedGroup/microzig](https://github.com/ZigEmbeddedGroup/microzig) ⭐ 2,255 | 🐛 77 | 🌐 Zig | 📅 2026-08-18 - Unified abstraction layer and HAL for several microcontrollers.
...
* [lupyuen/pinephone-nuttx](https://github.com/lupyuen/pinephone-nuttx) ⭐ 102 | 🐛 0 | 🌐 Zig | 📅 2026-08-19 - Apache NuttX RTOS for PinePhone. Apache NuttX is a lightweight Real-Time Operating System (RTOS) that runs on PINE64 PinePhone. [lupyuen.github.io/articles/what](https://lupyuen.github.io/articles/what).
...
* [Aro](https://github.com/Vexu/arocc) ⭐ 1,798 | 🐛 47 | 🌐 Zig | 📅 2026-08-18 - A C compiler with the goal of providing fast compilation and low memory usage with good diagnostics.
* [buzz](https://github.com/buzz-language/buzz) ⭐ 1,524 | 🐛 80 | 🌐 Zig | 📅 2026-08-18 - A small/lightweight statically typed scripting language.
...
* [karlseguin/http.zig](https://github.com/karlseguin/http.zig) ⭐ 1,586 | 🐛 15 | 🌐 Zig | 📅 2026-08-12 - An HTTP/1.1 server for Zig.
* [sleep3r/mtproto.zig](https://github.com/sleep3r/mtproto.zig) ⭐ 1,050 | 🐛 3 | 🌐 Zig | 📅 2026-08-04 - High-performance Telegram MTProto proxy written in Zig.
* [tardy-org/zzz](https://github.com/tardy-org/zzz) ⭐ 771 | 🐛 16 | 🌐 Zig | 📅 2026-08-18 - A framework for writing performant and reliable networked services in Zig. Supports HTTP and HTTPS.
...
* [muhammad-fiaz/httpx.zig](https://github.com/muhammad-fiaz/httpx.zig) ⭐ 82 | 🐛 4 | 🌐 Zig | 📅 2026-08-18 - Production-ready HTTP/1.x/2/3 client and server runtime for Zig with proxy support, concurrency, and protocol primitives.
...
* [zig-nostr/nostr](https://github.com/zig-nostr/nostr) ⭐ 8 | 🐛 5 | 🌐 Zig | 📅 2026-08-15 - The Nostr protocol natively in Zig: secp256k1/Schnorr keys, events, relay transport with the outbox model, a local-first LMDB event store, NIP-46 remote signing, and more.
...
* [lightpanda-io/browser](https://github.com/lightpanda-io/browser) ⭐ 34,088 | 🐛 84 | 🌐 Zig | 📅 2026-08-19 - Headless browser designed for AI and automation.

### Web Framework

* [zigzap/zap](https://github.com/zigzap/zap) ⭐ 3,404 | 🐛 28 | 🌐 C | 📅 2026-06-01 - Blazingly fast web backends in Zig.
* [kristoff-it/zine](https://github.com/kristoff-it/zine) ⭐ 1,530 | 🐛 52 | 🌐 Zig | 📅 2026-08-12 - Static Site Generator written in Zig.
* [jetzig-framework/jetzig](https://github.com/jetzig-framework/jetzig) ⭐ 1,506 | 🐛 40 | 🌐 Zig | 📅 2026-06-12 - Jetzig is a web framework written in Zig.
* [cztomsik/tokamak](https://github.com/cztomsik/tokamak) ⭐ 631 | 🐛 5 | 🌐 Zig | 📅 2026-08-18 - Web framework that leverages dependency injection for clean, modular application development.
...
* [nurulhudaapon/zx](https://github.com/nurulhudaapon/zx) ⭐ 318 | 🐛 28 | 🌐 Zig | 📅 2026-08-13 - A full-stack web framework for Zig.
...
* [llllOllOOll/spider](https://github.com/llllOllOOll/spider) ⭐ 47 | 🐛 0 | 🌐 C | 📅 2026-08-07 - A web framework for Zig with a focus on ergonomics and performance.
...
* [blockblaz/ssz.zig](https://github.com/blockblaz/ssz.zig) ⭐ 34 | 🐛 15 | 🌐 Zig | 📅 2026-08-11 - A Zig implementation of the [SSZ serialization protocol](https://github.com/ethereum/eth2.0-specs/blob/dev/ssz/simple-serialize.md) ⭐ 3,958 | 🐛 64 | 🌐 Python | 📅 2026-08-18.
...
* [zwasm](https://github.com/zwasm/zwasm) ⭐ 162 | 🐛 3 | 🌐 Zig | 📅 2026-08-19 - From-scratch WebAssembly runtime in Zig. Full WebAssembly 3.0 with 100% spec conformance, WASI 0.1/0.2/0.3, and interpreter + JIT (arm64/x86\_64) + AOT backends.
...
* [tigerbeetle](https://github.com/tigerbeetle/tigerbeetle) ⭐ 16,840 | 🐛 125 | 🌐 Zig | 📅 2026-08-18 - The distributed financial accounting database designed for mission critical safety and performance. [tigerbeetle.com](https://tigerbeetle.com/).
* [vrischmann/zig-sqlite](https://github.com/vrischmann/zig-sqlite) ⭐ 617 | 🐛 5 | 🌐 C | 📅 2026-07-24 - Zig-SQLite is a small wrapper around SQLite's C API, making it easier to use with Zig.
...
* [speed2exe/myzql](https://github.com/speed2exe/myzql) ⭐ 74 | 🐛 5 | 🌐 Zig | 📅 2026-06-18 - MySQL and MariaDB driver in native Zig.
...
* [zml](https://github.com/zml/zml) ⭐ 3,988 | 🐛 39 | 🌐 Zig | 📅 2026-08-19 - A high performance machine learning stack for Zig.
...
* [ggml-zig](https://github.com/codingonion/ggml-zig) - A replacement for [ggml: Tensor library for machine learning](https://github.com/ggerganov/ggml) ⭐ 15,196 | 🐛 347 | 🌐 C++ | 📅 2026-08-18 written in Zig.

### Large Language Model

* [nullclaw/nullclaw](https://github.com/nullclaw/nullclaw) ⭐ 8,031 | 🐛 86 | 🌐 Zig | 📅 2026-07-19 - Fastest, smallest, and fully autonomous AI assistant infrastructure written in Zig.
* [ddalcu/mlx-serve](https://github.com/ddalcu/mlx-serve) ⭐ 741 | 🐛 31 | 🌐 Zig | 📅 2026-08-19 - Native LLM inference server for Apple Silicon (MLX + GGUF) with OpenAI- and Anthropic-compatible APIs; ships MLX Core, a macOS menu-bar app. MIT.
...
* [EugenHotaj/zig\_gpt2](https://github.com/EugenHotaj/zig_gpt2) ⭐ 39 | 🐛 0 | 🌐 Zig | 📅 2023-07-24 - Neural Network Inference Engine in Zig. GPT2 inference engine written in Zig. The inference engine can run [NanoGPT](https://github.com/karpathy/nanoGPT) ⭐ 62,202 | 🐛 351 | 🌐 Python | 📅 2025-11-12.
...
* [Snektron/vulkan-zig](https://github.com/Snektron/vulkan-zig) ⭐ 899 | 🐛 24 | 🌐 Zig | 📅 2026-08-18 - Vulkan binding generator for Zig.
...
* [anomalyco/opentui](https://github.com/anomalyco/opentui) ⭐ 13,075 | 🐛 217 | 🌐 TypeScript | 📅 2026-08-19 - A library for building terminal user interfaces.
* [rockorager/libvaxis](https://github.com/rockorager/libvaxis) ⭐ 1,963 | 🐛 36 | 🌐 Zig | 📅 2026-08-18 - Modern TUI library written in Zig.
...
* [fabioarnold/nanovg-zig](https://github.com/fabioarnold/nanovg-zig) ⭐ 246 | 🐛 1 | 🌐 C | 📅 2026-01-29 - [NanoVG](https://github.com/memononen/nanovg) ⭐ 5,691 | 🐛 321 | 🌐 C | 📅 2026-02-19 - Zig Version. A small anti-aliased hardware-accelerated vector graphics library. [fabioarnold.github.io/nanovg-zig/](https://fabioarnold.github.io/nanovg-zig/).
...
* [david-vanderson/dvui](https://github.com/david-vanderson/dvui) ⭐ 1,632 | 🐛 98 | 🌐 Zig | 📅 2026-08-19 - Easy to Integrate Immediate Mode GUI for Zig.
...
* [meszmate/zigzag](https://github.com/meszmate/zigzag) ⭐ 516 | 🐛 0 | 🌐 Zig | 📅 2026-08-14 - The TUI Framework for Zig.
* [rcalixte/libqt6zig](https://github.com/rcalixte/libqt6zig) ⭐ 261 | 🐛 0 | 🌐 Zig | 📅 2026-08-12 - Qt 6 for Zig.
...
* [Mach](https://github.com/hexops/mach) ⭐ 4,824 | 🐛 167 | 🌐 Zig | 📅 2026-05-23 - A game engine & graphics toolkit for the future. machengine.org.
* [PixelGuys/Cubyz](https://github.com/PixelGuys/Cubyz) ⭐ 3,616 | 🐛 949 | 🌐 Zig | 📅 2026-08-17 - Voxel sandbox game with a large render distance, procedurally generated content and some cool graphical effects.
* [zig-gamedev/zig-gamedev](https://github.com/zig-gamedev/zig-gamedev) ⭐ 2,861 | 🐛 37 | 🌐 Zig | 📅 2026-03-08 - Building game development ecosystem for @ziglang.
...
* [zigimg/zigimg](https://github.com/zigimg/zigimg) ⭐ 834 | 🐛 48 | 🌐 Zig | 📅 2026-08-18 - Zig library for reading and writing different image formats.
* [freref/fancy-cat](https://github.com/freref/fancy-cat) ⭐ 555 | 🐛 20 | 🌐 Zig | 📅 2026-08-03 - PDF reader inside the terminal.
...
* [floooh/sokol-zig](https://github.com/floooh/sokol-zig) ⭐ 719 | 🐛 13 | 🌐 C | 📅 2026-08-18 - Zig bindings for the sokol headers.
...
* [raylib](https://github.com/raysan5/raylib/) ⭐ 34,391 | 🐛 31 | 🌐 C | 📅 2026-08-18 - A simple and easy-to-use library to enjoy videogames programming.
...
* [FFmpeg](https://github.com/andrewrk/ffmpeg) ⭐ 316 | 🐛 6 | 🌐 C | 📅 2026-08-14 - Library FFmpeg with the build system replaced by Zig.
