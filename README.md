...
* [zigtools/zls](https://github.com/zigtools/zls) ⭐ 5,145 | 🐛 170 | 🌐 Zig | 📅 2026-09-11 - The @ziglang language server for all your Zig editor tooling needs, from autocomplete to goto-def! [installation](https://zigtools.org/zls/install/).
* [neurocyte/flow](https://github.com/neurocyte/flow) ⭐ 2,417 | 🐛 79 | 🌐 Zig | 📅 2026-09-22 - Flow Control - a programmer's text editor written in Zig.
* [zed-extensions/Zig](https://github.com/zed-extensions/zig) ⭐ 90 | 🐛 15 | 🌐 Rust | 📅 2026-06-07 - Zig extension for Zed editor.
...
* [sb2bg/marionette](https://github.com/sb2bg/marionette) ⭐ 87 | 🐛 1 | 🌐 Zig | 📅 2026-09-22 - Deterministic simulation testing for Zig with a `std.Io` implementation, letting you inject faults and replay failures from seeds.
...
* [justrach/nanobrew](https://github.com/justrach/nanobrew) ⭐ 1,122 | 🐛 3 | 🌐 Zig | 📅 2026-09-21 - A fast macOS package manager written in Zig.
* [tristanisham/zvm](https://github.com/tristanisham/zvm) ⭐ 1,065 | 🐛 3 | 🌐 Go | 📅 2026-09-20 - Lets you easily install/upgrade between different versions of Zig. ZLS install can be included. (written in Go).
* [nektro/zigmod](https://github.com/nektro/zigmod) ⭐ 947 | 🐛 18 | 🌐 Zig | 📅 2026-09-04 - A package manager for the Zig programming language.
* [mitchellh/zig-overlay](https://github.com/mitchellh/zig-overlay) ⭐ 548 | 🐛 10 | 🌐 Nix | 📅 2026-09-22 - Nix flake for the Zig compiler.
...
* [Cloudef/zig2nix](https://github.com/Cloudef/zig2nix) ⭐ 191 | 🐛 7 | 🌐 Zig | 📅 2026-09-22 - Flake for packaging, building and running Zig projects.
* [indaco/malt](https://github.com/indaco/malt) ⭐ 168 | 🐛 1 | 🌐 Zig | 📅 2026-09-22 - Homebrew's whole ecosystem, none of its weight: a single Zig binary with native post\_install and a themeable TUI and CLI.
...
* [asdf-community/asdf-zig](https://github.com/asdf-community/asdf-zig) ⭐ 82 | 🐛 1 | 🌐 Python | 📅 2026-08-14 - Zig plugin for the [asdf](https://github.com/asdf-vm/asdf) ⭐ 25,594 | 🐛 149 | 🌐 Go | 📅 2026-09-22 version manager.
...
* [ghostty](https://github.com/ghostty-org/ghostty) ⭐ 61,422 | 🐛 249 | 🌐 Zig | 📅 2026-09-22 - Modern terminal emulator written in Zig.
* [NilsIrl/dockerc](https://github.com/NilsIrl/dockerc) ⭐ 4,918 | 🐛 25 | 🌐 Zig | 📅 2025-01-02 - Container image to single executable compiler.
* [zmx](https://github.com/neurosnap/zmx) ⭐ 2,160 | 🐛 30 | 🌐 Zig | 📅 2026-09-19 - Session persistence for terminal processes.
* [Illusionna/LocalTransfer](https://github.com/Illusionna/LocalTransfer) ⭐ 612 | 🐛 1 | 🌐 Zig | 📅 2026-09-03 - A fast cross-platform HTTP file server.
...
* [midasdf/zt](https://github.com/midasdf/zt) ⭐ 70 | 🐛 0 | 🌐 Zig | 📅 2026-07-04 - Ultra-fast, minimal terminal emulator written in Zig with fbdev, X11, Wayland, and macOS backends.
...
* [mtxr/claude-switch](https://github.com/mtxr/claude-switch) ⭐ 8 | 🐛 0 | 🌐 Zig | 📅 2026-06-11 - Swap between Claude (Code + Desktop) accounts on macOS with a single command. Credentials stored securely in macOS Keychain. Fully offline.
...
* [bare-devcontainer/templates](https://github.com/bare-devcontainer/templates/tree/main/src/zig) ⭐ 1 | 🐛 1 | 🌐 Shell | 📅 2026-09-21 - Security-focused Zig dev container with zls integration and a persistent build cache. The base image is available at [bare-devcontainer/images](https://github.com/bare-devcontainer/images/tree/main/zig) ⭐ 2 | 🐛 2 | 🌐 Shell | 📅 2026-09-22.
...
* [deatil/zig-rsa](https://github.com/deatil/zig-rsa) ⭐ 0 | 🐛 0 | 🌐 Zig | 📅 2026-09-22 - An RSA library for Zig. No-AI.
...
* [dweiller/zimalloc](https://github.com/dweiller/zimalloc) ⭐ 48 | 🐛 7 | 🌐 Zig | 📅 2025-10-07 - A general purpose allocator for Zig, inspired by [mimalloc](https://github.com/microsoft/mimalloc) ⭐ 13,391 | 🐛 298 | 🌐 C | 📅 2026-09-22.
...
* [hello-algo-zig](https://github.com/codingonion/hello-algo-zig) ⭐ 82 | 🐛 0 | 🌐 Zig | 📅 2023-07-16 - Zig programming language codes for the famous public project [《Hello, Algorithm》|《 Hello，算法 》](https://github.com/krahets/hello-algo) ⭐ 130,374 | 🐛 40 | 🌐 Java | 📅 2026-08-17 about data structures and algorithms.
...
* [tree-sitter/zig-tree-sitter](https://github.com/tree-sitter/zig-tree-sitter) ⭐ 124 | 🐛 0 | 🌐 Zig | 📅 2026-06-27 - Zig bindings to the [Tree-sitter](https://tree-sitter.github.io/zig-tree-sitter/) parsing library.
...
* [muhammad-fiaz/logly.zig](https://github.com/muhammad-fiaz/logly.zig) ⭐ 69 | 🐛 6 | 🌐 Zig | 📅 2026-09-13 - A modern, production-grade, high-performance structured logging library for Zig, built for speed and scalability.
...
* [OrlovEvgeny/serde.zig](https://github.com/OrlovEvgeny/serde.zig) ⭐ 85 | 🐛 4 | 🌐 Zig | 📅 2026-09-15 - Comptime serialization framework for Zig supporting JSON, MessagePack, TOML, YAML, ZON, and CSV.
...
* [zoptia/zoptia0regex](https://github.com/zoptia/zoptia0regex) ⭐ 6 | 🐛 0 | 🌐 Zig | 📅 2026-09-15 - A regular-expression (regex) library — a faithful, linear-time port of Go's regexp (RE2), proven byte-for-byte identical to Go via \~30k differential tests.
...
* [pedronaugusto/strand](https://github.com/pedronaugusto/strand) ⭐ 0 | 🐛 0 | 🌐 Zig | 📅 2026-09-20 - Typed JSON Lines for Zig: one JSON value per line, read and written for append-only logs, line protocols and event streams. AI-assisted.
...
* [scento/zig-date](https://github.com/scento/zig-date) ⭐ 7 | 🐛 0 | 🌐 Zig | 📅 2023-03-26 - Time and date for Zig. Zig-date is a date and time library for the Zig, inspired by the popular Rust library [chrono](https://github.com/chronotope/chrono) ⭐ 3,911 | 🐛 193 | 🌐 Rust | 📅 2026-09-07.
...
* [mitchellh/libxev](https://github.com/mitchellh/libxev) ⭐ 3,580 | 🐛 67 | 🌐 Zig | 📅 2026-07-17 - A cross-platform, high-performance event loop that provides abstractions for non-blocking IO, timers, events, and more and works on Linux (io\_uring or epoll), macOS (kqueue), and WebAssembly + WASI. Available as both a Zig and C API.
...
* [ZigEmbeddedGroup/microzig](https://github.com/ZigEmbeddedGroup/microzig) ⭐ 2,282 | 🐛 82 | 🌐 Zig | 📅 2026-09-19 - Unified abstraction layer and HAL for several microcontrollers.
...
* [lupyuen/pinephone-nuttx](https://github.com/lupyuen/pinephone-nuttx) ⭐ 102 | 🐛 0 | 🌐 Zig | 📅 2026-09-22 - Apache NuttX RTOS for PinePhone. Apache NuttX is a lightweight Real-Time Operating System (RTOS) that runs on PINE64 PinePhone. [lupyuen.github.io/articles/what](https://lupyuen.github.io/articles/what).
...
* [pedronaugusto/conduit](https://github.com/pedronaugusto/conduit) ⭐ 0 | 🐛 0 | 🌐 Zig | 📅 2026-09-20 - Starts child processes and gives them pseudo-terminals, on a pty in their own session with a window size, or on pipes killed and reaped with a deadline. AI-assisted.
* [pedronaugusto/lookout](https://github.com/pedronaugusto/lookout) ⭐ 0 | 🐛 0 | 🌐 Zig | 📅 2026-09-20 - A file-system watcher for Zig: one Watcher type over each platform's own notification interface, and a polling backend that needs nothing from the kernel. AI-assisted.
* [javiorfo/zig-syslinfo](https://github.com/javiorfo/zig-syslinfo) - Linux sysinfo Zig library.

### Compilers and Interpreters

* [Aro](https://github.com/Vexu/arocc) ⭐ 1,806 | 🐛 47 | 🌐 Zig | 📅 2026-09-16 - A C compiler with the goal of providing fast compilation and low memory usage with good diagnostics.
...
* [Fun](https://github.com/omdxp/fun) ⭐ 326 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-20 - A statically-typed language that transpiles to C, combining safety and performance with C's efficiency.
...
* [zish](https://github.com/rotkonetworks/zish) ⭐ 8 | 🐛 4 | 🌐 Zig | 📅 2026-09-12 - An opinionated shell written in Zig.
...
* [sleep3r/mtproto.zig](https://github.com/sleep3r/mtproto.zig) ⭐ 1,945 | 🐛 5 | 🌐 Zig | 📅 2026-09-18 - High-performance Telegram MTProto proxy written in Zig.
...
* [muhammad-fiaz/httpx.zig](https://github.com/muhammad-fiaz/httpx.zig) ⭐ 90 | 🐛 3 | 🌐 Zig | 📅 2026-09-15 - Production-ready HTTP/1.x/2/3 client and server runtime for Zig with proxy support, concurrency, and protocol primitives.
...
* [zig-nostr/nostr](https://github.com/zig-nostr/nostr) ⭐ 9 | 🐛 2 | 🌐 Zig | 📅 2026-09-21 - The Nostr protocol natively in Zig: secp256k1/Schnorr keys, events, relay transport with the outbox model, a local-first LMDB event store, NIP-46 remote signing, and more.
...
* [lightpanda-io/browser](https://github.com/lightpanda-io/browser) ⭐ 35,507 | 🐛 74 | 🌐 Zig | 📅 2026-09-22 - Headless browser designed for AI and automation.
...
* [zon-dev/zinc](https://github.com/zon-dev/zinc) ⭐ 187 | 🐛 2 | 🌐 Zig | 📅 2026-09-20 - Zinc is a web framework written in pure Zig with a focus on high performance, usability, security, and extensibility.
...
* [im-ng/zero](https://github.com/im-ng/zero) ⭐ 31 | 🐛 2 | 🌐 Zig | 📅 2026-09-22 - Simple and opinionated web framework written in Zig and aims to make microservices development in Zig easier.
...
* [StrobeLabs/eth.zig](https://github.com/StrobeLabs/eth.zig) ⭐ 85 | 🐛 28 | 🌐 C | 📅 2026-09-11 - Pure Zig Ethereum client library. Zero dependencies, comptime-first.
...
* [blockblaz/ssz.zig](https://github.com/blockblaz/ssz.zig) ⭐ 34 | 🐛 17 | 🌐 Zig | 📅 2026-09-01 - A Zig implementation of the [SSZ serialization protocol](https://github.com/ethereum/eth2.0-specs/blob/dev/ssz/simple-serialize.md) ⭐ 3,966 | 🐛 66 | 🌐 Python | 📅 2026-09-21.
...
* [zwasm](https://github.com/zwasm/zwasm) ⭐ 179 | 🐛 59 | 🌐 Zig | 📅 2026-09-22 - From-scratch WebAssembly runtime in Zig. Full WebAssembly 3.0 with 100% spec conformance, WASI 0.1/0.2/0.3, and interpreter + JIT (arm64/x86\_64) + AOT backends.
...
* [tigerbeetle](https://github.com/tigerbeetle/tigerbeetle) ⭐ 17,070 | 🐛 114 | 🌐 Zig | 📅 2026-08-31 - The distributed financial accounting database designed for mission critical safety and performance. [tigerbeetle.com](https://tigerbeetle.com/).
...
* [karlseguin/pg.zig](https://github.com/karlseguin/pg.zig) ⭐ 599 | 🐛 4 | 🌐 Zig | 📅 2026-09-18 - Native PostgreSQL driver / client for Zig.
...
* [seqor/seqor](https://github.com/seqor/seqor) ⭐ 63 | 🐛 1 | 🌐 Zig | 📅 2026-09-16 - Seqor is a cost-effective, Loki compatible database for logs.
...
* [pedronaugusto/chronicle](https://github.com/pedronaugusto/chronicle) ⭐ 0 | 🐛 0 | 🌐 Zig | 📅 2026-09-20 - An append-only event log for Zig, where a journal is a directory of segment files holding one JSON object per line. AI-assisted.
...
* [zml](https://github.com/zml/zml) ⭐ 4,074 | 🐛 54 | 🌐 Zig | 📅 2026-09-22 - A high performance machine learning stack for Zig.
...
* [ggml-zig](https://github.com/codingonion/ggml-zig) - A replacement for [ggml: Tensor library for machine learning](https://github.com/ggerganov/ggml) ⭐ 15,389 | 🐛 364 | 🌐 C++ | 📅 2026-09-22 written in Zig.

### Large Language Model

* [nullclaw/nullclaw](https://github.com/nullclaw/nullclaw) ⭐ 8,103 | 🐛 96 | 🌐 Zig | 📅 2026-07-19 - Fastest, smallest, and fully autonomous AI assistant infrastructure written in Zig.
* [ddalcu/mlx-serve](https://github.com/ddalcu/mlx-serve) ⭐ 1,479 | 🐛 65 | 🌐 Zig | 📅 2026-09-22 - Native LLM inference server for Apple Silicon (MLX + GGUF) with OpenAI- and Anthropic-compatible APIs; ships MLX Core, a macOS menu-bar app. MIT.
...
* [EugenHotaj/zig\_gpt2](https://github.com/EugenHotaj/zig_gpt2) ⭐ 40 | 🐛 0 | 🌐 Zig | 📅 2023-07-24 - Neural Network Inference Engine in Zig. GPT2 inference engine written in Zig. The inference engine can run [NanoGPT](https://github.com/karpathy/nanoGPT) ⭐ 63,312 | 🐛 349 | 🌐 Python | 📅 2025-11-12.
...
* [Snektron/vulkan-zig](https://github.com/Snektron/vulkan-zig) ⭐ 912 | 🐛 24 | 🌐 Zig | 📅 2026-08-30 - Vulkan binding generator for Zig.
...
* [anomalyco/opentui](https://github.com/anomalyco/opentui) ⭐ 13,363 | 🐛 150 | 🌐 TypeScript | 📅 2026-09-22 - A library for building terminal user interfaces.
* [rockorager/libvaxis](https://github.com/rockorager/libvaxis) ⭐ 2,010 | 🐛 33 | 🌐 Zig | 📅 2026-09-08 - Modern TUI library written in Zig.
* [ziglibs/zgl](https://github.com/ziglibs/zgl) ⭐ 626 | 🐛 4 | 🌐 Zig | 📅 2026-05-26 - Zig OpenGL Wrapper.
...
* [vancluever/z2d](https://github.com/vancluever/z2d) ⭐ 302 | 🐛 10 | 🌐 Zig | 📅 2026-09-19 - A pure Zig 2D graphics library.
...
* [fabioarnold/nanovg-zig](https://github.com/fabioarnold/nanovg-zig) ⭐ 246 | 🐛 1 | 🌐 C | 📅 2026-01-29 - [NanoVG](https://github.com/memononen/nanovg) ⭐ 5,705 | 🐛 321 | 🌐 C | 📅 2026-02-19 - Zig Version. A small anti-aliased hardware-accelerated vector graphics library. [fabioarnold.github.io/nanovg-zig/](https://fabioarnold.github.io/nanovg-zig/).
...
* [david-vanderson/dvui](https://github.com/david-vanderson/dvui) ⭐ 1,668 | 🐛 105 | 🌐 Zig | 📅 2026-09-21 - Easy to Integrate Immediate Mode GUI for Zig.
* [webui-dev/zig-webui](https://github.com/webui-dev/zig-webui) ⭐ 832 | 🐛 10 | 🌐 Zig | 📅 2026-08-03 - Use any web browser or WebView as GUI, with your preferred language in the backend and HTML5 in the frontend, all in a lightweight portable lib.
* [meszmate/zigzag](https://github.com/meszmate/zigzag) ⭐ 559 | 🐛 8 | 🌐 Zig | 📅 2026-09-03 - The TUI Framework for Zig.
* [rcalixte/libqt6zig](https://github.com/rcalixte/libqt6zig) ⭐ 268 | 🐛 0 | 🌐 Zig | 📅 2026-09-18 - Qt 6 for Zig.
...
* [Mach](https://github.com/hexops/mach) ⭐ 4,842 | 🐛 167 | 🌐 Zig | 📅 2026-05-23 - A game engine & graphics toolkit for the future. machengine.org.
* [PixelGuys/Cubyz](https://github.com/PixelGuys/Cubyz) ⭐ 3,668 | 🐛 910 | 🌐 Zig | 📅 2026-09-20 - Voxel sandbox game with a large render distance, procedurally generated content and some cool graphical effects.
...
* [dmtrKovalenko/odiff](https://github.com/dmtrKovalenko/odiff) ⭐ 3,205 | 🐛 15 | 🌐 Zig | 📅 2026-08-24 - ODiff - A very fast SIMD-first image comparison library (with Node.js API).
* [zigimg/zigimg](https://github.com/zigimg/zigimg) ⭐ 841 | 🐛 50 | 🌐 Zig | 📅 2026-09-08 - Zig library for reading and writing different image formats.
* [freref/fancy-cat](https://github.com/freref/fancy-cat) ⭐ 562 | 🐛 20 | 🌐 Zig | 📅 2026-08-03 - PDF reader inside the terminal.
* [bfactory-ai/zignal](https://github.com/bfactory-ai/zignal) ⭐ 461 | 🐛 0 | 🌐 Zig | 📅 2026-09-21 - Image processing library in Zig, heavily inspired by dlib.
...
* [fulcrum-so/ziggy-pydust](https://github.com/fulcrum-so/ziggy-pydust) ⭐ 790 | 🐛 46 | 🌐 Zig | 📅 2026-09-21 - A toolkit for building Python extensions in Zig. [pydust.fulcrum.so/](https://pydust.fulcrum.so/).
...
* [mitchellh/zig-objc](https://github.com/mitchellh/zig-objc) ⭐ 350 | 🐛 4 | 🌐 Zig | 📅 2026-04-17 - Objective-C runtime bindings for Zig (Zig calling ObjC).
...
* [happystraw/phpz](https://github.com/happystraw/phpz) ⭐ 5 | 🐛 5 | 🌐 Zig | 📅 2026-09-16 - Build PHP extensions with Zig.
...
* [raylib](https://github.com/raysan5/raylib/) ⭐ 34,819 | 🐛 14 | 🌐 C | 📅 2026-09-22 - A simple and easy-to-use library to enjoy videogames programming.
