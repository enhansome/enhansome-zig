...
* [Zigistry/Zigistry](https://github.com/Zigistry/Zigistry) ⭐ 706 | 🐛 6 | 🌐 Svelte | 📅 2026-09-16 - A place where you can find all the libraries that suit your Zig lang needs.
...
* [zigtools/zls](https://github.com/zigtools/zls) ⭐ 5,139 | 🐛 169 | 🌐 Zig | 📅 2026-09-11 - The @ziglang language server for all your Zig editor tooling needs, from autocomplete to goto-def! [installation](https://zigtools.org/zls/install/).
* [neurocyte/flow](https://github.com/neurocyte/flow) ⭐ 2,404 | 🐛 79 | 🌐 Zig | 📅 2026-09-18 - Flow Control - a programmer's text editor written in Zig.
...
* [KurtWagner/zlinter](https://github.com/KurtWagner/zlinter) ⭐ 96 | 🐛 5 | 🌐 Zig | 📅 2026-09-16 - Zig linter that is integrated from source into your `build.zig`.
...
* [mstdokumaci/zsort](https://github.com/mstdokumaci/zsort) ⭐ 24 | 🐛 1 | 🌐 Zig | 📅 2026-08-11 - Import sorter/organizer with pre-commit hook support.

### Documentation and Testing

* [sb2bg/marionette](https://github.com/sb2bg/marionette) ⭐ 86 | 🐛 1 | 🌐 Zig | 📅 2026-09-08 - Deterministic simulation testing for Zig with a `std.Io` implementation, letting you inject faults and replay failures from seeds.
...
* [justrach/nanobrew](https://github.com/justrach/nanobrew) ⭐ 1,122 | 🐛 3 | 🌐 Zig | 📅 2026-09-18 - A fast macOS package manager written in Zig.
...
* [mitchellh/zig-overlay](https://github.com/mitchellh/zig-overlay) ⭐ 548 | 🐛 10 | 🌐 Nix | 📅 2026-09-20 - Nix flake for the Zig compiler.
...
* [Cloudef/zig2nix](https://github.com/Cloudef/zig2nix) ⭐ 191 | 🐛 7 | 🌐 Zig | 📅 2026-09-20 - Flake for packaging, building and running Zig projects.
* [indaco/malt](https://github.com/indaco/malt) ⭐ 167 | 🐛 0 | 🌐 Zig | 📅 2026-09-20 - Homebrew's whole ecosystem, none of its weight: a single Zig binary with native post\_install and a themeable TUI and CLI.
...
* [asdf-community/asdf-zig](https://github.com/asdf-community/asdf-zig) ⭐ 82 | 🐛 1 | 🌐 Python | 📅 2026-08-14 - Zig plugin for the [asdf](https://github.com/asdf-vm/asdf) ⭐ 25,592 | 🐛 146 | 🌐 Go | 📅 2026-09-03 version manager.
...
* [ghostty](https://github.com/ghostty-org/ghostty) ⭐ 61,345 | 🐛 250 | 🌐 Zig | 📅 2026-09-20 - Modern terminal emulator written in Zig.
* [NilsIrl/dockerc](https://github.com/NilsIrl/dockerc) ⭐ 4,918 | 🐛 25 | 🌐 Zig | 📅 2025-01-02 - Container image to single executable compiler.
* [zmx](https://github.com/neurosnap/zmx) ⭐ 2,156 | 🐛 27 | 🌐 Zig | 📅 2026-09-19 - Session persistence for terminal processes.
* [Illusionna/LocalTransfer](https://github.com/Illusionna/LocalTransfer) ⭐ 606 | 🐛 0 | 🌐 Zig | 📅 2026-09-03 - A fast cross-platform HTTP file server.
...
* [bare-devcontainer/templates](https://github.com/bare-devcontainer/templates/tree/main/src/zig) ⭐ 1 | 🐛 1 | 🌐 Shell | 📅 2026-09-20 - Security-focused Zig dev container with zls integration and a persistent build cache. The base image is available at [bare-devcontainer/images](https://github.com/bare-devcontainer/images/tree/main/zig) ⭐ 2 | 🐛 3 | 🌐 Shell | 📅 2026-09-20.
...
* [deatil/zig-rsa](https://github.com/deatil/zig-rsa) ⭐ 0 | 🐛 0 | 🌐 Zig | 📅 2026-09-20 - An RSA library for Zig. No-AI.
...
* [dweiller/zimalloc](https://github.com/dweiller/zimalloc) ⭐ 48 | 🐛 7 | 🌐 Zig | 📅 2025-10-07 - A general purpose allocator for Zig, inspired by [mimalloc](https://github.com/microsoft/mimalloc) ⭐ 13,377 | 🐛 298 | 🌐 C | 📅 2026-09-18.
...
* [TheAlgorithms/Zig](https://github.com/TheAlgorithms/Zig) ⭐ 407 | 🐛 0 | 🌐 Zig | 📅 2026-08-15 - Collection of Algorithms implemented in Zig.
...
* [hello-algo-zig](https://github.com/codingonion/hello-algo-zig) ⭐ 82 | 🐛 0 | 🌐 Zig | 📅 2023-07-16 - Zig programming language codes for the famous public project [《Hello, Algorithm》|《 Hello，算法 》](https://github.com/krahets/hello-algo) ⭐ 130,309 | 🐛 40 | 🌐 Java | 📅 2026-08-17 about data structures and algorithms.
...
* [Arwalk/zig-protobuf](https://github.com/Arwalk/zig-protobuf) ⭐ 434 | 🐛 21 | 🌐 Zig | 📅 2026-07-14 - A protobuf 3 implementation for Zig.
...
* [scento/zig-date](https://github.com/scento/zig-date) ⭐ 7 | 🐛 0 | 🌐 Zig | 📅 2023-03-26 - Time and date for Zig. Zig-date is a date and time library for the Zig, inspired by the popular Rust library [chrono](https://github.com/chronotope/chrono) ⭐ 3,910 | 🐛 193 | 🌐 Rust | 📅 2026-09-07.
...
* [xcaeser/zli](https://github.com/xcaeser/zli) ⭐ 338 | 🐛 1 | 🌐 Zig | 📅 2026-08-29 - Zig command-line interfaces made easy. A blazing fast CLI framework. Build ergonomic, high-performance command-line tools with Zig.
* [MasterQ32/zig-args](https://github.com/MasterQ32/zig-args) ⭐ 309 | 🐛 10 | 🌐 Zig | 📅 2026-05-21 - Simple-to-use argument parser with struct-based config.
...
* [lupyuen/pinephone-nuttx](https://github.com/lupyuen/pinephone-nuttx) ⭐ 102 | 🐛 0 | 🌐 Zig | 📅 2026-09-20 - Apache NuttX RTOS for PinePhone. Apache NuttX is a lightweight Real-Time Operating System (RTOS) that runs on PINE64 PinePhone. [lupyuen.github.io/articles/what](https://lupyuen.github.io/articles/what).
...
* [sleep3r/mtproto.zig](https://github.com/sleep3r/mtproto.zig) ⭐ 1,914 | 🐛 5 | 🌐 Zig | 📅 2026-09-18 - High-performance Telegram MTProto proxy written in Zig.
...
* [lightpanda-io/browser](https://github.com/lightpanda-io/browser) ⭐ 35,458 | 🐛 81 | 🌐 Zig | 📅 2026-09-20 - Headless browser designed for AI and automation.

### Web Framework

* [zigzap/zap](https://github.com/zigzap/zap) ⚠️ Archived - Blazingly fast web backends in Zig.
* [kristoff-it/zine](https://github.com/kristoff-it/zine) ⭐ 1,572 | 🐛 56 | 🌐 Zig | 📅 2026-09-03 - Static Site Generator written in Zig.
...
* [cztomsik/tokamak](https://github.com/cztomsik/tokamak) ⭐ 634 | 🐛 5 | 🌐 Zig | 📅 2026-08-28 - Web framework that leverages dependency injection for clean, modular application development.
* [karlseguin/websocket.zig](https://github.com/karlseguin/websocket.zig) ⭐ 519 | 🐛 10 | 🌐 Zig | 📅 2026-08-23 - A WebSocket implementation for Zig.
* [nurulhudaapon/zx](https://github.com/nurulhudaapon/zx) ⭐ 338 | 🐛 31 | 🌐 Zig | 📅 2026-09-18 - A full-stack web framework for Zig.
* [zon-dev/zinc](https://github.com/zon-dev/zinc) ⭐ 185 | 🐛 2 | 🌐 Zig | 📅 2026-09-20 - Zinc is a web framework written in pure Zig with a focus on high performance, usability, security, and extensibility.
...
* [im-ng/zero](https://github.com/im-ng/zero) ⭐ 30 | 🐛 2 | 🌐 Zig | 📅 2026-09-20 - Simple and opinionated web framework written in Zig and aims to make microservices development in Zig easier.
...
* [blockblaz/ssz.zig](https://github.com/blockblaz/ssz.zig) ⭐ 34 | 🐛 17 | 🌐 Zig | 📅 2026-09-01 - A Zig implementation of the [SSZ serialization protocol](https://github.com/ethereum/eth2.0-specs/blob/dev/ssz/simple-serialize.md) ⭐ 3,967 | 🐛 67 | 🌐 Python | 📅 2026-09-16.
...
* [zwasm](https://github.com/zwasm/zwasm) ⭐ 179 | 🐛 59 | 🌐 Zig | 📅 2026-09-20 - From-scratch WebAssembly runtime in Zig. Full WebAssembly 3.0 with 100% spec conformance, WASI 0.1/0.2/0.3, and interpreter + JIT (arm64/x86\_64) + AOT backends.
...
* [tigerbeetle](https://github.com/tigerbeetle/tigerbeetle) ⭐ 17,052 | 🐛 111 | 🌐 Zig | 📅 2026-08-31 - The distributed financial accounting database designed for mission critical safety and performance. [tigerbeetle.com](https://tigerbeetle.com/).
...
* [karlseguin/pg.zig](https://github.com/karlseguin/pg.zig) ⭐ 597 | 🐛 5 | 🌐 Zig | 📅 2026-09-18 - Native PostgreSQL driver / client for Zig.
...
* [speed2exe/myzql](https://github.com/speed2exe/myzql) ⭐ 76 | 🐛 4 | 🌐 Zig | 📅 2026-09-16 - MySQL and MariaDB driver in native Zig.
...
* [zml](https://github.com/zml/zml) ⭐ 4,070 | 🐛 51 | 🌐 Zig | 📅 2026-09-19 - A high performance machine learning stack for Zig.
...
* [ggml-zig](https://github.com/codingonion/ggml-zig) - A replacement for [ggml: Tensor library for machine learning](https://github.com/ggerganov/ggml) ⭐ 15,377 | 🐛 364 | 🌐 C++ | 📅 2026-09-14 written in Zig.
...
* [ddalcu/mlx-serve](https://github.com/ddalcu/mlx-serve) ⭐ 1,424 | 🐛 54 | 🌐 Zig | 📅 2026-09-20 - Native LLM inference server for Apple Silicon (MLX + GGUF) with OpenAI- and Anthropic-compatible APIs; ships MLX Core, a macOS menu-bar app. MIT.
...
* [EugenHotaj/zig\_gpt2](https://github.com/EugenHotaj/zig_gpt2) ⭐ 40 | 🐛 0 | 🌐 Zig | 📅 2023-07-24 - Neural Network Inference Engine in Zig. GPT2 inference engine written in Zig. The inference engine can run [NanoGPT](https://github.com/karpathy/nanoGPT) ⭐ 63,249 | 🐛 349 | 🌐 Python | 📅 2025-11-12.
...
* [anomalyco/opentui](https://github.com/anomalyco/opentui) ⭐ 13,348 | 🐛 147 | 🌐 TypeScript | 📅 2026-09-19 - A library for building terminal user interfaces.
* [rockorager/libvaxis](https://github.com/rockorager/libvaxis) ⭐ 2,008 | 🐛 33 | 🌐 Zig | 📅 2026-09-08 - Modern TUI library written in Zig.
...
* [vancluever/z2d](https://github.com/vancluever/z2d) ⭐ 299 | 🐛 10 | 🌐 Zig | 📅 2026-09-19 - A pure Zig 2D graphics library.
...
* [david-vanderson/dvui](https://github.com/david-vanderson/dvui) ⭐ 1,663 | 🐛 105 | 🌐 Zig | 📅 2026-09-19 - Easy to Integrate Immediate Mode GUI for Zig.
...
* [meszmate/zigzag](https://github.com/meszmate/zigzag) ⭐ 556 | 🐛 8 | 🌐 Zig | 📅 2026-09-03 - The TUI Framework for Zig.
...
* [PixelGuys/Cubyz](https://github.com/PixelGuys/Cubyz) ⭐ 3,665 | 🐛 910 | 🌐 Zig | 📅 2026-09-20 - Voxel sandbox game with a large render distance, procedurally generated content and some cool graphical effects.
...
* [dmtrKovalenko/odiff](https://github.com/dmtrKovalenko/odiff) ⭐ 3,201 | 🐛 15 | 🌐 Zig | 📅 2026-08-24 - ODiff - A very fast SIMD-first image comparison library (with Node.js API).
...
* [fulcrum-so/ziggy-pydust](https://github.com/fulcrum-so/ziggy-pydust) ⭐ 789 | 🐛 46 | 🌐 Zig | 📅 2026-09-16 - A toolkit for building Python extensions in Zig. [pydust.fulcrum.so/](https://pydust.fulcrum.so/).
...
* [raylib](https://github.com/raysan5/raylib/) ⭐ 34,796 | 🐛 13 | 🌐 C | 📅 2026-09-20 - A simple and easy-to-use library to enjoy videogames programming.
