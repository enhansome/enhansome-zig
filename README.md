...
* [zigtools/zls](https://github.com/zigtools/zls) ⭐ 5,120 | 🐛 169 | 🌐 Zig | 📅 2026-09-11 - The @ziglang language server for all your Zig editor tooling needs, from autocomplete to goto-def! [installation](https://zigtools.org/zls/install/).
* [neurocyte/flow](https://github.com/neurocyte/flow) ⭐ 2,219 | 🐛 80 | 🌐 Zig | 📅 2026-09-10 - Flow Control - a programmer's text editor written in Zig.
...
* [forketyfork/zwanzig](https://github.com/forketyfork/zwanzig) ⭐ 29 | 🐛 2 | 🌐 Zig | 📅 2026-09-11 - Static analyzer for Zig with CFG-based checks (leaks, double-free, optional unwrap, stack escapes).
...
* [justrach/nanobrew](https://github.com/justrach/nanobrew) ⭐ 1,114 | 🐛 2 | 🌐 Zig | 📅 2026-09-09 - A fast macOS package manager written in Zig.
* [tristanisham/zvm](https://github.com/tristanisham/zvm) ⭐ 1,058 | 🐛 3 | 🌐 Go | 📅 2026-09-11 - Lets you easily install/upgrade between different versions of Zig. ZLS install can be included. (written in Go).
...
* [Cloudef/zig2nix](https://github.com/Cloudef/zig2nix) ⭐ 191 | 🐛 6 | 🌐 Zig | 📅 2026-09-11 - Flake for packaging, building and running Zig projects.
* [indaco/malt](https://github.com/indaco/malt) ⭐ 165 | 🐛 0 | 🌐 Zig | 📅 2026-09-11 - Homebrew's whole ecosystem, none of its weight: a single Zig binary with native post\_install and a themeable TUI and CLI.
...
* [vezel-dev/zig-sdk](https://github.com/vezel-dev/zig-sdk) ⭐ 110 | 🐛 21 | 🌐 C# | 📅 2026-09-11 - An MSBuild SDK for building Zig, C, and C++ projects using the Zig compiler.
* [zigtools/zpm](https://github.com/zigtools/zpm) ⭐ 104 | 🐛 0 | 🌐 Nix | 📅 2024-05-29 - Zig package manager helper.
* [asdf-community/asdf-zig](https://github.com/asdf-community/asdf-zig) ⭐ 82 | 🐛 1 | 🌐 Python | 📅 2026-08-14 - Zig plugin for the [asdf](https://github.com/asdf-vm/asdf) ⭐ 25,580 | 🐛 144 | 🌐 Go | 📅 2026-09-03 version manager.
...
* [ghostty](https://github.com/ghostty-org/ghostty) ⭐ 60,949 | 🐛 251 | 🌐 Zig | 📅 2026-09-10 - Modern terminal emulator written in Zig.
* [NilsIrl/dockerc](https://github.com/NilsIrl/dockerc) ⭐ 4,919 | 🐛 25 | 🌐 Zig | 📅 2025-01-02 - Container image to single executable compiler.
* [zmx](https://github.com/neurosnap/zmx) ⭐ 2,131 | 🐛 24 | 🌐 Zig | 📅 2026-09-11 - Session persistence for terminal processes.
* [Illusionna/LocalTransfer](https://github.com/Illusionna/LocalTransfer) ⭐ 598 | 🐛 0 | 🌐 Zig | 📅 2026-09-03 - A fast cross-platform HTTP file server.
...
* [forketyfork/architect](https://github.com/forketyfork/architect) ⭐ 50 | 🐛 8 | 🌐 Zig | 📅 2026-09-11 - A flexible terminal grid for multi-agent AI workflows.
...
* [bare-devcontainer/templates](https://github.com/bare-devcontainer/templates/tree/main/src/zig) ⭐ 1 | 🐛 1 | 🌐 Shell | 📅 2026-09-11 - Security-focused Zig dev container with zls integration and a persistent build cache. The base image is available at [bare-devcontainer/images](https://github.com/bare-devcontainer/images/tree/main/zig) ⭐ 2 | 🐛 2 | 🌐 Shell | 📅 2026-09-11.
...
* [deatil/zig-rsa](https://github.com/deatil/zig-rsa) ⭐ 0 | 🐛 0 | 🌐 Zig | 📅 2026-09-11 - An RSA library for Zig. No-AI.
...
* [dweiller/zimalloc](https://github.com/dweiller/zimalloc) ⭐ 48 | 🐛 7 | 🌐 Zig | 📅 2025-10-07 - A general purpose allocator for Zig, inspired by [mimalloc](https://github.com/microsoft/mimalloc) ⭐ 13,360 | 🐛 301 | 🌐 C | 📅 2026-09-11.
...
* [hello-algo-zig](https://github.com/codingonion/hello-algo-zig) ⭐ 82 | 🐛 0 | 🌐 Zig | 📅 2023-07-16 - Zig programming language codes for the famous public project [《Hello, Algorithm》|《 Hello，算法 》](https://github.com/krahets/hello-algo) ⭐ 130,009 | 🐛 41 | 🌐 Java | 📅 2026-08-17 about data structures and algorithms.
...
* [zoptia/zoptia0regex](https://github.com/zoptia/zoptia0regex) ⭐ 5 | 🐛 0 | 🌐 Zig | 📅 2026-09-10 - A regular-expression (regex) library — a faithful, linear-time port of Go's regexp (RE2), proven byte-for-byte identical to Go via \~30k differential tests.
...
* [Hejsil/zig-clap](https://github.com/Hejsil/zig-clap) ⭐ 1,613 | 🐛 7 | 🌐 Zig | 📅 2026-08-31 - A simple and easy to use command line argument parser library for Zig.
...
* [mitchellh/libxev](https://github.com/mitchellh/libxev) ⭐ 3,584 | 🐛 60 | 🌐 Zig | 📅 2026-07-17 - A cross-platform, high-performance event loop that provides abstractions for non-blocking IO, timers, events, and more and works on Linux (io\_uring or epoll), macOS (kqueue), and WebAssembly + WASI. Available as both a Zig and C API.
...
* [ZigEmbeddedGroup/microzig](https://github.com/ZigEmbeddedGroup/microzig) ⭐ 2,280 | 🐛 83 | 🌐 Zig | 📅 2026-09-10 - Unified abstraction layer and HAL for several microcontrollers.
...
* [lupyuen/pinephone-nuttx](https://github.com/lupyuen/pinephone-nuttx) ⭐ 102 | 🐛 0 | 🌐 Zig | 📅 2026-09-11 - Apache NuttX RTOS for PinePhone. Apache NuttX is a lightweight Real-Time Operating System (RTOS) that runs on PINE64 PinePhone. [lupyuen.github.io/articles/what](https://lupyuen.github.io/articles/what).
...
* [Fun](https://github.com/omdxp/fun) ⭐ 128 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-11 - A statically-typed language that transpiles to C, combining safety and performance with C's efficiency.
...
* [sleep3r/mtproto.zig](https://github.com/sleep3r/mtproto.zig) ⭐ 1,766 | 🐛 6 | 🌐 Zig | 📅 2026-09-08 - High-performance Telegram MTProto proxy written in Zig.
...
* [lightpanda-io/browser](https://github.com/lightpanda-io/browser) ⭐ 35,279 | 🐛 95 | 🌐 Zig | 📅 2026-09-11 - Headless browser designed for AI and automation.

### Web Framework

* [zigzap/zap](https://github.com/zigzap/zap) ⚠️ Archived - Blazingly fast web backends in Zig.
* [kristoff-it/zine](https://github.com/kristoff-it/zine) ⭐ 1,565 | 🐛 55 | 🌐 Zig | 📅 2026-09-03 - Static Site Generator written in Zig.
...
* [deatil/zig-jwt](https://github.com/deatil/zig-jwt) ⭐ 21 | 🐛 0 | 🌐 Zig | 📅 2026-09-11 - A JWT(JSON Web Token) library for Zig.
* [im-ng/zero](https://github.com/im-ng/zero) ⭐ 21 | 🐛 3 | 🌐 Zig | 📅 2026-09-11 - Simple and opinionated web framework written in Zig and aims to make microservices development in Zig easier.
...
* [blockblaz/ssz.zig](https://github.com/blockblaz/ssz.zig) ⭐ 34 | 🐛 17 | 🌐 Zig | 📅 2026-09-01 - A Zig implementation of the [SSZ serialization protocol](https://github.com/ethereum/eth2.0-specs/blob/dev/ssz/simple-serialize.md) ⭐ 3,961 | 🐛 62 | 🌐 Python | 📅 2026-09-10.
...
* [zwasm](https://github.com/zwasm/zwasm) ⭐ 174 | 🐛 50 | 🌐 Zig | 📅 2026-09-11 - From-scratch WebAssembly runtime in Zig. Full WebAssembly 3.0 with 100% spec conformance, WASI 0.1/0.2/0.3, and interpreter + JIT (arm64/x86\_64) + AOT backends.
...
* [tigerbeetle](https://github.com/tigerbeetle/tigerbeetle) ⭐ 17,001 | 🐛 105 | 🌐 Zig | 📅 2026-08-31 - The distributed financial accounting database designed for mission critical safety and performance. [tigerbeetle.com](https://tigerbeetle.com/).
* [vrischmann/zig-sqlite](https://github.com/vrischmann/zig-sqlite) ⭐ 619 | 🐛 9 | 🌐 C | 📅 2026-07-24 - Zig-SQLite is a small wrapper around SQLite's C API, making it easier to use with Zig.
...
* [zml](https://github.com/zml/zml) ⭐ 4,027 | 🐛 48 | 🌐 Zig | 📅 2026-09-11 - A high performance machine learning stack for Zig.
...
* [ggml-zig](https://github.com/codingonion/ggml-zig) - A replacement for [ggml: Tensor library for machine learning](https://github.com/ggerganov/ggml) ⭐ 15,334 | 🐛 361 | 🌐 C++ | 📅 2026-09-09 written in Zig.

### Large Language Model

* [nullclaw/nullclaw](https://github.com/nullclaw/nullclaw) ⭐ 8,082 | 🐛 94 | 🌐 Zig | 📅 2026-07-19 - Fastest, smallest, and fully autonomous AI assistant infrastructure written in Zig.
* [ddalcu/mlx-serve](https://github.com/ddalcu/mlx-serve) ⭐ 1,226 | 🐛 55 | 🌐 Zig | 📅 2026-09-11 - Native LLM inference server for Apple Silicon (MLX + GGUF) with OpenAI- and Anthropic-compatible APIs; ships MLX Core, a macOS menu-bar app. MIT.
...
* [EugenHotaj/zig\_gpt2](https://github.com/EugenHotaj/zig_gpt2) ⭐ 40 | 🐛 0 | 🌐 Zig | 📅 2023-07-24 - Neural Network Inference Engine in Zig. GPT2 inference engine written in Zig. The inference engine can run [NanoGPT](https://github.com/karpathy/nanoGPT) ⭐ 62,987 | 🐛 349 | 🌐 Python | 📅 2025-11-12.
...
* [anomalyco/opentui](https://github.com/anomalyco/opentui) ⭐ 13,279 | 🐛 134 | 🌐 TypeScript | 📅 2026-09-11 - A library for building terminal user interfaces.
...
* [fabioarnold/nanovg-zig](https://github.com/fabioarnold/nanovg-zig) ⭐ 246 | 🐛 1 | 🌐 C | 📅 2026-01-29 - [NanoVG](https://github.com/memononen/nanovg) ⭐ 5,703 | 🐛 321 | 🌐 C | 📅 2026-02-19 - Zig Version. A small anti-aliased hardware-accelerated vector graphics library. [fabioarnold.github.io/nanovg-zig/](https://fabioarnold.github.io/nanovg-zig/).
...
* [Capy](https://github.com/capy-ui/capy) ⭐ 2,692 | 🐛 25 | 🌐 Zig | 📅 2025-12-25 - Build one codebase and get native UI on Windows, Linux and Web. [capy-ui.org](https://capy-ui.org/).
* [david-vanderson/dvui](https://github.com/david-vanderson/dvui) ⭐ 1,657 | 🐛 101 | 🌐 Zig | 📅 2026-09-10 - Easy to Integrate Immediate Mode GUI for Zig.
...
* [PixelGuys/Cubyz](https://github.com/PixelGuys/Cubyz) ⭐ 3,652 | 🐛 921 | 🌐 Zig | 📅 2026-09-07 - Voxel sandbox game with a large render distance, procedurally generated content and some cool graphical effects.
...
* [dmtrKovalenko/odiff](https://github.com/dmtrKovalenko/odiff) ⭐ 3,189 | 🐛 15 | 🌐 Zig | 📅 2026-08-24 - ODiff - A very fast SIMD-first image comparison library (with Node.js API).
...
* [happystraw/phpz](https://github.com/happystraw/phpz) ⭐ 5 | 🐛 1 | 🌐 Zig | 📅 2026-09-11 - Build PHP extensions with Zig.
...
* [raylib](https://github.com/raysan5/raylib/) ⭐ 34,658 | 🐛 20 | 🌐 C | 📅 2026-09-10 - A simple and easy-to-use library to enjoy videogames programming.
* [libxlsxwriter](https://github.com/jmcnamara/libxlsxwriter) ⭐ 1,758 | 🐛 20 | 🌐 C | 📅 2026-07-07 - A C library for creating Excel XLSX files, build system replaced by Zig.
