...
* [zigtools/zls](https://github.com/zigtools/zls) ⭐ 5,090 | 🐛 163 | 🌐 Zig | 📅 2026-08-14 - The @ziglang language server for all your Zig editor tooling needs, from autocomplete to goto-def! [installation](https://zigtools.org/zls/install/).
* [neurocyte/flow](https://github.com/neurocyte/flow) ⭐ 2,187 | 🐛 80 | 🌐 Zig | 📅 2026-08-25 - Flow Control - a programmer's text editor written in Zig.
...
* [forketyfork/zwanzig](https://github.com/forketyfork/zwanzig) ⭐ 28 | 🐛 2 | 🌐 Zig | 📅 2026-08-22 - Static analyzer for Zig with CFG-based checks (leaks, double-free, optional unwrap, stack escapes).
...
* [justrach/nanobrew](https://github.com/justrach/nanobrew) ⭐ 1,108 | 🐛 12 | 🌐 Zig | 📅 2026-08-15 - A fast macOS package manager written in Zig.
* [tristanisham/zvm](https://github.com/tristanisham/zvm) ⭐ 1,049 | 🐛 2 | 🌐 Go | 📅 2026-08-26 - Lets you easily install/upgrade between different versions of Zig. ZLS install can be included. (written in Go).
* [nektro/zigmod](https://github.com/nektro/zigmod) ⭐ 941 | 🐛 19 | 🌐 Zig | 📅 2026-06-10 - A package manager for the Zig programming language.
* [mitchellh/zig-overlay](https://github.com/mitchellh/zig-overlay) ⭐ 541 | 🐛 10 | 🌐 Nix | 📅 2026-08-26 - Nix flake for the Zig compiler.
...
* [Cloudef/zig2nix](https://github.com/Cloudef/zig2nix) ⭐ 188 | 🐛 7 | 🌐 Zig | 📅 2026-08-26 - Flake for packaging, building and running Zig projects.
* [indaco/malt](https://github.com/indaco/malt) ⭐ 157 | 🐛 9 | 🌐 Zig | 📅 2026-08-25 - Homebrew's whole ecosystem, none of its weight: a single Zig binary with native post\_install and a themeable TUI and CLI.
...
* [asdf-community/asdf-zig](https://github.com/asdf-community/asdf-zig) ⭐ 81 | 🐛 0 | 🌐 Python | 📅 2026-08-14 - Zig plugin for the [asdf](https://github.com/asdf-vm/asdf) ⭐ 25,548 | 🐛 152 | 🌐 Go | 📅 2026-08-12 version manager.
...
* [ghostty](https://github.com/ghostty-org/ghostty) ⭐ 60,249 | 🐛 237 | 🌐 Zig | 📅 2026-08-26 - Modern terminal emulator written in Zig.
* [NilsIrl/dockerc](https://github.com/NilsIrl/dockerc) ⭐ 4,915 | 🐛 25 | 🌐 Zig | 📅 2025-01-02 - Container image to single executable compiler.
* [zmx](https://github.com/neurosnap/zmx) ⭐ 2,079 | 🐛 29 | 🌐 Zig | 📅 2026-08-20 - Session persistence for terminal processes.
* [Illusionna/LocalTransfer](https://github.com/Illusionna/LocalTransfer) ⭐ 577 | 🐛 0 | 🌐 Zig | 📅 2026-08-09 - A fast cross-platform HTTP file server.
...
* [zlist](https://github.com/here-Leslie-Lau/zlist) ⭐ 58 | 🐛 4 | 🌐 Zig | 📅 2026-08-26 - A simple, colorful alternative to ls built with Zig.
* [forketyfork/architect](https://github.com/forketyfork/architect) ⭐ 49 | 🐛 9 | 🌐 Zig | 📅 2026-08-22 - A flexible terminal grid for multi-agent AI workflows.
...
* [bare-devcontainer/templates](https://github.com/bare-devcontainer/templates/tree/main/src/zig) ⭐ 1 | 🐛 1 | 🌐 Shell | 📅 2026-08-25 - Security-focused Zig dev container with zls integration and a persistent build cache. The base image is available at [bare-devcontainer/images](https://github.com/bare-devcontainer/images/tree/main/zig) ⭐ 2 | 🐛 2 | 🌐 Shell | 📅 2026-08-26.
...
* [andrewrk/poop](https://github.com/andrewrk/poop) ⭐ 2,031 | 🐛 29 | 🌐 Zig | 📅 2026-05-04 - CLI Performance Observer written in Zig.
...
* [dweiller/zimalloc](https://github.com/dweiller/zimalloc) ⭐ 48 | 🐛 7 | 🌐 Zig | 📅 2025-10-07 - A general purpose allocator for Zig, inspired by [mimalloc](https://github.com/microsoft/mimalloc) ⭐ 13,330 | 🐛 312 | 🌐 C | 📅 2026-08-22.
...
* [hello-algo-zig](https://github.com/codingonion/hello-algo-zig) ⭐ 82 | 🐛 0 | 🌐 Zig | 📅 2023-07-16 - Zig programming language codes for the famous public project [《Hello, Algorithm》|《 Hello，算法 》](https://github.com/krahets/hello-algo) ⭐ 129,607 | 🐛 43 | 🌐 Java | 📅 2026-08-17 about data structures and algorithms.
...
* [rockorager/zeit](https://github.com/rockorager/zeit) ⭐ 232 | 🐛 5 | 🌐 Zig | 📅 2026-08-17 - Generic date/time library, including time zone loading and conversion.
...
* [mitchellh/libxev](https://github.com/mitchellh/libxev) ⭐ 3,570 | 🐛 58 | 🌐 Zig | 📅 2026-07-17 - A cross-platform, high-performance event loop that provides abstractions for non-blocking IO, timers, events, and more and works on Linux (io\_uring or epoll), macOS (kqueue), and WebAssembly + WASI. Available as both a Zig and C API.
...
* [ZigEmbeddedGroup/microzig](https://github.com/ZigEmbeddedGroup/microzig) ⭐ 2,262 | 🐛 78 | 🌐 Zig | 📅 2026-08-18 - Unified abstraction layer and HAL for several microcontrollers.
...
* [lupyuen/pinephone-nuttx](https://github.com/lupyuen/pinephone-nuttx) ⭐ 102 | 🐛 0 | 🌐 Zig | 📅 2026-08-26 - Apache NuttX RTOS for PinePhone. Apache NuttX is a lightweight Real-Time Operating System (RTOS) that runs on PINE64 PinePhone. [lupyuen.github.io/articles/what](https://lupyuen.github.io/articles/what).
...
* [Aro](https://github.com/Vexu/arocc) ⭐ 1,801 | 🐛 47 | 🌐 Zig | 📅 2026-08-18 - A C compiler with the goal of providing fast compilation and low memory usage with good diagnostics.
* [buzz](https://github.com/buzz-language/buzz) ⭐ 1,529 | 🐛 80 | 🌐 Zig | 📅 2026-08-20 - A small/lightweight statically typed scripting language.
...
* [Fun](https://github.com/omdxp/fun) ⭐ 24 | 🐛 1 | 🌐 Zig | 📅 2026-08-26 - A statically-typed language that transpiles to C, combining safety and performance with C's efficiency.
...
* [karlseguin/http.zig](https://github.com/karlseguin/http.zig) ⭐ 1,590 | 🐛 15 | 🌐 Zig | 📅 2026-08-25 - An HTTP/1.1 server for Zig.
* [sleep3r/mtproto.zig](https://github.com/sleep3r/mtproto.zig) ⭐ 1,405 | 🐛 2 | 🌐 Zig | 📅 2026-08-24 - High-performance Telegram MTProto proxy written in Zig.
...
* [muhammad-fiaz/httpx.zig](https://github.com/muhammad-fiaz/httpx.zig) ⭐ 85 | 🐛 4 | 🌐 Zig | 📅 2026-08-24 - Production-ready HTTP/1.x/2/3 client and server runtime for Zig with proxy support, concurrency, and protocol primitives.
...
* [lightpanda-io/browser](https://github.com/lightpanda-io/browser) ⭐ 34,258 | 🐛 96 | 🌐 Zig | 📅 2026-08-26 - Headless browser designed for AI and automation.

### Web Framework

* [zigzap/zap](https://github.com/zigzap/zap) ⭐ 3,412 | 🐛 28 | 🌐 C | 📅 2026-06-01 - Blazingly fast web backends in Zig.
* [kristoff-it/zine](https://github.com/kristoff-it/zine) ⭐ 1,539 | 🐛 54 | 🌐 Zig | 📅 2026-08-12 - Static Site Generator written in Zig.
...
* [im-ng/zero](https://github.com/im-ng/zero) ⭐ 21 | 🐛 3 | 🌐 Zig | 📅 2026-08-26 - Simple and opinionated web framework written in Zig and aims to make microservices development in Zig easier.
...
* [blockblaz/ssz.zig](https://github.com/blockblaz/ssz.zig) ⭐ 34 | 🐛 16 | 🌐 Zig | 📅 2026-08-11 - A Zig implementation of the [SSZ serialization protocol](https://github.com/ethereum/eth2.0-specs/blob/dev/ssz/simple-serialize.md) ⭐ 3,957 | 🐛 65 | 🌐 Python | 📅 2026-08-25.
...
* [zwasm](https://github.com/zwasm/zwasm) ⭐ 169 | 🐛 45 | 🌐 Zig | 📅 2026-08-26 - From-scratch WebAssembly runtime in Zig. Full WebAssembly 3.0 with 100% spec conformance, WASI 0.1/0.2/0.3, and interpreter + JIT (arm64/x86\_64) + AOT backends.
...
* [tigerbeetle](https://github.com/tigerbeetle/tigerbeetle) ⭐ 16,907 | 🐛 110 | 🌐 Zig | 📅 2026-08-25 - The distributed financial accounting database designed for mission critical safety and performance. [tigerbeetle.com](https://tigerbeetle.com/).
...
* [karlseguin/pg.zig](https://github.com/karlseguin/pg.zig) ⭐ 591 | 🐛 5 | 🌐 Zig | 📅 2026-08-25 - Native PostgreSQL driver / client for Zig.
...
* [zml](https://github.com/zml/zml) ⭐ 4,003 | 🐛 44 | 🌐 Zig | 📅 2026-08-26 - A high performance machine learning stack for Zig.
...
* [ggml-zig](https://github.com/codingonion/ggml-zig) - A replacement for [ggml: Tensor library for machine learning](https://github.com/ggerganov/ggml) ⭐ 15,234 | 🐛 351 | 🌐 C++ | 📅 2026-08-25 written in Zig.

### Large Language Model

* [nullclaw/nullclaw](https://github.com/nullclaw/nullclaw) ⭐ 8,050 | 🐛 92 | 🌐 Zig | 📅 2026-07-19 - Fastest, smallest, and fully autonomous AI assistant infrastructure written in Zig.
* [ddalcu/mlx-serve](https://github.com/ddalcu/mlx-serve) ⭐ 810 | 🐛 41 | 🌐 Zig | 📅 2026-08-26 - Native LLM inference server for Apple Silicon (MLX + GGUF) with OpenAI- and Anthropic-compatible APIs; ships MLX Core, a macOS menu-bar app. MIT.
...
* [EugenHotaj/zig\_gpt2](https://github.com/EugenHotaj/zig_gpt2) ⭐ 40 | 🐛 0 | 🌐 Zig | 📅 2023-07-24 - Neural Network Inference Engine in Zig. GPT2 inference engine written in Zig. The inference engine can run [NanoGPT](https://github.com/karpathy/nanoGPT) ⭐ 62,496 | 🐛 352 | 🌐 Python | 📅 2025-11-12.
...
* [Snektron/vulkan-zig](https://github.com/Snektron/vulkan-zig) ⭐ 902 | 🐛 25 | 🌐 Zig | 📅 2026-08-23 - Vulkan binding generator for Zig.
...
* [anomalyco/opentui](https://github.com/anomalyco/opentui) ⭐ 13,156 | 🐛 158 | 🌐 TypeScript | 📅 2026-08-26 - A library for building terminal user interfaces.
* [rockorager/libvaxis](https://github.com/rockorager/libvaxis) ⭐ 1,977 | 🐛 34 | 🌐 Zig | 📅 2026-08-20 - Modern TUI library written in Zig.
...
* [david-vanderson/dvui](https://github.com/david-vanderson/dvui) ⭐ 1,642 | 🐛 98 | 🌐 Zig | 📅 2026-08-24 - Easy to Integrate Immediate Mode GUI for Zig.
...
* [meszmate/zigzag](https://github.com/meszmate/zigzag) ⭐ 528 | 🐛 3 | 🌐 Zig | 📅 2026-08-14 - The TUI Framework for Zig.
* [rcalixte/libqt6zig](https://github.com/rcalixte/libqt6zig) ⭐ 262 | 🐛 0 | 🌐 Zig | 📅 2026-08-25 - Qt 6 for Zig.
...
* [kotsutsumi/zylix](https://github.com/kotsutsumi/zylix) ⭐ 69 | 🐛 7 | 🌐 Zig | 📅 2026-03-15 - Zig powered cross-platform UI framework with Virtual DOM.
...
* [PixelGuys/Cubyz](https://github.com/PixelGuys/Cubyz) ⭐ 3,629 | 🐛 944 | 🌐 Zig | 📅 2026-08-25 - Voxel sandbox game with a large render distance, procedurally generated content and some cool graphical effects.
...
* [andrewrk/tetris](https://github.com/andrewrk/tetris) ⭐ 488 | 🐛 0 | 🌐 Zig | 📅 2026-05-29 - A simple tetris clone written in Zig programming language. [www.youtube.com/watch?v=AiintPutWrE](https://www.youtube.com/watch?v=AiintPutWrE).
...
* [dmtrKovalenko/odiff](https://github.com/dmtrKovalenko/odiff) ⭐ 3,172 | 🐛 15 | 🌐 Zig | 📅 2026-08-24 - ODiff - A very fast SIMD-first image comparison library (with Node.js API).
* [zigimg/zigimg](https://github.com/zigimg/zigimg) ⭐ 837 | 🐛 49 | 🌐 Zig | 📅 2026-08-18 - Zig library for reading and writing different image formats.
* [freref/fancy-cat](https://github.com/freref/fancy-cat) ⭐ 557 | 🐛 20 | 🌐 Zig | 📅 2026-08-03 - PDF reader inside the terminal.
* [bfactory-ai/zignal](https://github.com/bfactory-ai/zignal) ⭐ 460 | 🐛 1 | 🌐 Zig | 📅 2026-08-26 - Image processing library in Zig, heavily inspired by dlib.
...
* [fulcrum-so/ziggy-pydust](https://github.com/fulcrum-so/ziggy-pydust) ⭐ 786 | 🐛 44 | 🌐 Zig | 📅 2026-08-20 - A toolkit for building Python extensions in Zig. [pydust.fulcrum.so/](https://pydust.fulcrum.so/).
* [floooh/sokol-zig](https://github.com/floooh/sokol-zig) ⭐ 722 | 🐛 14 | 🌐 C | 📅 2026-08-24 - Zig bindings for the sokol headers.
* [natecraddock/ziglua](https://github.com/natecraddock/ziglua) ⭐ 520 | 🐛 10 | 🌐 Zig | 📅 2026-08-25 - Zig bindings for the Lua C API.
...
* [raylib](https://github.com/raysan5/raylib/) ⭐ 34,472 | 🐛 18 | 🌐 C | 📅 2026-08-25 - A simple and easy-to-use library to enjoy videogames programming.
