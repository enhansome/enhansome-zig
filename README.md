...
* [Zigistry/Zigistry](https://github.com/Zigistry/Zigistry) ⭐ 706 | 🐛 6 | 🌐 Svelte | 📅 2026-09-21 - A place where you can find all the libraries that suit your Zig lang needs.
...
* [zigtools/zls](https://github.com/zigtools/zls) ⭐ 5,143 | 🐛 170 | 🌐 Zig | 📅 2026-09-11 - The @ziglang language server for all your Zig editor tooling needs, from autocomplete to goto-def! [installation](https://zigtools.org/zls/install/).
* [neurocyte/flow](https://github.com/neurocyte/flow) ⭐ 2,411 | 🐛 80 | 🌐 Zig | 📅 2026-09-18 - Flow Control - a programmer's text editor written in Zig.
...
* [DonIsaac/zlint](https://github.com/DonIsaac/zlint) ⭐ 312 | 🐛 32 | 🌐 Zig | 📅 2026-09-17 - Linter for the Zig programming language.
* [KurtWagner/zlinter](https://github.com/KurtWagner/zlinter) ⭐ 98 | 🐛 5 | 🌐 Zig | 📅 2026-09-16 - Zig linter that is integrated from source into your `build.zig`.
...
* [sb2bg/marionette](https://github.com/sb2bg/marionette) ⭐ 87 | 🐛 1 | 🌐 Zig | 📅 2026-09-08 - Deterministic simulation testing for Zig with a `std.Io` implementation, letting you inject faults and replay failures from seeds.
...
* [marler8997/zigup](https://github.com/marler8997/zigup) ⭐ 1,124 | 🐛 54 | 🌐 Zig | 📅 2025-06-14 - Download and manage Zig compilers.
...
* [mitchellh/zig-overlay](https://github.com/mitchellh/zig-overlay) ⭐ 548 | 🐛 10 | 🌐 Nix | 📅 2026-09-21 - Nix flake for the Zig compiler.
...
* [Cloudef/zig2nix](https://github.com/Cloudef/zig2nix) ⭐ 191 | 🐛 7 | 🌐 Zig | 📅 2026-09-21 - Flake for packaging, building and running Zig projects.
* [indaco/malt](https://github.com/indaco/malt) ⭐ 167 | 🐛 1 | 🌐 Zig | 📅 2026-09-21 - Homebrew's whole ecosystem, none of its weight: a single Zig binary with native post\_install and a themeable TUI and CLI.
...
* [asdf-community/asdf-zig](https://github.com/asdf-community/asdf-zig) ⭐ 82 | 🐛 1 | 🌐 Python | 📅 2026-08-14 - Zig plugin for the [asdf](https://github.com/asdf-vm/asdf) ⭐ 25,598 | 🐛 146 | 🌐 Go | 📅 2026-09-03 version manager.
...
* [ghostty](https://github.com/ghostty-org/ghostty) ⭐ 61,394 | 🐛 251 | 🌐 Zig | 📅 2026-09-21 - Modern terminal emulator written in Zig.
* [NilsIrl/dockerc](https://github.com/NilsIrl/dockerc) ⭐ 4,918 | 🐛 25 | 🌐 Zig | 📅 2025-01-02 - Container image to single executable compiler.
* [zmx](https://github.com/neurosnap/zmx) ⭐ 2,159 | 🐛 29 | 🌐 Zig | 📅 2026-09-19 - Session persistence for terminal processes.
* [Illusionna/LocalTransfer](https://github.com/Illusionna/LocalTransfer) ⭐ 611 | 🐛 1 | 🌐 Zig | 📅 2026-09-03 - A fast cross-platform HTTP file server.
...
* [deatil/zig-rsa](https://github.com/deatil/zig-rsa) ⭐ 0 | 🐛 0 | 🌐 Zig | 📅 2026-09-21 - An RSA library for Zig. No-AI.
...
* [hendriknielaender/zBench](https://github.com/hendriknielaender/zBench) ⭐ 228 | 🐛 8 | 🌐 Zig | 📅 2026-06-24 - Simple benchmarking library.
...
* [dweiller/zimalloc](https://github.com/dweiller/zimalloc) ⭐ 48 | 🐛 7 | 🌐 Zig | 📅 2025-10-07 - A general purpose allocator for Zig, inspired by [mimalloc](https://github.com/microsoft/mimalloc) ⭐ 13,383 | 🐛 299 | 🌐 C | 📅 2026-09-18.
...
* [hello-algo-zig](https://github.com/codingonion/hello-algo-zig) ⭐ 82 | 🐛 0 | 🌐 Zig | 📅 2023-07-16 - Zig programming language codes for the famous public project [《Hello, Algorithm》|《 Hello，算法 》](https://github.com/krahets/hello-algo) ⭐ 130,334 | 🐛 40 | 🌐 Java | 📅 2026-08-17 about data structures and algorithms.
...
* [tree-sitter/zig-tree-sitter](https://github.com/tree-sitter/zig-tree-sitter) ⭐ 123 | 🐛 0 | 🌐 Zig | 📅 2026-06-27 - Zig bindings to the [Tree-sitter](https://tree-sitter.github.io/zig-tree-sitter/) parsing library.
...
* [Arwalk/zig-protobuf](https://github.com/Arwalk/zig-protobuf) ⭐ 434 | 🐛 21 | 🌐 Zig | 📅 2026-09-20 - A protobuf 3 implementation for Zig.
...
* [Hejsil/zig-clap](https://github.com/Hejsil/zig-clap) ⭐ 1,623 | 🐛 7 | 🌐 Zig | 📅 2026-08-31 - A simple and easy to use command line argument parser library for Zig.
...
* [mitchellh/libxev](https://github.com/mitchellh/libxev) ⭐ 3,582 | 🐛 67 | 🌐 Zig | 📅 2026-07-17 - A cross-platform, high-performance event loop that provides abstractions for non-blocking IO, timers, events, and more and works on Linux (io\_uring or epoll), macOS (kqueue), and WebAssembly + WASI. Available as both a Zig and C API.
...
* [ZigEmbeddedGroup/microzig](https://github.com/ZigEmbeddedGroup/microzig) ⭐ 2,280 | 🐛 82 | 🌐 Zig | 📅 2026-09-19 - Unified abstraction layer and HAL for several microcontrollers.
...
* [lupyuen/pinephone-nuttx](https://github.com/lupyuen/pinephone-nuttx) ⭐ 102 | 🐛 0 | 🌐 Zig | 📅 2026-09-21 - Apache NuttX RTOS for PinePhone. Apache NuttX is a lightweight Real-Time Operating System (RTOS) that runs on PINE64 PinePhone. [lupyuen.github.io/articles/what](https://lupyuen.github.io/articles/what).
...
* [sleep3r/mtproto.zig](https://github.com/sleep3r/mtproto.zig) ⭐ 1,930 | 🐛 5 | 🌐 Zig | 📅 2026-09-18 - High-performance Telegram MTProto proxy written in Zig.
* [karlseguin/http.zig](https://github.com/karlseguin/http.zig) ⭐ 1,601 | 🐛 15 | 🌐 Zig | 📅 2026-08-26 - An HTTP/1.1 server for Zig.
* [tardy-org/zzz](https://github.com/tardy-org/zzz) ⭐ 785 | 🐛 17 | 🌐 Zig | 📅 2026-09-16 - A framework for writing performant and reliable networked services in Zig. Supports HTTP and HTTPS.
...
* [lightpanda-io/browser](https://github.com/lightpanda-io/browser) ⭐ 35,490 | 🐛 78 | 🌐 Zig | 📅 2026-09-21 - Headless browser designed for AI and automation.
...
* [nurulhudaapon/zx](https://github.com/nurulhudaapon/zx) ⭐ 340 | 🐛 29 | 🌐 Zig | 📅 2026-09-21 - A full-stack web framework for Zig.
...
* [im-ng/zero](https://github.com/im-ng/zero) ⭐ 31 | 🐛 2 | 🌐 Zig | 📅 2026-09-21 - Simple and opinionated web framework written in Zig and aims to make microservices development in Zig easier.
...
* [blockblaz/ssz.zig](https://github.com/blockblaz/ssz.zig) ⭐ 34 | 🐛 17 | 🌐 Zig | 📅 2026-09-01 - A Zig implementation of the [SSZ serialization protocol](https://github.com/ethereum/eth2.0-specs/blob/dev/ssz/simple-serialize.md) ⭐ 3,967 | 🐛 67 | 🌐 Python | 📅 2026-09-21.
...
* [zwasm](https://github.com/zwasm/zwasm) ⭐ 179 | 🐛 60 | 🌐 Zig | 📅 2026-09-21 - From-scratch WebAssembly runtime in Zig. Full WebAssembly 3.0 with 100% spec conformance, WASI 0.1/0.2/0.3, and interpreter + JIT (arm64/x86\_64) + AOT backends.
...
* [tigerbeetle](https://github.com/tigerbeetle/tigerbeetle) ⭐ 17,058 | 🐛 112 | 🌐 Zig | 📅 2026-08-31 - The distributed financial accounting database designed for mission critical safety and performance. [tigerbeetle.com](https://tigerbeetle.com/).
...
* [zml](https://github.com/zml/zml) ⭐ 4,072 | 🐛 56 | 🌐 Zig | 📅 2026-09-21 - A high performance machine learning stack for Zig.
...
* [ggml-zig](https://github.com/codingonion/ggml-zig) - A replacement for [ggml: Tensor library for machine learning](https://github.com/ggerganov/ggml) ⭐ 15,383 | 🐛 364 | 🌐 C++ | 📅 2026-09-14 written in Zig.

### Large Language Model

* [nullclaw/nullclaw](https://github.com/nullclaw/nullclaw) ⭐ 8,104 | 🐛 96 | 🌐 Zig | 📅 2026-07-19 - Fastest, smallest, and fully autonomous AI assistant infrastructure written in Zig.
* [ddalcu/mlx-serve](https://github.com/ddalcu/mlx-serve) ⭐ 1,454 | 🐛 58 | 🌐 Zig | 📅 2026-09-21 - Native LLM inference server for Apple Silicon (MLX + GGUF) with OpenAI- and Anthropic-compatible APIs; ships MLX Core, a macOS menu-bar app. MIT.
...
* [EugenHotaj/zig\_gpt2](https://github.com/EugenHotaj/zig_gpt2) ⭐ 40 | 🐛 0 | 🌐 Zig | 📅 2023-07-24 - Neural Network Inference Engine in Zig. GPT2 inference engine written in Zig. The inference engine can run [NanoGPT](https://github.com/karpathy/nanoGPT) ⭐ 63,286 | 🐛 349 | 🌐 Python | 📅 2025-11-12.
...
* [anomalyco/opentui](https://github.com/anomalyco/opentui) ⭐ 13,355 | 🐛 149 | 🌐 TypeScript | 📅 2026-09-21 - A library for building terminal user interfaces.
...
* [david-vanderson/dvui](https://github.com/david-vanderson/dvui) ⭐ 1,664 | 🐛 105 | 🌐 Zig | 📅 2026-09-20 - Easy to Integrate Immediate Mode GUI for Zig.
* [webui-dev/zig-webui](https://github.com/webui-dev/zig-webui) ⭐ 831 | 🐛 10 | 🌐 Zig | 📅 2026-08-03 - Use any web browser or WebView as GUI, with your preferred language in the backend and HTML5 in the frontend, all in a lightweight portable lib.
* [meszmate/zigzag](https://github.com/meszmate/zigzag) ⭐ 558 | 🐛 8 | 🌐 Zig | 📅 2026-09-03 - The TUI Framework for Zig.
...
* [PixelGuys/Cubyz](https://github.com/PixelGuys/Cubyz) ⭐ 3,666 | 🐛 910 | 🌐 Zig | 📅 2026-09-20 - Voxel sandbox game with a large render distance, procedurally generated content and some cool graphical effects.
* [zig-gamedev/zig-gamedev](https://github.com/zig-gamedev/zig-gamedev) ⭐ 2,863 | 🐛 37 | 🌐 Zig | 📅 2026-03-08 - Building game development ecosystem for @ziglang.
...
* [orhun/linuxwave](https://github.com/orhun/linuxwave) ⭐ 664 | 🐛 17 | 🌐 Zig | 📅 2026-07-31 - Generate music from the entropy of Linux 🐧🎵. [orhun.dev/linuxwave/](https://orhun.dev/linuxwave/).
...
* [dmtrKovalenko/odiff](https://github.com/dmtrKovalenko/odiff) ⭐ 3,202 | 🐛 15 | 🌐 Zig | 📅 2026-08-24 - ODiff - A very fast SIMD-first image comparison library (with Node.js API).
...
* [bfactory-ai/zignal](https://github.com/bfactory-ai/zignal) ⭐ 460 | 🐛 0 | 🌐 Zig | 📅 2026-09-19 - Image processing library in Zig, heavily inspired by dlib.
...
* [fulcrum-so/ziggy-pydust](https://github.com/fulcrum-so/ziggy-pydust) ⭐ 789 | 🐛 46 | 🌐 Zig | 📅 2026-09-21 - A toolkit for building Python extensions in Zig. [pydust.fulcrum.so/](https://pydust.fulcrum.so/).
...
* [raylib](https://github.com/raysan5/raylib/) ⭐ 34,807 | 🐛 12 | 🌐 C | 📅 2026-09-21 - A simple and easy-to-use library to enjoy videogames programming.
...
* [FFmpeg](https://github.com/andrewrk/ffmpeg) ⭐ 321 | 🐛 9 | 🌐 C | 📅 2026-09-21 - Library FFmpeg with the build system replaced by Zig.
