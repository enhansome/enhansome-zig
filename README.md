...
* [zigtools/zls](https://github.com/zigtools/zls) ⭐ 5,113 | 🐛 169 | 🌐 Zig | 📅 2026-09-04 - The @ziglang language server for all your Zig editor tooling needs, from autocomplete to goto-def! [installation](https://zigtools.org/zls/install/).
* [neurocyte/flow](https://github.com/neurocyte/flow) ⭐ 2,212 | 🐛 82 | 🌐 Zig | 📅 2026-08-29 - Flow Control - a programmer's text editor written in Zig.
...
* [KurtWagner/zlinter](https://github.com/KurtWagner/zlinter) ⭐ 94 | 🐛 5 | 🌐 Zig | 📅 2026-08-20 - Zig linter that is integrated from source into your `build.zig`.
...
* [justrach/nanobrew](https://github.com/justrach/nanobrew) ⭐ 1,115 | 🐛 14 | 🌐 Zig | 📅 2026-08-15 - A fast macOS package manager written in Zig.
...
* [mitchellh/zig-overlay](https://github.com/mitchellh/zig-overlay) ⭐ 543 | 🐛 10 | 🌐 Nix | 📅 2026-09-07 - Nix flake for the Zig compiler.
...
* [Cloudef/zig2nix](https://github.com/Cloudef/zig2nix) ⭐ 190 | 🐛 6 | 🌐 Zig | 📅 2026-09-07 - Flake for packaging, building and running Zig projects.
* [indaco/malt](https://github.com/indaco/malt) ⭐ 164 | 🐛 2 | 🌐 Zig | 📅 2026-09-07 - Homebrew's whole ecosystem, none of its weight: a single Zig binary with native post\_install and a themeable TUI and CLI.
...
* [asdf-community/asdf-zig](https://github.com/asdf-community/asdf-zig) ⭐ 82 | 🐛 0 | 🌐 Python | 📅 2026-08-14 - Zig plugin for the [asdf](https://github.com/asdf-vm/asdf) ⭐ 25,566 | 🐛 144 | 🌐 Go | 📅 2026-09-03 version manager.
...
* [ghostty](https://github.com/ghostty-org/ghostty) ⭐ 60,805 | 🐛 247 | 🌐 Zig | 📅 2026-09-07 - Modern terminal emulator written in Zig.
* [NilsIrl/dockerc](https://github.com/NilsIrl/dockerc) ⭐ 4,919 | 🐛 25 | 🌐 Zig | 📅 2025-01-02 - Container image to single executable compiler.
* [zmx](https://github.com/neurosnap/zmx) ⭐ 2,120 | 🐛 22 | 🌐 Zig | 📅 2026-09-05 - Session persistence for terminal processes.
* [Illusionna/LocalTransfer](https://github.com/Illusionna/LocalTransfer) ⭐ 589 | 🐛 0 | 🌐 Zig | 📅 2026-09-03 - A fast cross-platform HTTP file server.
...
* [midasdf/zt](https://github.com/midasdf/zt) ⭐ 66 | 🐛 0 | 🌐 Zig | 📅 2026-07-04 - Ultra-fast, minimal terminal emulator written in Zig with fbdev, X11, Wayland, and macOS backends.
* [zlist](https://github.com/here-Leslie-Lau/zlist) ⭐ 61 | 🐛 4 | 🌐 Zig | 📅 2026-09-07 - A simple, colorful alternative to ls built with Zig.
...
* [bare-devcontainer/templates](https://github.com/bare-devcontainer/templates/tree/main/src/zig) ⭐ 1 | 🐛 1 | 🌐 Shell | 📅 2026-09-07 - Security-focused Zig dev container with zls integration and a persistent build cache. The base image is available at [bare-devcontainer/images](https://github.com/bare-devcontainer/images/tree/main/zig) ⭐ 2 | 🐛 2 | 🌐 Shell | 📅 2026-09-07.
...
* [deatil/zig-rsa](https://github.com/deatil/zig-rsa) ⭐ 0 | 🐛 0 | 🌐 Zig | 📅 2026-09-06 - An RSA library for Zig. No-AI.
...
* [dweiller/zimalloc](https://github.com/dweiller/zimalloc) ⭐ 48 | 🐛 7 | 🌐 Zig | 📅 2025-10-07 - A general purpose allocator for Zig, inspired by [mimalloc](https://github.com/microsoft/mimalloc) ⭐ 13,355 | 🐛 303 | 🌐 C | 📅 2026-09-07.
...
* [hello-algo-zig](https://github.com/codingonion/hello-algo-zig) ⭐ 82 | 🐛 0 | 🌐 Zig | 📅 2023-07-16 - Zig programming language codes for the famous public project [《Hello, Algorithm》|《 Hello，算法 》](https://github.com/krahets/hello-algo) ⭐ 129,932 | 🐛 42 | 🌐 Java | 📅 2026-08-17 about data structures and algorithms.
...
* [Arwalk/zig-protobuf](https://github.com/Arwalk/zig-protobuf) ⭐ 432 | 🐛 22 | 🌐 Zig | 📅 2026-07-14 - A protobuf 3 implementation for Zig.
...
* [karlseguin/log.zig](https://github.com/karlseguin/log.zig) ⭐ 196 | 🐛 0 | 🌐 Zig | 📅 2026-06-20 - A structured logger for Zig.
...
* [OrlovEvgeny/serde.zig](https://github.com/OrlovEvgeny/serde.zig) ⭐ 84 | 🐛 4 | 🌐 Zig | 📅 2026-09-07 - Comptime serialization framework for Zig supporting JSON, MessagePack, TOML, YAML, ZON, and CSV.
...
* [Hejsil/zig-clap](https://github.com/Hejsil/zig-clap) ⭐ 1,610 | 🐛 7 | 🌐 Zig | 📅 2026-08-31 - A simple and easy to use command line argument parser library for Zig.
...
* [ZigEmbeddedGroup/microzig](https://github.com/ZigEmbeddedGroup/microzig) ⭐ 2,277 | 🐛 80 | 🌐 Zig | 📅 2026-09-07 - Unified abstraction layer and HAL for several microcontrollers.
...
* [lupyuen/pinephone-nuttx](https://github.com/lupyuen/pinephone-nuttx) ⭐ 102 | 🐛 0 | 🌐 Zig | 📅 2026-09-07 - Apache NuttX RTOS for PinePhone. Apache NuttX is a lightweight Real-Time Operating System (RTOS) that runs on PINE64 PinePhone. [lupyuen.github.io/articles/what](https://lupyuen.github.io/articles/what).
...
* [Aro](https://github.com/Vexu/arocc) ⭐ 1,803 | 🐛 48 | 🌐 Zig | 📅 2026-09-06 - A C compiler with the goal of providing fast compilation and low memory usage with good diagnostics.
...
* [sleep3r/mtproto.zig](https://github.com/sleep3r/mtproto.zig) ⭐ 1,683 | 🐛 6 | 🌐 Zig | 📅 2026-09-06 - High-performance Telegram MTProto proxy written in Zig.
* [karlseguin/http.zig](https://github.com/karlseguin/http.zig) ⭐ 1,596 | 🐛 15 | 🌐 Zig | 📅 2026-08-26 - An HTTP/1.1 server for Zig.
* [tardy-org/zzz](https://github.com/tardy-org/zzz) ⭐ 780 | 🐛 18 | 🌐 Zig | 📅 2026-09-05 - A framework for writing performant and reliable networked services in Zig. Supports HTTP and HTTPS.
...
* [muhammad-fiaz/httpx.zig](https://github.com/muhammad-fiaz/httpx.zig) ⭐ 89 | 🐛 3 | 🌐 Zig | 📅 2026-09-06 - Production-ready HTTP/1.x/2/3 client and server runtime for Zig with proxy support, concurrency, and protocol primitives.
...
* [zig-nostr/nostr](https://github.com/zig-nostr/nostr) ⭐ 8 | 🐛 5 | 🌐 Zig | 📅 2026-09-07 - The Nostr protocol natively in Zig: secp256k1/Schnorr keys, events, relay transport with the outbox model, a local-first LMDB event store, NIP-46 remote signing, and more.
...
* [lightpanda-io/browser](https://github.com/lightpanda-io/browser) ⭐ 34,653 | 🐛 86 | 🌐 Zig | 📅 2026-09-07 - Headless browser designed for AI and automation.

### Web Framework

* [zigzap/zap](https://github.com/zigzap/zap) ⚠️ Archived - Blazingly fast web backends in Zig.
* [kristoff-it/zine](https://github.com/kristoff-it/zine) ⭐ 1,565 | 🐛 54 | 🌐 Zig | 📅 2026-09-03 - Static Site Generator written in Zig.
...
* [blockblaz/ssz.zig](https://github.com/blockblaz/ssz.zig) ⭐ 34 | 🐛 17 | 🌐 Zig | 📅 2026-09-01 - A Zig implementation of the [SSZ serialization protocol](https://github.com/ethereum/eth2.0-specs/blob/dev/ssz/simple-serialize.md) ⭐ 3,961 | 🐛 59 | 🌐 Python | 📅 2026-09-07.
...
* [zwasm](https://github.com/zwasm/zwasm) ⭐ 172 | 🐛 51 | 🌐 Zig | 📅 2026-09-07 - From-scratch WebAssembly runtime in Zig. Full WebAssembly 3.0 with 100% spec conformance, WASI 0.1/0.2/0.3, and interpreter + JIT (arm64/x86\_64) + AOT backends.
...
* [tigerbeetle](https://github.com/tigerbeetle/tigerbeetle) ⭐ 16,966 | 🐛 103 | 🌐 Zig | 📅 2026-08-31 - The distributed financial accounting database designed for mission critical safety and performance. [tigerbeetle.com](https://tigerbeetle.com/).
...
* [karlseguin/pg.zig](https://github.com/karlseguin/pg.zig) ⭐ 593 | 🐛 4 | 🌐 Zig | 📅 2026-08-26 - Native PostgreSQL driver / client for Zig.
...
* [speed2exe/myzql](https://github.com/speed2exe/myzql) ⭐ 75 | 🐛 5 | 🌐 Zig | 📅 2026-09-07 - MySQL and MariaDB driver in native Zig.
...
* [seqor/seqor](https://github.com/seqor/seqor) ⭐ 62 | 🐛 1 | 🌐 Zig | 📅 2026-09-06 - Seqor is a cost-effective, Loki compatible database for logs.
...
* [zml](https://github.com/zml/zml) ⭐ 4,018 | 🐛 49 | 🌐 Zig | 📅 2026-09-07 - A high performance machine learning stack for Zig.
...
* [ggml-zig](https://github.com/codingonion/ggml-zig) - A replacement for [ggml: Tensor library for machine learning](https://github.com/ggerganov/ggml) ⭐ 15,302 | 🐛 359 | 🌐 C++ | 📅 2026-09-04 written in Zig.

### Large Language Model

* [nullclaw/nullclaw](https://github.com/nullclaw/nullclaw) ⭐ 8,069 | 🐛 94 | 🌐 Zig | 📅 2026-07-19 - Fastest, smallest, and fully autonomous AI assistant infrastructure written in Zig.
* [ddalcu/mlx-serve](https://github.com/ddalcu/mlx-serve) ⭐ 1,153 | 🐛 63 | 🌐 Zig | 📅 2026-09-07 - Native LLM inference server for Apple Silicon (MLX + GGUF) with OpenAI- and Anthropic-compatible APIs; ships MLX Core, a macOS menu-bar app. MIT.
...
* [EugenHotaj/zig\_gpt2](https://github.com/EugenHotaj/zig_gpt2) ⭐ 40 | 🐛 0 | 🌐 Zig | 📅 2023-07-24 - Neural Network Inference Engine in Zig. GPT2 inference engine written in Zig. The inference engine can run [NanoGPT](https://github.com/karpathy/nanoGPT) ⭐ 62,875 | 🐛 348 | 🌐 Python | 📅 2025-11-12.
...
* [Snektron/vulkan-zig](https://github.com/Snektron/vulkan-zig) ⭐ 908 | 🐛 24 | 🌐 Zig | 📅 2026-08-30 - Vulkan binding generator for Zig.
...
* [anomalyco/opentui](https://github.com/anomalyco/opentui) ⭐ 13,260 | 🐛 130 | 🌐 TypeScript | 📅 2026-09-07 - A library for building terminal user interfaces.
* [rockorager/libvaxis](https://github.com/rockorager/libvaxis) ⭐ 1,990 | 🐛 34 | 🌐 Zig | 📅 2026-09-06 - Modern TUI library written in Zig.
...
* [Capy](https://github.com/capy-ui/capy) ⭐ 2,693 | 🐛 25 | 🌐 Zig | 📅 2025-12-25 - Build one codebase and get native UI on Windows, Linux and Web. [capy-ui.org](https://capy-ui.org/).
* [david-vanderson/dvui](https://github.com/david-vanderson/dvui) ⭐ 1,652 | 🐛 98 | 🌐 Zig | 📅 2026-09-05 - Easy to Integrate Immediate Mode GUI for Zig.
...
* [meszmate/zigzag](https://github.com/meszmate/zigzag) ⭐ 545 | 🐛 7 | 🌐 Zig | 📅 2026-09-03 - The TUI Framework for Zig.
...
* [Mach](https://github.com/hexops/mach) ⭐ 4,836 | 🐛 167 | 🌐 Zig | 📅 2026-05-23 - A game engine & graphics toolkit for the future. machengine.org.
* [PixelGuys/Cubyz](https://github.com/PixelGuys/Cubyz) ⭐ 3,650 | 🐛 915 | 🌐 Zig | 📅 2026-09-06 - Voxel sandbox game with a large render distance, procedurally generated content and some cool graphical effects.
...
* [dmtrKovalenko/odiff](https://github.com/dmtrKovalenko/odiff) ⭐ 3,184 | 🐛 15 | 🌐 Zig | 📅 2026-08-24 - ODiff - A very fast SIMD-first image comparison library (with Node.js API).
...
* [fulcrum-so/ziggy-pydust](https://github.com/fulcrum-so/ziggy-pydust) ⭐ 787 | 🐛 46 | 🌐 Zig | 📅 2026-09-07 - A toolkit for building Python extensions in Zig. [pydust.fulcrum.so/](https://pydust.fulcrum.so/).
* [floooh/sokol-zig](https://github.com/floooh/sokol-zig) ⭐ 725 | 🐛 13 | 🌐 C | 📅 2026-09-06 - Zig bindings for the sokol headers.
...
* [raylib](https://github.com/raysan5/raylib/) ⭐ 34,627 | 🐛 17 | 🌐 C | 📅 2026-09-06 - A simple and easy-to-use library to enjoy videogames programming.
