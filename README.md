...
* [Zigistry/Zigistry](https://github.com/Zigistry/Zigistry) ⭐ 706 | 🐛 5 | 🌐 Svelte | 📅 2026-09-09 - A place where you can find all the libraries that suit your Zig lang needs.
...
* [neurocyte/flow](https://github.com/neurocyte/flow) ⭐ 2,223 | 🐛 78 | 🌐 Zig | 📅 2026-09-14 - Flow Control - a programmer's text editor written in Zig.
...
* [DonIsaac/zlint](https://github.com/DonIsaac/zlint) ⭐ 311 | 🐛 33 | 🌐 Zig | 📅 2026-09-14 - Linter for the Zig programming language.
...
* [justrach/nanobrew](https://github.com/justrach/nanobrew) ⭐ 1,118 | 🐛 2 | 🌐 Zig | 📅 2026-09-14 - A fast macOS package manager written in Zig.
...
* [Cloudef/zig2nix](https://github.com/Cloudef/zig2nix) ⭐ 191 | 🐛 7 | 🌐 Zig | 📅 2026-09-15 - Flake for packaging, building and running Zig projects.
* [indaco/malt](https://github.com/indaco/malt) ⭐ 166 | 🐛 0 | 🌐 Zig | 📅 2026-09-15 - Homebrew's whole ecosystem, none of its weight: a single Zig binary with native post\_install and a themeable TUI and CLI.
...
* [asdf-community/asdf-zig](https://github.com/asdf-community/asdf-zig) ⭐ 82 | 🐛 1 | 🌐 Python | 📅 2026-08-14 - Zig plugin for the [asdf](https://github.com/asdf-vm/asdf) ⭐ 25,588 | 🐛 145 | 🌐 Go | 📅 2026-09-03 version manager.
...
* [ghostty](https://github.com/ghostty-org/ghostty) ⭐ 61,132 | 🐛 244 | 🌐 Zig | 📅 2026-09-15 - Modern terminal emulator written in Zig.
* [NilsIrl/dockerc](https://github.com/NilsIrl/dockerc) ⭐ 4,919 | 🐛 25 | 🌐 Zig | 📅 2025-01-02 - Container image to single executable compiler.
* [zmx](https://github.com/neurosnap/zmx) ⭐ 2,144 | 🐛 25 | 🌐 Zig | 📅 2026-09-12 - Session persistence for terminal processes.
...
* [midasdf/zt](https://github.com/midasdf/zt) ⭐ 68 | 🐛 0 | 🌐 Zig | 📅 2026-07-04 - Ultra-fast, minimal terminal emulator written in Zig with fbdev, X11, Wayland, and macOS backends.
...
* [mtxr/claude-switch](https://github.com/mtxr/claude-switch) ⭐ 7 | 🐛 0 | 🌐 Zig | 📅 2026-06-11 - Swap between Claude (Code + Desktop) accounts on macOS with a single command. Credentials stored securely in macOS Keychain. Fully offline.
...
* [deatil/zig-rsa](https://github.com/deatil/zig-rsa) ⭐ 0 | 🐛 0 | 🌐 Zig | 📅 2026-09-15 - An RSA library for Zig. No-AI.
...
* [dweiller/zimalloc](https://github.com/dweiller/zimalloc) ⭐ 48 | 🐛 7 | 🌐 Zig | 📅 2025-10-07 - A general purpose allocator for Zig, inspired by [mimalloc](https://github.com/microsoft/mimalloc) ⭐ 13,365 | 🐛 296 | 🌐 C | 📅 2026-09-15.
...
* [hello-algo-zig](https://github.com/codingonion/hello-algo-zig) ⭐ 82 | 🐛 0 | 🌐 Zig | 📅 2023-07-16 - Zig programming language codes for the famous public project [《Hello, Algorithm》|《 Hello，算法 》](https://github.com/krahets/hello-algo) ⭐ 130,121 | 🐛 41 | 🌐 Java | 📅 2026-08-17 about data structures and algorithms.
...
* [scento/zig-date](https://github.com/scento/zig-date) ⭐ 7 | 🐛 0 | 🌐 Zig | 📅 2023-03-26 - Time and date for Zig. Zig-date is a date and time library for the Zig, inspired by the popular Rust library [chrono](https://github.com/chronotope/chrono) ⭐ 3,906 | 🐛 193 | 🌐 Rust | 📅 2026-09-07.
...
* [Hejsil/zig-clap](https://github.com/Hejsil/zig-clap) ⭐ 1,616 | 🐛 7 | 🌐 Zig | 📅 2026-08-31 - A simple and easy to use command line argument parser library for Zig.
...
* [jiacai2050/zigcli](https://github.com/jiacai2050/zigcli) ⭐ 135 | 🐛 8 | 🌐 Zig | 📅 2026-07-19 - A toolkit for building command lines programs in Zig.
...
* [ZigEmbeddedGroup/microzig](https://github.com/ZigEmbeddedGroup/microzig) ⭐ 2,282 | 🐛 82 | 🌐 Zig | 📅 2026-09-15 - Unified abstraction layer and HAL for several microcontrollers.
...
* [lupyuen/pinephone-nuttx](https://github.com/lupyuen/pinephone-nuttx) ⭐ 102 | 🐛 0 | 🌐 Zig | 📅 2026-09-15 - Apache NuttX RTOS for PinePhone. Apache NuttX is a lightweight Real-Time Operating System (RTOS) that runs on PINE64 PinePhone. [lupyuen.github.io/articles/what](https://lupyuen.github.io/articles/what).
...
* [marlersoft/zigwin32](https://github.com/marlersoft/zigwin32) ⭐ 451 | 🐛 30 | 🌐 Zig | 📅 2026-07-23 - A complete autogenerated set of Zig bindings for the Win32 API.
...
* [Aro](https://github.com/Vexu/arocc) ⭐ 1,807 | 🐛 48 | 🌐 Zig | 📅 2026-09-14 - A C compiler with the goal of providing fast compilation and low memory usage with good diagnostics.
...
* [Fun](https://github.com/omdxp/fun) ⭐ 363 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-15 - A statically-typed language that transpiles to C, combining safety and performance with C's efficiency.
...
* [sleep3r/mtproto.zig](https://github.com/sleep3r/mtproto.zig) ⭐ 1,850 | 🐛 5 | 🌐 Zig | 📅 2026-09-08 - High-performance Telegram MTProto proxy written in Zig.
...
* [muhammad-fiaz/httpx.zig](https://github.com/muhammad-fiaz/httpx.zig) ⭐ 90 | 🐛 3 | 🌐 Zig | 📅 2026-09-13 - Production-ready HTTP/1.x/2/3 client and server runtime for Zig with proxy support, concurrency, and protocol primitives.
...
* [lightpanda-io/browser](https://github.com/lightpanda-io/browser) ⭐ 35,356 | 🐛 97 | 🌐 Zig | 📅 2026-09-15 - Headless browser designed for AI and automation.

### Web Framework

* [zigzap/zap](https://github.com/zigzap/zap) ⚠️ Archived - Blazingly fast web backends in Zig.
* [kristoff-it/zine](https://github.com/kristoff-it/zine) ⭐ 1,567 | 🐛 55 | 🌐 Zig | 📅 2026-09-03 - Static Site Generator written in Zig.
...
* [nurulhudaapon/zx](https://github.com/nurulhudaapon/zx) ⭐ 335 | 🐛 31 | 🌐 Zig | 📅 2026-08-30 - A full-stack web framework for Zig.
...
* [im-ng/zero](https://github.com/im-ng/zero) ⭐ 26 | 🐛 1 | 🌐 Zig | 📅 2026-09-14 - Simple and opinionated web framework written in Zig and aims to make microservices development in Zig easier.
...
* [blockblaz/ssz.zig](https://github.com/blockblaz/ssz.zig) ⭐ 34 | 🐛 17 | 🌐 Zig | 📅 2026-09-01 - A Zig implementation of the [SSZ serialization protocol](https://github.com/ethereum/eth2.0-specs/blob/dev/ssz/simple-serialize.md) ⭐ 3,963 | 🐛 65 | 🌐 Python | 📅 2026-09-15.
...
* [zwasm](https://github.com/zwasm/zwasm) ⭐ 175 | 🐛 55 | 🌐 Zig | 📅 2026-09-14 - From-scratch WebAssembly runtime in Zig. Full WebAssembly 3.0 with 100% spec conformance, WASI 0.1/0.2/0.3, and interpreter + JIT (arm64/x86\_64) + AOT backends.
...
* [tigerbeetle](https://github.com/tigerbeetle/tigerbeetle) ⭐ 17,018 | 🐛 106 | 🌐 Zig | 📅 2026-08-31 - The distributed financial accounting database designed for mission critical safety and performance. [tigerbeetle.com](https://tigerbeetle.com/).
...
* [zml](https://github.com/zml/zml) ⭐ 4,043 | 🐛 51 | 🌐 Zig | 📅 2026-09-15 - A high performance machine learning stack for Zig.
...
* [ggml-zig](https://github.com/codingonion/ggml-zig) - A replacement for [ggml: Tensor library for machine learning](https://github.com/ggerganov/ggml) ⭐ 15,358 | 🐛 362 | 🌐 C++ | 📅 2026-09-14 written in Zig.

### Large Language Model

* [nullclaw/nullclaw](https://github.com/nullclaw/nullclaw) ⭐ 8,087 | 🐛 95 | 🌐 Zig | 📅 2026-07-19 - Fastest, smallest, and fully autonomous AI assistant infrastructure written in Zig.
* [ddalcu/mlx-serve](https://github.com/ddalcu/mlx-serve) ⭐ 1,276 | 🐛 47 | 🌐 Zig | 📅 2026-09-15 - Native LLM inference server for Apple Silicon (MLX + GGUF) with OpenAI- and Anthropic-compatible APIs; ships MLX Core, a macOS menu-bar app. MIT.
...
* [CogitatorTech/zigformer](https://github.com/CogitatorTech/zigformer) ⭐ 53 | 🐛 0 | 🌐 Zig | 📅 2025-11-27 - ZigFormer is a transformer-based LLM implemented in pure Zig.
* [clebert/LLaMa2.zig](https://github.com/clebert/llama2.zig) ⚠️ Archived - Inference LLaMA 2 in pure Zig.
* [EugenHotaj/zig\_gpt2](https://github.com/EugenHotaj/zig_gpt2) ⭐ 40 | 🐛 0 | 🌐 Zig | 📅 2023-07-24 - Neural Network Inference Engine in Zig. GPT2 inference engine written in Zig. The inference engine can run [NanoGPT](https://github.com/karpathy/nanoGPT) ⭐ 63,113 | 🐛 349 | 🌐 Python | 📅 2025-11-12.
...
* [anomalyco/opentui](https://github.com/anomalyco/opentui) ⭐ 13,307 | 🐛 147 | 🌐 TypeScript | 📅 2026-09-15 - A library for building terminal user interfaces.
...
* [Capy](https://github.com/capy-ui/capy) ⭐ 2,697 | 🐛 25 | 🌐 Zig | 📅 2025-12-25 - Build one codebase and get native UI on Windows, Linux and Web. [capy-ui.org](https://capy-ui.org/).
* [david-vanderson/dvui](https://github.com/david-vanderson/dvui) ⭐ 1,658 | 🐛 102 | 🌐 Zig | 📅 2026-09-14 - Easy to Integrate Immediate Mode GUI for Zig.
* [webui-dev/zig-webui](https://github.com/webui-dev/zig-webui) ⭐ 829 | 🐛 10 | 🌐 Zig | 📅 2026-08-03 - Use any web browser or WebView as GUI, with your preferred language in the backend and HTML5 in the frontend, all in a lightweight portable lib.
* [meszmate/zigzag](https://github.com/meszmate/zigzag) ⭐ 550 | 🐛 8 | 🌐 Zig | 📅 2026-09-03 - The TUI Framework for Zig.
* [rcalixte/libqt6zig](https://github.com/rcalixte/libqt6zig) ⭐ 265 | 🐛 0 | 🌐 Zig | 📅 2026-09-14 - Qt 6 for Zig.
...
* [PixelGuys/Cubyz](https://github.com/PixelGuys/Cubyz) ⭐ 3,660 | 🐛 915 | 🌐 Zig | 📅 2026-09-14 - Voxel sandbox game with a large render distance, procedurally generated content and some cool graphical effects.
...
* [zigimg/zigimg](https://github.com/zigimg/zigimg) ⭐ 840 | 🐛 50 | 🌐 Zig | 📅 2026-09-08 - Zig library for reading and writing different image formats.
...
* [happystraw/phpz](https://github.com/happystraw/phpz) ⭐ 5 | 🐛 5 | 🌐 Zig | 📅 2026-09-15 - Build PHP extensions with Zig.
...
* [raylib](https://github.com/raysan5/raylib/) ⭐ 34,733 | 🐛 12 | 🌐 C | 📅 2026-09-14 - A simple and easy-to-use library to enjoy videogames programming.
