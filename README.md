...
* [Zigistry/Zigistry](https://github.com/Zigistry/Zigistry) ⭐ 707 | 🐛 5 | 🌐 Svelte | 📅 2026-08-23 - A place where you can find all the libraries that suit your Zig lang needs.

### Text Editors

* [zigtools/zls](https://github.com/zigtools/zls) ⭐ 5,087 | 🐛 159 | 🌐 Zig | 📅 2026-08-14 - The @ziglang language server for all your Zig editor tooling needs, from autocomplete to goto-def! [installation](https://zigtools.org/zls/install/).
* [neurocyte/flow](https://github.com/neurocyte/flow) ⭐ 2,183 | 🐛 80 | 🌐 Zig | 📅 2026-08-21 - Flow Control - a programmer's text editor written in Zig.
...
* [sb2bg/marionette](https://github.com/sb2bg/marionette) ⭐ 78 | 🐛 1 | 🌐 Zig | 📅 2026-08-12 - Deterministic simulation testing for Zig with a `std.Io` implementation, letting you inject faults and replay failures from seeds.
...
* [mitchellh/zig-overlay](https://github.com/mitchellh/zig-overlay) ⭐ 541 | 🐛 10 | 🌐 Nix | 📅 2026-08-23 - Nix flake for the Zig compiler.
...
* [Cloudef/zig2nix](https://github.com/Cloudef/zig2nix) ⭐ 187 | 🐛 7 | 🌐 Zig | 📅 2026-08-24 - Flake for packaging, building and running Zig projects.
* [indaco/malt](https://github.com/indaco/malt) ⭐ 155 | 🐛 10 | 🌐 Zig | 📅 2026-08-24 - Homebrew's whole ecosystem, none of its weight: a single Zig binary with native post\_install and a themeable TUI and CLI.
...
* [asdf-community/asdf-zig](https://github.com/asdf-community/asdf-zig) ⭐ 81 | 🐛 0 | 🌐 Python | 📅 2026-08-14 - Zig plugin for the [asdf](https://github.com/asdf-vm/asdf) ⭐ 25,541 | 🐛 151 | 🌐 Go | 📅 2026-08-12 version manager.
...
* [ghostty](https://github.com/ghostty-org/ghostty) ⭐ 60,129 | 🐛 238 | 🌐 Zig | 📅 2026-08-24 - Modern terminal emulator written in Zig.
* [NilsIrl/dockerc](https://github.com/NilsIrl/dockerc) ⭐ 4,915 | 🐛 25 | 🌐 Zig | 📅 2025-01-02 - Container image to single executable compiler.
* [zmx](https://github.com/neurosnap/zmx) ⭐ 2,072 | 🐛 29 | 🌐 Zig | 📅 2026-08-20 - Session persistence for terminal processes.
...
* [andrewrk/poop](https://github.com/andrewrk/poop) ⭐ 2,030 | 🐛 29 | 🌐 Zig | 📅 2026-05-04 - CLI Performance Observer written in Zig.
...
* [dweiller/zimalloc](https://github.com/dweiller/zimalloc) ⭐ 48 | 🐛 7 | 🌐 Zig | 📅 2025-10-07 - A general purpose allocator for Zig, inspired by [mimalloc](https://github.com/microsoft/mimalloc) ⭐ 13,325 | 🐛 312 | 🌐 C | 📅 2026-08-22.
...
* [hello-algo-zig](https://github.com/codingonion/hello-algo-zig) ⭐ 82 | 🐛 0 | 🌐 Zig | 📅 2023-07-16 - Zig programming language codes for the famous public project [《Hello, Algorithm》|《 Hello，算法 》](https://github.com/krahets/hello-algo) ⭐ 129,582 | 🐛 42 | 🌐 Java | 📅 2026-08-17 about data structures and algorithms.
...
* [Arwalk/zig-protobuf](https://github.com/Arwalk/zig-protobuf) ⭐ 428 | 🐛 20 | 🌐 Zig | 📅 2026-07-14 - A protobuf 3 implementation for Zig.
...
* [scento/zig-date](https://github.com/scento/zig-date) ⭐ 7 | 🐛 0 | 🌐 Zig | 📅 2023-03-26 - Time and date for Zig. Zig-date is a date and time library for the Zig, inspired by the popular Rust library [chrono](https://github.com/chronotope/chrono) ⭐ 3,899 | 🐛 196 | 🌐 Rust | 📅 2026-08-03.
...
* [mitchellh/libxev](https://github.com/mitchellh/libxev) ⭐ 3,565 | 🐛 58 | 🌐 Zig | 📅 2026-07-17 - A cross-platform, high-performance event loop that provides abstractions for non-blocking IO, timers, events, and more and works on Linux (io\_uring or epoll), macOS (kqueue), and WebAssembly + WASI. Available as both a Zig and C API.
...
* [ZigEmbeddedGroup/microzig](https://github.com/ZigEmbeddedGroup/microzig) ⭐ 2,259 | 🐛 77 | 🌐 Zig | 📅 2026-08-18 - Unified abstraction layer and HAL for several microcontrollers.
...
* [lupyuen/pinephone-nuttx](https://github.com/lupyuen/pinephone-nuttx) ⭐ 102 | 🐛 0 | 🌐 Zig | 📅 2026-08-24 - Apache NuttX RTOS for PinePhone. Apache NuttX is a lightweight Real-Time Operating System (RTOS) that runs on PINE64 PinePhone. [lupyuen.github.io/articles/what](https://lupyuen.github.io/articles/what).
...
* [buzz](https://github.com/buzz-language/buzz) ⭐ 1,526 | 🐛 80 | 🌐 Zig | 📅 2026-08-20 - A small/lightweight statically typed scripting language.
...
* [karlseguin/http.zig](https://github.com/karlseguin/http.zig) ⭐ 1,589 | 🐛 15 | 🌐 Zig | 📅 2026-08-22 - An HTTP/1.1 server for Zig.
* [sleep3r/mtproto.zig](https://github.com/sleep3r/mtproto.zig) ⭐ 1,272 | 🐛 4 | 🌐 Zig | 📅 2026-08-22 - High-performance Telegram MTProto proxy written in Zig.
...
* [muhammad-fiaz/httpx.zig](https://github.com/muhammad-fiaz/httpx.zig) ⭐ 83 | 🐛 4 | 🌐 Zig | 📅 2026-08-23 - Production-ready HTTP/1.x/2/3 client and server runtime for Zig with proxy support, concurrency, and protocol primitives.
...
* [lightpanda-io/browser](https://github.com/lightpanda-io/browser) ⭐ 34,215 | 🐛 91 | 🌐 Zig | 📅 2026-08-24 - Headless browser designed for AI and automation.

### Web Framework

* [zigzap/zap](https://github.com/zigzap/zap) ⭐ 3,409 | 🐛 28 | 🌐 C | 📅 2026-06-01 - Blazingly fast web backends in Zig.
* [kristoff-it/zine](https://github.com/kristoff-it/zine) ⭐ 1,536 | 🐛 54 | 🌐 Zig | 📅 2026-08-12 - Static Site Generator written in Zig.
...
* [cztomsik/tokamak](https://github.com/cztomsik/tokamak) ⭐ 632 | 🐛 5 | 🌐 Zig | 📅 2026-08-20 - Web framework that leverages dependency injection for clean, modular application development.
* [karlseguin/websocket.zig](https://github.com/karlseguin/websocket.zig) ⭐ 516 | 🐛 10 | 🌐 Zig | 📅 2026-08-23 - A WebSocket implementation for Zig.
* [nurulhudaapon/zx](https://github.com/nurulhudaapon/zx) ⭐ 323 | 🐛 32 | 🌐 Zig | 📅 2026-08-13 - A full-stack web framework for Zig.
...
* [blockblaz/ssz.zig](https://github.com/blockblaz/ssz.zig) ⭐ 34 | 🐛 16 | 🌐 Zig | 📅 2026-08-11 - A Zig implementation of the [SSZ serialization protocol](https://github.com/ethereum/eth2.0-specs/blob/dev/ssz/simple-serialize.md) ⭐ 3,958 | 🐛 64 | 🌐 Python | 📅 2026-08-24.
...
* [zware](https://github.com/malcolmstill/zware) ⭐ 413 | 🐛 16 | 🌐 Zig | 📅 2026-06-21 - Zig WebAssembly Runtime Engine. zware is a library for executing WebAssembly embedded in [Zig](https://ziglang.org/) programs.
...
* [zwasm](https://github.com/zwasm/zwasm) ⭐ 165 | 🐛 27 | 🌐 Zig | 📅 2026-08-24 - From-scratch WebAssembly runtime in Zig. Full WebAssembly 3.0 with 100% spec conformance, WASI 0.1/0.2/0.3, and interpreter + JIT (arm64/x86\_64) + AOT backends.
...
* [tigerbeetle](https://github.com/tigerbeetle/tigerbeetle) ⭐ 16,896 | 🐛 124 | 🌐 Zig | 📅 2026-08-18 - The distributed financial accounting database designed for mission critical safety and performance. [tigerbeetle.com](https://tigerbeetle.com/).
...
* [zml](https://github.com/zml/zml) ⭐ 3,999 | 🐛 40 | 🌐 Zig | 📅 2026-08-24 - A high performance machine learning stack for Zig.
...
* [ggml-zig](https://github.com/codingonion/ggml-zig) - A replacement for [ggml: Tensor library for machine learning](https://github.com/ggerganov/ggml) ⭐ 15,221 | 🐛 352 | 🌐 C++ | 📅 2026-08-21 written in Zig.

### Large Language Model

* [nullclaw/nullclaw](https://github.com/nullclaw/nullclaw) ⭐ 8,045 | 🐛 89 | 🌐 Zig | 📅 2026-07-19 - Fastest, smallest, and fully autonomous AI assistant infrastructure written in Zig.
* [ddalcu/mlx-serve](https://github.com/ddalcu/mlx-serve) ⭐ 787 | 🐛 33 | 🌐 Zig | 📅 2026-08-24 - Native LLM inference server for Apple Silicon (MLX + GGUF) with OpenAI- and Anthropic-compatible APIs; ships MLX Core, a macOS menu-bar app. MIT.
...
* [EugenHotaj/zig\_gpt2](https://github.com/EugenHotaj/zig_gpt2) ⭐ 39 | 🐛 0 | 🌐 Zig | 📅 2023-07-24 - Neural Network Inference Engine in Zig. GPT2 inference engine written in Zig. The inference engine can run [NanoGPT](https://github.com/karpathy/nanoGPT) ⭐ 62,442 | 🐛 352 | 🌐 Python | 📅 2025-11-12.
...
* [Snektron/vulkan-zig](https://github.com/Snektron/vulkan-zig) ⭐ 901 | 🐛 25 | 🌐 Zig | 📅 2026-08-23 - Vulkan binding generator for Zig.
...
* [anomalyco/opentui](https://github.com/anomalyco/opentui) ⭐ 13,135 | 🐛 212 | 🌐 TypeScript | 📅 2026-08-24 - A library for building terminal user interfaces.
* [rockorager/libvaxis](https://github.com/rockorager/libvaxis) ⭐ 1,974 | 🐛 34 | 🌐 Zig | 📅 2026-08-20 - Modern TUI library written in Zig.
...
* [Capy](https://github.com/capy-ui/capy) ⭐ 2,678 | 🐛 25 | 🌐 Zig | 📅 2025-12-25 - Build one codebase and get native UI on Windows, Linux and Web. [capy-ui.org](https://capy-ui.org/).
...
* [webui-dev/zig-webui](https://github.com/webui-dev/zig-webui) ⭐ 826 | 🐛 10 | 🌐 Zig | 📅 2026-08-03 - Use any web browser or WebView as GUI, with your preferred language in the backend and HTML5 in the frontend, all in a lightweight portable lib.
* [meszmate/zigzag](https://github.com/meszmate/zigzag) ⭐ 528 | 🐛 0 | 🌐 Zig | 📅 2026-08-14 - The TUI Framework for Zig.
* [rcalixte/libqt6zig](https://github.com/rcalixte/libqt6zig) ⭐ 262 | 🐛 0 | 🌐 Zig | 📅 2026-08-19 - Qt 6 for Zig.
...
* [Mach](https://github.com/hexops/mach) ⭐ 4,827 | 🐛 167 | 🌐 Zig | 📅 2026-05-23 - A game engine & graphics toolkit for the future. machengine.org.
* [PixelGuys/Cubyz](https://github.com/PixelGuys/Cubyz) ⭐ 3,624 | 🐛 953 | 🌐 Zig | 📅 2026-08-23 - Voxel sandbox game with a large render distance, procedurally generated content and some cool graphical effects.
...
* [dmtrKovalenko/odiff](https://github.com/dmtrKovalenko/odiff) ⭐ 3,169 | 🐛 16 | 🌐 Zig | 📅 2026-08-21 - ODiff - A very fast SIMD-first image comparison library (with Node.js API).
...
* [natecraddock/ziglua](https://github.com/natecraddock/ziglua) ⭐ 518 | 🐛 10 | 🌐 Zig | 📅 2026-08-04 - Zig bindings for the Lua C API.
...
* [raylib](https://github.com/raysan5/raylib/) ⭐ 34,446 | 🐛 25 | 🌐 C | 📅 2026-08-23 - A simple and easy-to-use library to enjoy videogames programming.
