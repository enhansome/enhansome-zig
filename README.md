...
* [zigtools/zls](https://github.com/zigtools/zls) ⭐ 5,075 | 🐛 158 | 🌐 Zig | 📅 2026-08-14 - The @ziglang language server for all your Zig editor tooling needs, from autocomplete to goto-def! [installation](https://zigtools.org/zls/install/).
* [neurocyte/flow](https://github.com/neurocyte/flow) ⭐ 2,174 | 🐛 82 | 🌐 Zig | 📅 2026-08-14 - Flow Control - a programmer's text editor written in Zig.
...
* [DonIsaac/zlint](https://github.com/DonIsaac/zlint) ⭐ 304 | 🐛 37 | 🌐 Zig | 📅 2026-08-16 - Linter for the Zig programming language.
...
* [justrach/nanobrew](https://github.com/justrach/nanobrew) ⭐ 1,102 | 🐛 7 | 🌐 Zig | 📅 2026-08-15 - A fast macOS package manager written in Zig.
...
* [mitchellh/zig-overlay](https://github.com/mitchellh/zig-overlay) ⭐ 538 | 🐛 10 | 🌐 Nix | 📅 2026-08-16 - Nix flake for the Zig compiler.
...
* [Cloudef/zig2nix](https://github.com/Cloudef/zig2nix) ⭐ 186 | 🐛 7 | 🌐 Zig | 📅 2026-08-16 - Flake for packaging, building and running Zig projects.
...
* [asdf-community/asdf-zig](https://github.com/asdf-community/asdf-zig) ⭐ 81 | 🐛 0 | 🌐 Python | 📅 2026-08-14 - Zig plugin for the [asdf](https://github.com/asdf-vm/asdf) ⭐ 25,528 | 🐛 152 | 🌐 Go | 📅 2026-08-12 version manager.
...
* [ghostty](https://github.com/ghostty-org/ghostty) ⭐ 59,708 | 🐛 258 | 🌐 Zig | 📅 2026-08-16 - Modern terminal emulator written in Zig.
* [NilsIrl/dockerc](https://github.com/NilsIrl/dockerc) ⭐ 4,913 | 🐛 25 | 🌐 Zig | 📅 2025-01-02 - Container image to single executable compiler.
* [zmx](https://github.com/neurosnap/zmx) ⭐ 2,039 | 🐛 28 | 🌐 Zig | 📅 2026-08-14 - Session persistence for terminal processes.
* [Illusionna/LocalTransfer](https://github.com/Illusionna/LocalTransfer) ⭐ 554 | 🐛 0 | 🌐 Zig | 📅 2026-08-09 - A fast cross-platform HTTP file server.
...
* [zlist](https://github.com/here-Leslie-Lau/zlist) ⭐ 58 | 🐛 5 | 🌐 Zig | 📅 2026-08-12 - A simple, colorful alternative to ls built with Zig.
* [forketyfork/architect](https://github.com/forketyfork/architect) ⭐ 45 | 🐛 10 | 🌐 Zig | 📅 2026-08-16 - A flexible terminal grid for multi-agent AI workflows.
...
* [andrewrk/poop](https://github.com/andrewrk/poop) ⭐ 2,023 | 🐛 29 | 🌐 Zig | 📅 2026-05-04 - CLI Performance Observer written in Zig.
...
* [dweiller/zimalloc](https://github.com/dweiller/zimalloc) ⭐ 48 | 🐛 7 | 🌐 Zig | 📅 2025-10-07 - A general purpose allocator for Zig, inspired by [mimalloc](https://github.com/microsoft/mimalloc) ⭐ 13,295 | 🐛 323 | 🌐 C | 📅 2026-08-16.
...
* [hello-algo-zig](https://github.com/codingonion/hello-algo-zig) ⭐ 82 | 🐛 0 | 🌐 Zig | 📅 2023-07-16 - Zig programming language codes for the famous public project [《Hello, Algorithm》|《 Hello，算法 》](https://github.com/krahets/hello-algo) ⭐ 129,407 | 🐛 41 | 🌐 Java | 📅 2026-07-24 about data structures and algorithms.
...
* [OrlovEvgeny/serde.zig](https://github.com/OrlovEvgeny/serde.zig) ⭐ 79 | 🐛 3 | 🌐 Zig | 📅 2026-08-11 - Comptime serialization framework for Zig supporting JSON, MessagePack, TOML, YAML, ZON, and CSV.
...
* [scento/zig-date](https://github.com/scento/zig-date) ⭐ 7 | 🐛 0 | 🌐 Zig | 📅 2023-03-26 - Time and date for Zig. Zig-date is a date and time library for the Zig, inspired by the popular Rust library [chrono](https://github.com/chronotope/chrono) ⭐ 3,894 | 🐛 195 | 🌐 Rust | 📅 2026-08-03.
...
* [mitchellh/libxev](https://github.com/mitchellh/libxev) ⭐ 3,559 | 🐛 55 | 🌐 Zig | 📅 2026-07-17 - A cross-platform, high-performance event loop that provides abstractions for non-blocking IO, timers, events, and more and works on Linux (io\_uring or epoll), macOS (kqueue), and WebAssembly + WASI. Available as both a Zig and C API.
...
* [ZigEmbeddedGroup/microzig](https://github.com/ZigEmbeddedGroup/microzig) ⭐ 2,252 | 🐛 79 | 🌐 Zig | 📅 2026-08-14 - Unified abstraction layer and HAL for several microcontrollers.
...
* [lupyuen/pinephone-nuttx](https://github.com/lupyuen/pinephone-nuttx) ⭐ 101 | 🐛 0 | 🌐 Zig | 📅 2026-08-16 - Apache NuttX RTOS for PinePhone. Apache NuttX is a lightweight Real-Time Operating System (RTOS) that runs on PINE64 PinePhone. [lupyuen.github.io/articles/what](https://lupyuen.github.io/articles/what).
...
* [karlseguin/http.zig](https://github.com/karlseguin/http.zig) ⭐ 1,582 | 🐛 15 | 🌐 Zig | 📅 2026-08-12 - An HTTP/1.1 server for Zig.
...
* [lightpanda-io/browser](https://github.com/lightpanda-io/browser) ⭐ 33,921 | 🐛 87 | 🌐 Zig | 📅 2026-08-15 - Headless browser designed for AI and automation.

### Web Framework

* [zigzap/zap](https://github.com/zigzap/zap) ⭐ 3,401 | 🐛 28 | 🌐 C | 📅 2026-06-01 - Blazingly fast web backends in Zig.
* [kristoff-it/zine](https://github.com/kristoff-it/zine) ⭐ 1,529 | 🐛 51 | 🌐 Zig | 📅 2026-08-12 - Static Site Generator written in Zig.
...
* [blockblaz/ssz.zig](https://github.com/blockblaz/ssz.zig) ⭐ 34 | 🐛 15 | 🌐 Zig | 📅 2026-08-11 - A Zig implementation of the [SSZ serialization protocol](https://github.com/ethereum/eth2.0-specs/blob/dev/ssz/simple-serialize.md) ⭐ 3,959 | 🐛 62 | 🌐 Python | 📅 2026-08-16.
...
* [tigerbeetle](https://github.com/tigerbeetle/tigerbeetle) ⭐ 16,793 | 🐛 124 | 🌐 Zig | 📅 2026-08-04 - The distributed financial accounting database designed for mission critical safety and performance. [tigerbeetle.com](https://tigerbeetle.com/).
...
* [seqor/seqor](https://github.com/seqor/seqor) ⭐ 54 | 🐛 0 | 🌐 Zig | 📅 2026-08-15 - Seqor is a cost-effective, Loki compatible database for logs.
...
* [zml](https://github.com/zml/zml) ⭐ 3,977 | 🐛 40 | 🌐 Zig | 📅 2026-08-03 - A high performance machine learning stack for Zig.
...
* [ggml-zig](https://github.com/codingonion/ggml-zig) - A replacement for [ggml: Tensor library for machine learning](https://github.com/ggerganov/ggml) ⭐ 15,179 | 🐛 345 | 🌐 C++ | 📅 2026-08-14 written in Zig.

### Large Language Model

* [nullclaw/nullclaw](https://github.com/nullclaw/nullclaw) ⭐ 8,024 | 🐛 86 | 🌐 Zig | 📅 2026-07-19 - Fastest, smallest, and fully autonomous AI assistant infrastructure written in Zig.
* [ddalcu/mlx-serve](https://github.com/ddalcu/mlx-serve) ⭐ 680 | 🐛 19 | 🌐 Zig | 📅 2026-08-16 - Native LLM inference server for Apple Silicon (MLX + GGUF) with OpenAI- and Anthropic-compatible APIs; ships MLX Core, a macOS menu-bar app. MIT.
...
* [EugenHotaj/zig\_gpt2](https://github.com/EugenHotaj/zig_gpt2) ⭐ 39 | 🐛 0 | 🌐 Zig | 📅 2023-07-24 - Neural Network Inference Engine in Zig. GPT2 inference engine written in Zig. The inference engine can run [NanoGPT](https://github.com/karpathy/nanoGPT) ⭐ 62,134 | 🐛 351 | 🌐 Python | 📅 2025-11-12.
...
* [anomalyco/opentui](https://github.com/anomalyco/opentui) ⭐ 13,023 | 🐛 217 | 🌐 TypeScript | 📅 2026-08-16 - A library for building terminal user interfaces.
* [rockorager/libvaxis](https://github.com/rockorager/libvaxis) ⭐ 1,961 | 🐛 36 | 🌐 Zig | 📅 2026-08-15 - Modern TUI library written in Zig.
...
* [fabioarnold/nanovg-zig](https://github.com/fabioarnold/nanovg-zig) ⭐ 245 | 🐛 1 | 🌐 C | 📅 2026-01-29 - [NanoVG](https://github.com/memononen/nanovg) ⭐ 5,690 | 🐛 321 | 🌐 C | 📅 2026-02-19 - Zig Version. A small anti-aliased hardware-accelerated vector graphics library. [fabioarnold.github.io/nanovg-zig/](https://fabioarnold.github.io/nanovg-zig/).
...
* [Capy](https://github.com/capy-ui/capy) ⭐ 2,674 | 🐛 25 | 🌐 Zig | 📅 2025-12-25 - Build one codebase and get native UI on Windows, Linux and Web. [capy-ui.org](https://capy-ui.org/).
* [david-vanderson/dvui](https://github.com/david-vanderson/dvui) ⭐ 1,625 | 🐛 98 | 🌐 Zig | 📅 2026-08-12 - Easy to Integrate Immediate Mode GUI for Zig.
...
* [PixelGuys/Cubyz](https://github.com/PixelGuys/Cubyz) ⭐ 3,611 | 🐛 944 | 🌐 Zig | 📅 2026-08-15 - Voxel sandbox game with a large render distance, procedurally generated content and some cool graphical effects.
...
* [dmtrKovalenko/odiff](https://github.com/dmtrKovalenko/odiff) ⭐ 3,155 | 🐛 17 | 🌐 Zig | 📅 2026-07-23 - ODiff - A very fast SIMD-first image comparison library (with Node.js API).
...
* [raylib](https://github.com/raysan5/raylib/) ⭐ 34,338 | 🐛 31 | 🌐 C | 📅 2026-08-13 - A simple and easy-to-use library to enjoy videogames programming.
