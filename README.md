...
* [zigtools/zls](https://github.com/zigtools/zls) ⭐ 5,121 | 🐛 169 | 🌐 Zig | 📅 2026-09-07 - The @ziglang language server for all your Zig editor tooling needs, from autocomplete to goto-def! [installation](https://zigtools.org/zls/install/).
* [neurocyte/flow](https://github.com/neurocyte/flow) ⭐ 2,217 | 🐛 80 | 🌐 Zig | 📅 2026-09-09 - Flow Control - a programmer's text editor written in Zig.
...
* [KurtWagner/zlinter](https://github.com/KurtWagner/zlinter) ⭐ 95 | 🐛 5 | 🌐 Zig | 📅 2026-08-20 - Zig linter that is integrated from source into your `build.zig`.
* [forketyfork/zwanzig](https://github.com/forketyfork/zwanzig) ⭐ 29 | 🐛 1 | 🌐 Zig | 📅 2026-09-04 - Static analyzer for Zig with CFG-based checks (leaks, double-free, optional unwrap, stack escapes).
...
* [sb2bg/marionette](https://github.com/sb2bg/marionette) ⭐ 82 | 🐛 1 | 🌐 Zig | 📅 2026-09-08 - Deterministic simulation testing for Zig with a `std.Io` implementation, letting you inject faults and replay failures from seeds.
...
* [justrach/nanobrew](https://github.com/justrach/nanobrew) ⭐ 1,115 | 🐛 0 | 🌐 Zig | 📅 2026-09-09 - A fast macOS package manager written in Zig.
* [tristanisham/zvm](https://github.com/tristanisham/zvm) ⭐ 1,057 | 🐛 3 | 🌐 Go | 📅 2026-09-10 - Lets you easily install/upgrade between different versions of Zig. ZLS install can be included. (written in Go).
* [nektro/zigmod](https://github.com/nektro/zigmod) ⭐ 946 | 🐛 18 | 🌐 Zig | 📅 2026-09-04 - A package manager for the Zig programming language.
* [mitchellh/zig-overlay](https://github.com/mitchellh/zig-overlay) ⭐ 545 | 🐛 10 | 🌐 Nix | 📅 2026-09-09 - Nix flake for the Zig compiler.
...
* [Cloudef/zig2nix](https://github.com/Cloudef/zig2nix) ⭐ 191 | 🐛 6 | 🌐 Zig | 📅 2026-09-10 - Flake for packaging, building and running Zig projects.
* [indaco/malt](https://github.com/indaco/malt) ⭐ 165 | 🐛 3 | 🌐 Zig | 📅 2026-09-10 - Homebrew's whole ecosystem, none of its weight: a single Zig binary with native post\_install and a themeable TUI and CLI.
...
* [asdf-community/asdf-zig](https://github.com/asdf-community/asdf-zig) ⭐ 82 | 🐛 1 | 🌐 Python | 📅 2026-08-14 - Zig plugin for the [asdf](https://github.com/asdf-vm/asdf) ⭐ 25,577 | 🐛 144 | 🌐 Go | 📅 2026-09-03 version manager.
...
* [ghostty](https://github.com/ghostty-org/ghostty) ⭐ 60,918 | 🐛 249 | 🌐 Zig | 📅 2026-09-10 - Modern terminal emulator written in Zig.
* [NilsIrl/dockerc](https://github.com/NilsIrl/dockerc) ⭐ 4,919 | 🐛 25 | 🌐 Zig | 📅 2025-01-02 - Container image to single executable compiler.
* [zmx](https://github.com/neurosnap/zmx) ⭐ 2,127 | 🐛 22 | 🌐 Zig | 📅 2026-09-05 - Session persistence for terminal processes.
* [Illusionna/LocalTransfer](https://github.com/Illusionna/LocalTransfer) ⭐ 597 | 🐛 0 | 🌐 Zig | 📅 2026-09-03 - A fast cross-platform HTTP file server.
* [Arnau478/hevi](https://github.com/Arnau478/hevi) ⚠️ Archived - A minimalistic and modernized hex viewer, written in Zig.
* [BrookJeynes/jido](https://github.com/BrookJeynes/jido) ⭐ 82 | 🐛 2 | 🌐 Zig | 📅 2026-09-08 - Jido (formerly known as zte) is a small terminal file explorer, written in Zig.
* [midasdf/zt](https://github.com/midasdf/zt) ⭐ 67 | 🐛 0 | 🌐 Zig | 📅 2026-07-04 - Ultra-fast, minimal terminal emulator written in Zig with fbdev, X11, Wayland, and macOS backends.
* [zlist](https://github.com/here-Leslie-Lau/zlist) ⭐ 62 | 🐛 3 | 🌐 Zig | 📅 2026-09-08 - A simple, colorful alternative to ls built with Zig.
...
* [bare-devcontainer/templates](https://github.com/bare-devcontainer/templates/tree/main/src/zig) ⭐ 1 | 🐛 1 | 🌐 Shell | 📅 2026-09-10 - Security-focused Zig dev container with zls integration and a persistent build cache. The base image is available at [bare-devcontainer/images](https://github.com/bare-devcontainer/images/tree/main/zig) ⭐ 2 | 🐛 2 | 🌐 Shell | 📅 2026-09-10.
...
* [deatil/zig-rsa](https://github.com/deatil/zig-rsa) ⭐ 0 | 🐛 0 | 🌐 Zig | 📅 2026-09-09 - An RSA library for Zig. No-AI.
...
* [hendriknielaender/zBench](https://github.com/hendriknielaender/zBench) ⭐ 226 | 🐛 8 | 🌐 Zig | 📅 2026-06-24 - Simple benchmarking library.
...
* [dweiller/zimalloc](https://github.com/dweiller/zimalloc) ⭐ 48 | 🐛 7 | 🌐 Zig | 📅 2025-10-07 - A general purpose allocator for Zig, inspired by [mimalloc](https://github.com/microsoft/mimalloc) ⭐ 13,359 | 🐛 302 | 🌐 C | 📅 2026-09-10.
...
* [hello-algo-zig](https://github.com/codingonion/hello-algo-zig) ⭐ 82 | 🐛 0 | 🌐 Zig | 📅 2023-07-16 - Zig programming language codes for the famous public project [《Hello, Algorithm》|《 Hello，算法 》](https://github.com/krahets/hello-algo) ⭐ 129,997 | 🐛 41 | 🌐 Java | 📅 2026-08-17 about data structures and algorithms.
...
* [scento/zig-date](https://github.com/scento/zig-date) ⭐ 7 | 🐛 0 | 🌐 Zig | 📅 2023-03-26 - Time and date for Zig. Zig-date is a date and time library for the Zig, inspired by the popular Rust library [chrono](https://github.com/chronotope/chrono) ⭐ 3,905 | 🐛 194 | 🌐 Rust | 📅 2026-09-07.
...
* [Hejsil/zig-clap](https://github.com/Hejsil/zig-clap) ⭐ 1,611 | 🐛 7 | 🌐 Zig | 📅 2026-08-31 - A simple and easy to use command line argument parser library for Zig.
...
* [CogitatorTech/chilli](https://github.com/CogitatorTech/chilli) ⭐ 58 | 🐛 2 | 🌐 Zig | 📅 2026-07-19 - Chilli 🌶️ is a minimalistic CLI framework for Zig.
...
* [mitchellh/libxev](https://github.com/mitchellh/libxev) ⭐ 3,583 | 🐛 60 | 🌐 Zig | 📅 2026-07-17 - A cross-platform, high-performance event loop that provides abstractions for non-blocking IO, timers, events, and more and works on Linux (io\_uring or epoll), macOS (kqueue), and WebAssembly + WASI. Available as both a Zig and C API.
...
* [ZigEmbeddedGroup/microzig](https://github.com/ZigEmbeddedGroup/microzig) ⭐ 2,278 | 🐛 83 | 🌐 Zig | 📅 2026-09-10 - Unified abstraction layer and HAL for several microcontrollers.
...
* [lupyuen/pinephone-nuttx](https://github.com/lupyuen/pinephone-nuttx) ⭐ 102 | 🐛 0 | 🌐 Zig | 📅 2026-09-10 - Apache NuttX RTOS for PinePhone. Apache NuttX is a lightweight Real-Time Operating System (RTOS) that runs on PINE64 PinePhone. [lupyuen.github.io/articles/what](https://lupyuen.github.io/articles/what).
...
* [Aro](https://github.com/Vexu/arocc) ⭐ 1,806 | 🐛 48 | 🌐 Zig | 📅 2026-09-06 - A C compiler with the goal of providing fast compilation and low memory usage with good diagnostics.
...
* [Fun](https://github.com/omdxp/fun) ⭐ 127 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-10 - A statically-typed language that transpiles to C, combining safety and performance with C's efficiency.
...
* [zish](https://github.com/rotkonetworks/zish) ⭐ 8 | 🐛 3 | 🌐 Zig | 📅 2026-09-09 - An opinionated shell written in Zig.
...
* [sleep3r/mtproto.zig](https://github.com/sleep3r/mtproto.zig) ⭐ 1,744 | 🐛 6 | 🌐 Zig | 📅 2026-09-08 - High-performance Telegram MTProto proxy written in Zig.
* [karlseguin/http.zig](https://github.com/karlseguin/http.zig) ⭐ 1,599 | 🐛 15 | 🌐 Zig | 📅 2026-08-26 - An HTTP/1.1 server for Zig.
* [tardy-org/zzz](https://github.com/tardy-org/zzz) ⭐ 783 | 🐛 18 | 🌐 Zig | 📅 2026-09-05 - A framework for writing performant and reliable networked services in Zig. Supports HTTP and HTTPS.
...
* [muhammad-fiaz/httpx.zig](https://github.com/muhammad-fiaz/httpx.zig) ⭐ 90 | 🐛 4 | 🌐 Zig | 📅 2026-09-09 - Production-ready HTTP/1.x/2/3 client and server runtime for Zig with proxy support, concurrency, and protocol primitives.
...
* [lightpanda-io/browser](https://github.com/lightpanda-io/browser) ⭐ 35,254 | 🐛 96 | 🌐 Zig | 📅 2026-09-10 - Headless browser designed for AI and automation.
...
* [nurulhudaapon/zx](https://github.com/nurulhudaapon/zx) ⭐ 334 | 🐛 31 | 🌐 Zig | 📅 2026-08-30 - A full-stack web framework for Zig.
...
* [deatil/zig-jwt](https://github.com/deatil/zig-jwt) ⭐ 21 | 🐛 0 | 🌐 Zig | 📅 2026-09-10 - A JWT(JSON Web Token) library for Zig.
* [im-ng/zero](https://github.com/im-ng/zero) ⭐ 21 | 🐛 3 | 🌐 Zig | 📅 2026-09-10 - Simple and opinionated web framework written in Zig and aims to make microservices development in Zig easier.
...
* [deatil/zig-paseto](https://github.com/deatil/zig-paseto) ⭐ 3 | 🐛 0 | 🌐 Zig | 📅 2026-09-09 - A PASETO (Platform-Agnostic SEcurity TOkens) library for Zig.
...
* [StrobeLabs/eth.zig](https://github.com/StrobeLabs/eth.zig) ⭐ 84 | 🐛 25 | 🌐 C | 📅 2026-09-09 - Pure Zig Ethereum client library. Zero dependencies, comptime-first.
...
* [blockblaz/ssz.zig](https://github.com/blockblaz/ssz.zig) ⭐ 34 | 🐛 17 | 🌐 Zig | 📅 2026-09-01 - A Zig implementation of the [SSZ serialization protocol](https://github.com/ethereum/eth2.0-specs/blob/dev/ssz/simple-serialize.md) ⭐ 3,961 | 🐛 61 | 🌐 Python | 📅 2026-09-09.
...
* [zwasm](https://github.com/zwasm/zwasm) ⭐ 173 | 🐛 50 | 🌐 Zig | 📅 2026-09-10 - From-scratch WebAssembly runtime in Zig. Full WebAssembly 3.0 with 100% spec conformance, WASI 0.1/0.2/0.3, and interpreter + JIT (arm64/x86\_64) + AOT backends.
...
* [tigerbeetle](https://github.com/tigerbeetle/tigerbeetle) ⭐ 16,991 | 🐛 104 | 🌐 Zig | 📅 2026-08-31 - The distributed financial accounting database designed for mission critical safety and performance. [tigerbeetle.com](https://tigerbeetle.com/).
* [vrischmann/zig-sqlite](https://github.com/vrischmann/zig-sqlite) ⭐ 619 | 🐛 6 | 🌐 C | 📅 2026-07-24 - Zig-SQLite is a small wrapper around SQLite's C API, making it easier to use with Zig.
* [karlseguin/pg.zig](https://github.com/karlseguin/pg.zig) ⭐ 595 | 🐛 4 | 🌐 Zig | 📅 2026-08-26 - Native PostgreSQL driver / client for Zig.
...
* [speed2exe/myzql](https://github.com/speed2exe/myzql) ⭐ 75 | 🐛 5 | 🌐 Zig | 📅 2026-09-09 - MySQL and MariaDB driver in native Zig.
...
* [kooparse/zalgebra](https://github.com/kooparse/zalgebra) ⭐ 331 | 🐛 1 | 🌐 Zig | 📅 2026-07-28 - Linear algebra library for games and real-time graphics.
...
* [zml](https://github.com/zml/zml) ⭐ 4,024 | 🐛 48 | 🌐 Zig | 📅 2026-09-10 - A high performance machine learning stack for Zig.
...
* [ggml-zig](https://github.com/codingonion/ggml-zig) - A replacement for [ggml: Tensor library for machine learning](https://github.com/ggerganov/ggml) ⭐ 15,326 | 🐛 360 | 🌐 C++ | 📅 2026-09-09 written in Zig.

### Large Language Model

* [nullclaw/nullclaw](https://github.com/nullclaw/nullclaw) ⭐ 8,080 | 🐛 94 | 🌐 Zig | 📅 2026-07-19 - Fastest, smallest, and fully autonomous AI assistant infrastructure written in Zig.
* [ddalcu/mlx-serve](https://github.com/ddalcu/mlx-serve) ⭐ 1,215 | 🐛 53 | 🌐 Zig | 📅 2026-09-10 - Native LLM inference server for Apple Silicon (MLX + GGUF) with OpenAI- and Anthropic-compatible APIs; ships MLX Core, a macOS menu-bar app. MIT.
...
* [EugenHotaj/zig\_gpt2](https://github.com/EugenHotaj/zig_gpt2) ⭐ 40 | 🐛 0 | 🌐 Zig | 📅 2023-07-24 - Neural Network Inference Engine in Zig. GPT2 inference engine written in Zig. The inference engine can run [NanoGPT](https://github.com/karpathy/nanoGPT) ⭐ 62,951 | 🐛 349 | 🌐 Python | 📅 2025-11-12.
...
* [Snektron/vulkan-zig](https://github.com/Snektron/vulkan-zig) ⭐ 910 | 🐛 24 | 🌐 Zig | 📅 2026-08-30 - Vulkan binding generator for Zig.
...
* [anomalyco/opentui](https://github.com/anomalyco/opentui) ⭐ 13,272 | 🐛 134 | 🌐 TypeScript | 📅 2026-09-09 - A library for building terminal user interfaces.
* [rockorager/libvaxis](https://github.com/rockorager/libvaxis) ⭐ 1,996 | 🐛 34 | 🌐 Zig | 📅 2026-09-08 - Modern TUI library written in Zig.
...
* [david-vanderson/dvui](https://github.com/david-vanderson/dvui) ⭐ 1,655 | 🐛 98 | 🌐 Zig | 📅 2026-09-09 - Easy to Integrate Immediate Mode GUI for Zig.
...
* [meszmate/zigzag](https://github.com/meszmate/zigzag) ⭐ 549 | 🐛 7 | 🌐 Zig | 📅 2026-09-03 - The TUI Framework for Zig.
...
* [PixelGuys/Cubyz](https://github.com/PixelGuys/Cubyz) ⭐ 3,651 | 🐛 920 | 🌐 Zig | 📅 2026-09-07 - Voxel sandbox game with a large render distance, procedurally generated content and some cool graphical effects.
...
* [dmtrKovalenko/odiff](https://github.com/dmtrKovalenko/odiff) ⭐ 3,187 | 🐛 15 | 🌐 Zig | 📅 2026-08-24 - ODiff - A very fast SIMD-first image comparison library (with Node.js API).
...
* [fulcrum-so/ziggy-pydust](https://github.com/fulcrum-so/ziggy-pydust) ⭐ 787 | 🐛 46 | 🌐 Zig | 📅 2026-09-08 - A toolkit for building Python extensions in Zig. [pydust.fulcrum.so/](https://pydust.fulcrum.so/).
* [floooh/sokol-zig](https://github.com/floooh/sokol-zig) ⭐ 725 | 🐛 13 | 🌐 C | 📅 2026-09-10 - Zig bindings for the sokol headers.
* [natecraddock/ziglua](https://github.com/natecraddock/ziglua) ⭐ 522 | 🐛 9 | 🌐 Zig | 📅 2026-09-03 - Zig bindings for the Lua C API.
* [mitchellh/zig-objc](https://github.com/mitchellh/zig-objc) ⭐ 349 | 🐛 3 | 🌐 Zig | 📅 2026-04-17 - Objective-C runtime bindings for Zig (Zig calling ObjC).
...
* [happystraw/phpz](https://github.com/happystraw/phpz) ⭐ 5 | 🐛 1 | 🌐 Zig | 📅 2026-09-10 - Build PHP extensions with Zig.
...
* [raylib](https://github.com/raysan5/raylib/) ⭐ 34,656 | 🐛 20 | 🌐 C | 📅 2026-09-08 - A simple and easy-to-use library to enjoy videogames programming.
* [libxlsxwriter](https://github.com/jmcnamara/libxlsxwriter) ⭐ 1,757 | 🐛 20 | 🌐 C | 📅 2026-07-07 - A C library for creating Excel XLSX files, build system replaced by Zig.
