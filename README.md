...
* [neurocyte/flow](https://github.com/neurocyte/flow) ⭐ 2,198 | 🐛 80 | 🌐 Zig | 📅 2026-08-28 - Flow Control - a programmer's text editor written in Zig.
...
* [ghostty](https://github.com/ghostty-org/ghostty) ⭐ 60,395 | 🐛 239 | 🌐 Zig | 📅 2026-08-28 - Modern terminal emulator written in Zig.
* [NilsIrl/dockerc](https://github.com/NilsIrl/dockerc) ⭐ 4,915 | 🐛 25 | 🌐 Zig | 📅 2025-01-02 - Container image to single executable compiler.
* [zmx](https://github.com/neurosnap/zmx) ⭐ 2,091 | 🐛 29 | 🌐 Zig | 📅 2026-08-27 - Session persistence for terminal processes.
...
* [bare-devcontainer/templates](https://github.com/bare-devcontainer/templates/tree/main/src/zig) ⭐ 1 | 🐛 2 | 🌐 Shell | 📅 2026-08-29 - Security-focused Zig dev container with zls integration and a persistent build cache. The base image is available at [bare-devcontainer/images](https://github.com/bare-devcontainer/images/tree/main/zig) ⭐ 2 | 🐛 1 | 🌐 Shell | 📅 2026-08-29.
...
* [hello-algo-zig](https://github.com/codingonion/hello-algo-zig) ⭐ 82 | 🐛 0 | 🌐 Zig | 📅 2023-07-16 - Zig programming language codes for the famous public project [《Hello, Algorithm》|《 Hello，算法 》](https://github.com/krahets/hello-algo) ⭐ 129,656 | 🐛 42 | 🌐 Java | 📅 2026-08-17 about data structures and algorithms.
...
* [scento/zig-date](https://github.com/scento/zig-date) ⭐ 7 | 🐛 0 | 🌐 Zig | 📅 2023-03-26 - Time and date for Zig. Zig-date is a date and time library for the Zig, inspired by the popular Rust library [chrono](https://github.com/chronotope/chrono) ⭐ 3,901 | 🐛 194 | 🌐 Rust | 📅 2026-08-03.
...
* [Element 0](https://github.com/Element0Lang/element-0) ⭐ 29 | 🐛 3 | 🌐 Zig | 📅 2026-08-28 - A small embeddable Lisp dialect written in Zig.
...
* [sleep3r/mtproto.zig](https://github.com/sleep3r/mtproto.zig) ⭐ 1,474 | 🐛 0 | 🌐 Zig | 📅 2026-08-27 - High-performance Telegram MTProto proxy written in Zig.
...
* [muhammad-fiaz/httpx.zig](https://github.com/muhammad-fiaz/httpx.zig) ⭐ 86 | 🐛 6 | 🌐 Zig | 📅 2026-08-29 - Production-ready HTTP/1.x/2/3 client and server runtime for Zig with proxy support, concurrency, and protocol primitives.
...
* [lightpanda-io/browser](https://github.com/lightpanda-io/browser) ⭐ 34,301 | 🐛 104 | 🌐 Zig | 📅 2026-08-29 - Headless browser designed for AI and automation.
...
* [blockblaz/ssz.zig](https://github.com/blockblaz/ssz.zig) ⭐ 34 | 🐛 16 | 🌐 Zig | 📅 2026-08-11 - A Zig implementation of the [SSZ serialization protocol](https://github.com/ethereum/eth2.0-specs/blob/dev/ssz/simple-serialize.md) ⭐ 3,957 | 🐛 64 | 🌐 Python | 📅 2026-08-28.
...
* [tigerbeetle](https://github.com/tigerbeetle/tigerbeetle) ⭐ 16,922 | 🐛 107 | 🌐 Zig | 📅 2026-08-25 - The distributed financial accounting database designed for mission critical safety and performance. [tigerbeetle.com](https://tigerbeetle.com/).
...
* [zml](https://github.com/zml/zml) ⭐ 4,008 | 🐛 44 | 🌐 Zig | 📅 2026-08-28 - A high performance machine learning stack for Zig.
...
* [ggml-zig](https://github.com/codingonion/ggml-zig) - A replacement for [ggml: Tensor library for machine learning](https://github.com/ggerganov/ggml) ⭐ 15,253 | 🐛 352 | 🌐 C++ | 📅 2026-08-25 written in Zig.
...
* [ddalcu/mlx-serve](https://github.com/ddalcu/mlx-serve) ⭐ 867 | 🐛 35 | 🌐 Zig | 📅 2026-08-29 - Native LLM inference server for Apple Silicon (MLX + GGUF) with OpenAI- and Anthropic-compatible APIs; ships MLX Core, a macOS menu-bar app. MIT.
...
* [EugenHotaj/zig\_gpt2](https://github.com/EugenHotaj/zig_gpt2) ⭐ 40 | 🐛 0 | 🌐 Zig | 📅 2023-07-24 - Neural Network Inference Engine in Zig. GPT2 inference engine written in Zig. The inference engine can run [NanoGPT](https://github.com/karpathy/nanoGPT) ⭐ 62,559 | 🐛 351 | 🌐 Python | 📅 2025-11-12.
...
* [anomalyco/opentui](https://github.com/anomalyco/opentui) ⭐ 13,175 | 🐛 138 | 🌐 TypeScript | 📅 2026-08-29 - A library for building terminal user interfaces.
...
* [david-vanderson/dvui](https://github.com/david-vanderson/dvui) ⭐ 1,642 | 🐛 99 | 🌐 Zig | 📅 2026-08-28 - Easy to Integrate Immediate Mode GUI for Zig.
...
* [PixelGuys/Cubyz](https://github.com/PixelGuys/Cubyz) ⭐ 3,639 | 🐛 938 | 🌐 Zig | 📅 2026-08-28 - Voxel sandbox game with a large render distance, procedurally generated content and some cool graphical effects.
...
* [floooh/sokol-zig](https://github.com/floooh/sokol-zig) ⭐ 723 | 🐛 14 | 🌐 C | 📅 2026-08-28 - Zig bindings for the sokol headers.
...
* [raylib](https://github.com/raysan5/raylib/) ⭐ 34,494 | 🐛 15 | 🌐 C | 📅 2026-08-28 - A simple and easy-to-use library to enjoy videogames programming.
