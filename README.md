...
* [zigtools/zls](https://github.com/zigtools/zls) ⭐ 5,135 | 🐛 169 | 🌐 Zig | 📅 2026-09-11 - The @ziglang language server for all your Zig editor tooling needs, from autocomplete to goto-def! [installation](https://zigtools.org/zls/install/).
* [neurocyte/flow](https://github.com/neurocyte/flow) ⭐ 2,396 | 🐛 79 | 🌐 Zig | 📅 2026-09-18 - Flow Control - a programmer's text editor written in Zig.
...
* [tristanisham/zvm](https://github.com/tristanisham/zvm) ⭐ 1,064 | 🐛 3 | 🌐 Go | 📅 2026-09-19 - Lets you easily install/upgrade between different versions of Zig. ZLS install can be included. (written in Go).
* [nektro/zigmod](https://github.com/nektro/zigmod) ⭐ 946 | 🐛 18 | 🌐 Zig | 📅 2026-09-04 - A package manager for the Zig programming language.
* [mitchellh/zig-overlay](https://github.com/mitchellh/zig-overlay) ⭐ 547 | 🐛 10 | 🌐 Nix | 📅 2026-09-18 - Nix flake for the Zig compiler.
...
* [Cloudef/zig2nix](https://github.com/Cloudef/zig2nix) ⭐ 191 | 🐛 7 | 🌐 Zig | 📅 2026-09-19 - Flake for packaging, building and running Zig projects.
* [indaco/malt](https://github.com/indaco/malt) ⭐ 167 | 🐛 3 | 🌐 Zig | 📅 2026-09-19 - Homebrew's whole ecosystem, none of its weight: a single Zig binary with native post\_install and a themeable TUI and CLI.
...
* [asdf-community/asdf-zig](https://github.com/asdf-community/asdf-zig) ⭐ 82 | 🐛 1 | 🌐 Python | 📅 2026-08-14 - Zig plugin for the [asdf](https://github.com/asdf-vm/asdf) ⭐ 25,593 | 🐛 145 | 🌐 Go | 📅 2026-09-03 version manager.
...
* [ghostty](https://github.com/ghostty-org/ghostty) ⭐ 61,289 | 🐛 256 | 🌐 Zig | 📅 2026-09-18 - Modern terminal emulator written in Zig.
...
* [Illusionna/LocalTransfer](https://github.com/Illusionna/LocalTransfer) ⭐ 603 | 🐛 0 | 🌐 Zig | 📅 2026-09-03 - A fast cross-platform HTTP file server.
...
* [deatil/zig-rsa](https://github.com/deatil/zig-rsa) ⭐ 0 | 🐛 0 | 🌐 Zig | 📅 2026-09-19 - An RSA library for Zig. No-AI.
...
* [dweiller/zimalloc](https://github.com/dweiller/zimalloc) ⭐ 48 | 🐛 7 | 🌐 Zig | 📅 2025-10-07 - A general purpose allocator for Zig, inspired by [mimalloc](https://github.com/microsoft/mimalloc) ⭐ 13,374 | 🐛 300 | 🌐 C | 📅 2026-09-18.
...
* [deckarep/ziglang-set](https://github.com/deckarep/ziglang-set) ⭐ 108 | 🐛 5 | 🌐 Zig | 📅 2026-04-23 - A generic and general purpose Set implementation for the Zig language.
...
* [hello-algo-zig](https://github.com/codingonion/hello-algo-zig) ⭐ 82 | 🐛 0 | 🌐 Zig | 📅 2023-07-16 - Zig programming language codes for the famous public project [《Hello, Algorithm》|《 Hello，算法 》](https://github.com/krahets/hello-algo) ⭐ 130,276 | 🐛 40 | 🌐 Java | 📅 2026-08-17 about data structures and algorithms.
...
* [nDimensional/zig-flatbuffers](https://github.com/nDimensional/zig-flatbuffers) ⭐ 12 | 🐛 2 | 🌐 Zig | 📅 2026-06-01 - FlatBuffers codegen for Zig, in Zig.
...
* [ZigEmbeddedGroup/microzig](https://github.com/ZigEmbeddedGroup/microzig) ⭐ 2,279 | 🐛 82 | 🌐 Zig | 📅 2026-09-16 - Unified abstraction layer and HAL for several microcontrollers.
...
* [lupyuen/pinephone-nuttx](https://github.com/lupyuen/pinephone-nuttx) ⭐ 102 | 🐛 0 | 🌐 Zig | 📅 2026-09-19 - Apache NuttX RTOS for PinePhone. Apache NuttX is a lightweight Real-Time Operating System (RTOS) that runs on PINE64 PinePhone. [lupyuen.github.io/articles/what](https://lupyuen.github.io/articles/what).
...
* [Fun](https://github.com/omdxp/fun) ⭐ 325 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-19 - A statically-typed language that transpiles to C, combining safety and performance with C's efficiency.
...
* [sleep3r/mtproto.zig](https://github.com/sleep3r/mtproto.zig) ⭐ 1,890 | 🐛 5 | 🌐 Zig | 📅 2026-09-18 - High-performance Telegram MTProto proxy written in Zig.
...
* [lightpanda-io/browser](https://github.com/lightpanda-io/browser) ⭐ 35,437 | 🐛 81 | 🌐 Zig | 📅 2026-09-19 - Headless browser designed for AI and automation.
...
* [im-ng/zero](https://github.com/im-ng/zero) ⭐ 30 | 🐛 2 | 🌐 Zig | 📅 2026-09-18 - Simple and opinionated web framework written in Zig and aims to make microservices development in Zig easier.
...
* [blockblaz/ssz.zig](https://github.com/blockblaz/ssz.zig) ⭐ 34 | 🐛 17 | 🌐 Zig | 📅 2026-09-01 - A Zig implementation of the [SSZ serialization protocol](https://github.com/ethereum/eth2.0-specs/blob/dev/ssz/simple-serialize.md) ⭐ 3,967 | 🐛 66 | 🌐 Python | 📅 2026-09-16.
...
* [zwasm](https://github.com/zwasm/zwasm) ⭐ 179 | 🐛 64 | 🌐 Zig | 📅 2026-09-14 - From-scratch WebAssembly runtime in Zig. Full WebAssembly 3.0 with 100% spec conformance, WASI 0.1/0.2/0.3, and interpreter + JIT (arm64/x86\_64) + AOT backends.
...
* [tigerbeetle](https://github.com/tigerbeetle/tigerbeetle) ⭐ 17,041 | 🐛 109 | 🌐 Zig | 📅 2026-08-31 - The distributed financial accounting database designed for mission critical safety and performance. [tigerbeetle.com](https://tigerbeetle.com/).
...
* [zml](https://github.com/zml/zml) ⭐ 4,067 | 🐛 50 | 🌐 Zig | 📅 2026-09-18 - A high performance machine learning stack for Zig.
...
* [ggml-zig](https://github.com/codingonion/ggml-zig) - A replacement for [ggml: Tensor library for machine learning](https://github.com/ggerganov/ggml) ⭐ 15,372 | 🐛 364 | 🌐 C++ | 📅 2026-09-14 written in Zig.

### Large Language Model

* [nullclaw/nullclaw](https://github.com/nullclaw/nullclaw) ⭐ 8,100 | 🐛 95 | 🌐 Zig | 📅 2026-07-19 - Fastest, smallest, and fully autonomous AI assistant infrastructure written in Zig.
* [ddalcu/mlx-serve](https://github.com/ddalcu/mlx-serve) ⭐ 1,401 | 🐛 50 | 🌐 Zig | 📅 2026-09-19 - Native LLM inference server for Apple Silicon (MLX + GGUF) with OpenAI- and Anthropic-compatible APIs; ships MLX Core, a macOS menu-bar app. MIT.
...
* [EugenHotaj/zig\_gpt2](https://github.com/EugenHotaj/zig_gpt2) ⭐ 40 | 🐛 0 | 🌐 Zig | 📅 2023-07-24 - Neural Network Inference Engine in Zig. GPT2 inference engine written in Zig. The inference engine can run [NanoGPT](https://github.com/karpathy/nanoGPT) ⭐ 63,225 | 🐛 349 | 🌐 Python | 📅 2025-11-12.
...
* [anomalyco/opentui](https://github.com/anomalyco/opentui) ⭐ 13,342 | 🐛 144 | 🌐 TypeScript | 📅 2026-09-19 - A library for building terminal user interfaces.
...
* [vancluever/z2d](https://github.com/vancluever/z2d) ⭐ 299 | 🐛 11 | 🌐 Zig | 📅 2026-09-18 - A pure Zig 2D graphics library.
...
* [david-vanderson/dvui](https://github.com/david-vanderson/dvui) ⭐ 1,663 | 🐛 105 | 🌐 Zig | 📅 2026-09-18 - Easy to Integrate Immediate Mode GUI for Zig.
...
* [PixelGuys/Cubyz](https://github.com/PixelGuys/Cubyz) ⭐ 3,665 | 🐛 906 | 🌐 Zig | 📅 2026-09-19 - Voxel sandbox game with a large render distance, procedurally generated content and some cool graphical effects.
...
* [raylib](https://github.com/raysan5/raylib/) ⭐ 34,788 | 🐛 13 | 🌐 C | 📅 2026-09-19 - A simple and easy-to-use library to enjoy videogames programming.
