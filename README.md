...
* [neurocyte/flow](https://github.com/neurocyte/flow) ⭐ 2,352 | 🐛 78 | 🌐 Zig | 📅 2026-09-15 - Flow Control - a programmer's text editor written in Zig.
...
* [justrach/nanobrew](https://github.com/justrach/nanobrew) ⭐ 1,120 | 🐛 2 | 🌐 Zig | 📅 2026-09-16 - A fast macOS package manager written in Zig.
...
* [Cloudef/zig2nix](https://github.com/Cloudef/zig2nix) ⭐ 191 | 🐛 7 | 🌐 Zig | 📅 2026-09-17 - Flake for packaging, building and running Zig projects.
* [indaco/malt](https://github.com/indaco/malt) ⭐ 166 | 🐛 1 | 🌐 Zig | 📅 2026-09-17 - Homebrew's whole ecosystem, none of its weight: a single Zig binary with native post\_install and a themeable TUI and CLI.
...
* [ghostty](https://github.com/ghostty-org/ghostty) ⭐ 61,215 | 🐛 250 | 🌐 Zig | 📅 2026-09-16 - Modern terminal emulator written in Zig.
* [NilsIrl/dockerc](https://github.com/NilsIrl/dockerc) ⭐ 4,919 | 🐛 25 | 🌐 Zig | 📅 2025-01-02 - Container image to single executable compiler.
* [zmx](https://github.com/neurosnap/zmx) ⭐ 2,154 | 🐛 27 | 🌐 Zig | 📅 2026-09-12 - Session persistence for terminal processes.
* [Illusionna/LocalTransfer](https://github.com/Illusionna/LocalTransfer) ⭐ 608 | 🐛 0 | 🌐 Zig | 📅 2026-09-03 - A fast cross-platform HTTP file server.
...
* [deatil/zig-rsa](https://github.com/deatil/zig-rsa) ⭐ 0 | 🐛 0 | 🌐 Zig | 📅 2026-09-17 - An RSA library for Zig. No-AI.
...
* [hendriknielaender/zBench](https://github.com/hendriknielaender/zBench) ⭐ 227 | 🐛 8 | 🌐 Zig | 📅 2026-06-24 - Simple benchmarking library.
...
* [dweiller/zimalloc](https://github.com/dweiller/zimalloc) ⭐ 48 | 🐛 7 | 🌐 Zig | 📅 2025-10-07 - A general purpose allocator for Zig, inspired by [mimalloc](https://github.com/microsoft/mimalloc) ⭐ 13,367 | 🐛 299 | 🌐 C | 📅 2026-09-17.
...
* [hello-algo-zig](https://github.com/codingonion/hello-algo-zig) ⭐ 82 | 🐛 0 | 🌐 Zig | 📅 2023-07-16 - Zig programming language codes for the famous public project [《Hello, Algorithm》|《 Hello，算法 》](https://github.com/krahets/hello-algo) ⭐ 130,212 | 🐛 40 | 🌐 Java | 📅 2026-08-17 about data structures and algorithms.
...
* [peymanmortazavi/csv-zero](https://github.com/peymanmortazavi/csv-zero) ⭐ 29 | 🐛 6 | 🌐 Zig | 📅 2026-07-29 - Zero allocation, SIMD-accelerated CSV iterator and emitter for Zig.
...
* [scento/zig-date](https://github.com/scento/zig-date) ⭐ 7 | 🐛 0 | 🌐 Zig | 📅 2023-03-26 - Time and date for Zig. Zig-date is a date and time library for the Zig, inspired by the popular Rust library [chrono](https://github.com/chronotope/chrono) ⭐ 3,908 | 🐛 193 | 🌐 Rust | 📅 2026-09-07.
...
* [Hejsil/zig-clap](https://github.com/Hejsil/zig-clap) ⭐ 1,617 | 🐛 7 | 🌐 Zig | 📅 2026-08-31 - A simple and easy to use command line argument parser library for Zig.
...
* [neurocyte/thespian](https://github.com/neurocyte/thespian) ⭐ 34 | 🐛 0 | 🌐 C++ | 📅 2026-09-17 - An actor library for Zig, C & C++ applications.
...
* [ZigEmbeddedGroup/microzig](https://github.com/ZigEmbeddedGroup/microzig) ⭐ 2,281 | 🐛 81 | 🌐 Zig | 📅 2026-09-16 - Unified abstraction layer and HAL for several microcontrollers.
...
* [lupyuen/pinephone-nuttx](https://github.com/lupyuen/pinephone-nuttx) ⭐ 102 | 🐛 0 | 🌐 Zig | 📅 2026-09-17 - Apache NuttX RTOS for PinePhone. Apache NuttX is a lightweight Real-Time Operating System (RTOS) that runs on PINE64 PinePhone. [lupyuen.github.io/articles/what](https://lupyuen.github.io/articles/what).
...
* [Fun](https://github.com/omdxp/fun) ⭐ 361 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-17 - A statically-typed language that transpiles to C, combining safety and performance with C's efficiency.
...
* [sleep3r/mtproto.zig](https://github.com/sleep3r/mtproto.zig) ⭐ 1,875 | 🐛 5 | 🌐 Zig | 📅 2026-09-08 - High-performance Telegram MTProto proxy written in Zig.
...
* [lightpanda-io/browser](https://github.com/lightpanda-io/browser) ⭐ 35,401 | 🐛 79 | 🌐 Zig | 📅 2026-09-17 - Headless browser designed for AI and automation.

### Web Framework

* [zigzap/zap](https://github.com/zigzap/zap) ⚠️ Archived - Blazingly fast web backends in Zig.
* [kristoff-it/zine](https://github.com/kristoff-it/zine) ⭐ 1,569 | 🐛 56 | 🌐 Zig | 📅 2026-09-03 - Static Site Generator written in Zig.
...
* [nurulhudaapon/zx](https://github.com/nurulhudaapon/zx) ⭐ 336 | 🐛 31 | 🌐 Zig | 📅 2026-09-16 - A full-stack web framework for Zig.
...
* [im-ng/zero](https://github.com/im-ng/zero) ⭐ 28 | 🐛 2 | 🌐 Zig | 📅 2026-09-17 - Simple and opinionated web framework written in Zig and aims to make microservices development in Zig easier.
...
* [blockblaz/ssz.zig](https://github.com/blockblaz/ssz.zig) ⭐ 34 | 🐛 17 | 🌐 Zig | 📅 2026-09-01 - A Zig implementation of the [SSZ serialization protocol](https://github.com/ethereum/eth2.0-specs/blob/dev/ssz/simple-serialize.md) ⭐ 3,964 | 🐛 64 | 🌐 Python | 📅 2026-09-16.
...
* [tigerbeetle](https://github.com/tigerbeetle/tigerbeetle) ⭐ 17,033 | 🐛 106 | 🌐 Zig | 📅 2026-08-31 - The distributed financial accounting database designed for mission critical safety and performance. [tigerbeetle.com](https://tigerbeetle.com/).
* [vrischmann/zig-sqlite](https://github.com/vrischmann/zig-sqlite) ⭐ 618 | 🐛 6 | 🌐 C | 📅 2026-09-11 - Zig-SQLite is a small wrapper around SQLite's C API, making it easier to use with Zig.
* [karlseguin/pg.zig](https://github.com/karlseguin/pg.zig) ⭐ 596 | 🐛 6 | 🌐 Zig | 📅 2026-09-17 - Native PostgreSQL driver / client for Zig.
...
* [zml](https://github.com/zml/zml) ⭐ 4,057 | 🐛 51 | 🌐 Zig | 📅 2026-09-17 - A high performance machine learning stack for Zig.
...
* [ggml-zig](https://github.com/codingonion/ggml-zig) - A replacement for [ggml: Tensor library for machine learning](https://github.com/ggerganov/ggml) ⭐ 15,364 | 🐛 363 | 🌐 C++ | 📅 2026-09-14 written in Zig.

### Large Language Model

* [nullclaw/nullclaw](https://github.com/nullclaw/nullclaw) ⭐ 8,094 | 🐛 95 | 🌐 Zig | 📅 2026-07-19 - Fastest, smallest, and fully autonomous AI assistant infrastructure written in Zig.
* [ddalcu/mlx-serve](https://github.com/ddalcu/mlx-serve) ⭐ 1,363 | 🐛 36 | 🌐 Zig | 📅 2026-09-17 - Native LLM inference server for Apple Silicon (MLX + GGUF) with OpenAI- and Anthropic-compatible APIs; ships MLX Core, a macOS menu-bar app. MIT.
...
* [EugenHotaj/zig\_gpt2](https://github.com/EugenHotaj/zig_gpt2) ⭐ 40 | 🐛 0 | 🌐 Zig | 📅 2023-07-24 - Neural Network Inference Engine in Zig. GPT2 inference engine written in Zig. The inference engine can run [NanoGPT](https://github.com/karpathy/nanoGPT) ⭐ 63,168 | 🐛 349 | 🌐 Python | 📅 2025-11-12.
...
* [Snektron/vulkan-zig](https://github.com/Snektron/vulkan-zig) ⭐ 912 | 🐛 25 | 🌐 Zig | 📅 2026-08-30 - Vulkan binding generator for Zig.
...
* [anomalyco/opentui](https://github.com/anomalyco/opentui) ⭐ 13,324 | 🐛 140 | 🌐 TypeScript | 📅 2026-09-17 - A library for building terminal user interfaces.
* [rockorager/libvaxis](https://github.com/rockorager/libvaxis) ⭐ 2,009 | 🐛 34 | 🌐 Zig | 📅 2026-09-08 - Modern TUI library written in Zig.
...
* [vancluever/z2d](https://github.com/vancluever/z2d) ⭐ 298 | 🐛 11 | 🌐 Zig | 📅 2026-09-02 - A pure Zig 2D graphics library.
...
* [david-vanderson/dvui](https://github.com/david-vanderson/dvui) ⭐ 1,660 | 🐛 104 | 🌐 Zig | 📅 2026-09-17 - Easy to Integrate Immediate Mode GUI for Zig.
...
* [meszmate/zigzag](https://github.com/meszmate/zigzag) ⭐ 554 | 🐛 8 | 🌐 Zig | 📅 2026-09-03 - The TUI Framework for Zig.
* [rcalixte/libqt6zig](https://github.com/rcalixte/libqt6zig) ⭐ 266 | 🐛 0 | 🌐 Zig | 📅 2026-09-16 - Qt 6 for Zig.
...
* [PixelGuys/Cubyz](https://github.com/PixelGuys/Cubyz) ⭐ 3,663 | 🐛 913 | 🌐 Zig | 📅 2026-09-16 - Voxel sandbox game with a large render distance, procedurally generated content and some cool graphical effects.
...
* [orhun/linuxwave](https://github.com/orhun/linuxwave) ⭐ 662 | 🐛 17 | 🌐 Zig | 📅 2026-07-31 - Generate music from the entropy of Linux 🐧🎵. [orhun.dev/linuxwave/](https://orhun.dev/linuxwave/).
...
* [dmtrKovalenko/odiff](https://github.com/dmtrKovalenko/odiff) ⭐ 3,198 | 🐛 15 | 🌐 Zig | 📅 2026-08-24 - ODiff - A very fast SIMD-first image comparison library (with Node.js API).
...
* [bfactory-ai/zignal](https://github.com/bfactory-ai/zignal) ⭐ 459 | 🐛 0 | 🌐 Zig | 📅 2026-09-16 - Image processing library in Zig, heavily inspired by dlib.
...
* [fulcrum-so/ziggy-pydust](https://github.com/fulcrum-so/ziggy-pydust) ⭐ 788 | 🐛 46 | 🌐 Zig | 📅 2026-09-16 - A toolkit for building Python extensions in Zig. [pydust.fulcrum.so/](https://pydust.fulcrum.so/).
* [floooh/sokol-zig](https://github.com/floooh/sokol-zig) ⭐ 728 | 🐛 13 | 🌐 C | 📅 2026-09-14 - Zig bindings for the sokol headers.
...
* [raylib](https://github.com/raysan5/raylib/) ⭐ 34,770 | 🐛 14 | 🌐 C | 📅 2026-09-16 - A simple and easy-to-use library to enjoy videogames programming.
...
* [FFmpeg](https://github.com/andrewrk/ffmpeg) ⭐ 320 | 🐛 8 | 🌐 C | 📅 2026-08-28 - Library FFmpeg with the build system replaced by Zig.
