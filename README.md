...
* [Zigistry/Zigistry](https://github.com/Zigistry/Zigistry) ⭐ 706 | 🐛 6 | 🌐 Svelte | 📅 2026-09-09 - A place where you can find all the libraries that suit your Zig lang needs.
...
* [zigtools/zls](https://github.com/zigtools/zls) ⭐ 5,130 | 🐛 169 | 🌐 Zig | 📅 2026-09-11 - The @ziglang language server for all your Zig editor tooling needs, from autocomplete to goto-def! [installation](https://zigtools.org/zls/install/).
* [neurocyte/flow](https://github.com/neurocyte/flow) ⭐ 2,264 | 🐛 78 | 🌐 Zig | 📅 2026-09-15 - Flow Control - a programmer's text editor written in Zig.
...
* [DonIsaac/zlint](https://github.com/DonIsaac/zlint) ⭐ 311 | 🐛 33 | 🌐 Zig | 📅 2026-09-15 - Linter for the Zig programming language.
...
* [justrach/nanobrew](https://github.com/justrach/nanobrew) ⭐ 1,119 | 🐛 2 | 🌐 Zig | 📅 2026-09-15 - A fast macOS package manager written in Zig.
* [tristanisham/zvm](https://github.com/tristanisham/zvm) ⭐ 1,062 | 🐛 3 | 🌐 Go | 📅 2026-09-16 - Lets you easily install/upgrade between different versions of Zig. ZLS install can be included. (written in Go).
...
* [Cloudef/zig2nix](https://github.com/Cloudef/zig2nix) ⭐ 191 | 🐛 7 | 🌐 Zig | 📅 2026-09-16 - Flake for packaging, building and running Zig projects.
* [indaco/malt](https://github.com/indaco/malt) ⭐ 166 | 🐛 1 | 🌐 Zig | 📅 2026-09-16 - Homebrew's whole ecosystem, none of its weight: a single Zig binary with native post\_install and a themeable TUI and CLI.
...
* [asdf-community/asdf-zig](https://github.com/asdf-community/asdf-zig) ⭐ 82 | 🐛 1 | 🌐 Python | 📅 2026-08-14 - Zig plugin for the [asdf](https://github.com/asdf-vm/asdf) ⭐ 25,592 | 🐛 145 | 🌐 Go | 📅 2026-09-03 version manager.
...
* [ghostty](https://github.com/ghostty-org/ghostty) ⭐ 61,179 | 🐛 247 | 🌐 Zig | 📅 2026-09-15 - Modern terminal emulator written in Zig.
* [NilsIrl/dockerc](https://github.com/NilsIrl/dockerc) ⭐ 4,919 | 🐛 25 | 🌐 Zig | 📅 2025-01-02 - Container image to single executable compiler.
* [zmx](https://github.com/neurosnap/zmx) ⭐ 2,150 | 🐛 27 | 🌐 Zig | 📅 2026-09-12 - Session persistence for terminal processes.
* [Illusionna/LocalTransfer](https://github.com/Illusionna/LocalTransfer) ⭐ 605 | 🐛 0 | 🌐 Zig | 📅 2026-09-03 - A fast cross-platform HTTP file server.
...
* [deatil/zig-rsa](https://github.com/deatil/zig-rsa) ⭐ 0 | 🐛 0 | 🌐 Zig | 📅 2026-09-16 - An RSA library for Zig. No-AI.
...
* [dweiller/zimalloc](https://github.com/dweiller/zimalloc) ⭐ 48 | 🐛 7 | 🌐 Zig | 📅 2025-10-07 - A general purpose allocator for Zig, inspired by [mimalloc](https://github.com/microsoft/mimalloc) ⭐ 13,365 | 🐛 298 | 🌐 C | 📅 2026-09-16.
...
* [hello-algo-zig](https://github.com/codingonion/hello-algo-zig) ⭐ 82 | 🐛 0 | 🌐 Zig | 📅 2023-07-16 - Zig programming language codes for the famous public project [《Hello, Algorithm》|《 Hello，算法 》](https://github.com/krahets/hello-algo) ⭐ 130,150 | 🐛 40 | 🌐 Java | 📅 2026-08-17 about data structures and algorithms.
...
* [OrlovEvgeny/zigquery](https://github.com/OrlovEvgeny/zigquery) ⭐ 12 | 🐛 0 | 🌐 Zig | 📅 2026-08-31 - Zig HTML parser and CSS selector engine for DOM querying and manipulation.
...
* [peymanmortazavi/csv-zero](https://github.com/peymanmortazavi/csv-zero) ⭐ 28 | 🐛 6 | 🌐 Zig | 📅 2026-07-29 - Zero allocation, SIMD-accelerated CSV iterator and emitter for Zig.
...
* [xcaeser/zli](https://github.com/xcaeser/zli) ⭐ 336 | 🐛 1 | 🌐 Zig | 📅 2026-08-29 - Zig command-line interfaces made easy. A blazing fast CLI framework. Build ergonomic, high-performance command-line tools with Zig.
...
* [lupyuen/pinephone-nuttx](https://github.com/lupyuen/pinephone-nuttx) ⭐ 102 | 🐛 0 | 🌐 Zig | 📅 2026-09-16 - Apache NuttX RTOS for PinePhone. Apache NuttX is a lightweight Real-Time Operating System (RTOS) that runs on PINE64 PinePhone. [lupyuen.github.io/articles/what](https://lupyuen.github.io/articles/what).
...
* [AndreaOrru/zen](https://github.com/AndreaOrru/zen) ⭐ 532 | 🐛 1 | 🌐 Zig | 📅 2025-09-21 - Experimental operating system written in Zig.
...
* [Aro](https://github.com/Vexu/arocc) ⭐ 1,808 | 🐛 49 | 🌐 Zig | 📅 2026-09-14 - A C compiler with the goal of providing fast compilation and low memory usage with good diagnostics.
...
* [Fun](https://github.com/omdxp/fun) ⭐ 362 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-16 - A statically-typed language that transpiles to C, combining safety and performance with C's efficiency.
...
* [sleep3r/mtproto.zig](https://github.com/sleep3r/mtproto.zig) ⭐ 1,865 | 🐛 5 | 🌐 Zig | 📅 2026-09-08 - High-performance Telegram MTProto proxy written in Zig.
* [karlseguin/http.zig](https://github.com/karlseguin/http.zig) ⭐ 1,602 | 🐛 15 | 🌐 Zig | 📅 2026-08-26 - An HTTP/1.1 server for Zig.
* [tardy-org/zzz](https://github.com/tardy-org/zzz) ⭐ 784 | 🐛 18 | 🌐 Zig | 📅 2026-09-15 - A framework for writing performant and reliable networked services in Zig. Supports HTTP and HTTPS.
...
* [lightpanda-io/browser](https://github.com/lightpanda-io/browser) ⭐ 35,369 | 🐛 90 | 🌐 Zig | 📅 2026-09-16 - Headless browser designed for AI and automation.

### Web Framework

* [zigzap/zap](https://github.com/zigzap/zap) ⚠️ Archived - Blazingly fast web backends in Zig.
* [kristoff-it/zine](https://github.com/kristoff-it/zine) ⭐ 1,567 | 🐛 56 | 🌐 Zig | 📅 2026-09-03 - Static Site Generator written in Zig.
...
* [nurulhudaapon/zx](https://github.com/nurulhudaapon/zx) ⭐ 335 | 🐛 31 | 🌐 Zig | 📅 2026-09-16 - A full-stack web framework for Zig.
...
* [im-ng/zero](https://github.com/im-ng/zero) ⭐ 28 | 🐛 2 | 🌐 Zig | 📅 2026-09-16 - Simple and opinionated web framework written in Zig and aims to make microservices development in Zig easier.
...
* [zwasm](https://github.com/zwasm/zwasm) ⭐ 176 | 🐛 55 | 🌐 Zig | 📅 2026-09-14 - From-scratch WebAssembly runtime in Zig. Full WebAssembly 3.0 with 100% spec conformance, WASI 0.1/0.2/0.3, and interpreter + JIT (arm64/x86\_64) + AOT backends.
...
* [tigerbeetle](https://github.com/tigerbeetle/tigerbeetle) ⭐ 17,023 | 🐛 106 | 🌐 Zig | 📅 2026-08-31 - The distributed financial accounting database designed for mission critical safety and performance. [tigerbeetle.com](https://tigerbeetle.com/).
...
* [karlseguin/pg.zig](https://github.com/karlseguin/pg.zig) ⭐ 596 | 🐛 6 | 🌐 Zig | 📅 2026-08-26 - Native PostgreSQL driver / client for Zig.
...
* [seqor/seqor](https://github.com/seqor/seqor) ⭐ 63 | 🐛 1 | 🌐 Zig | 📅 2026-09-15 - Seqor is a cost-effective, Loki compatible database for logs.
...
* [zml](https://github.com/zml/zml) ⭐ 4,053 | 🐛 49 | 🌐 Zig | 📅 2026-09-16 - A high performance machine learning stack for Zig.
...
* [ggml-zig](https://github.com/codingonion/ggml-zig) - A replacement for [ggml: Tensor library for machine learning](https://github.com/ggerganov/ggml) ⭐ 15,359 | 🐛 363 | 🌐 C++ | 📅 2026-09-14 written in Zig.

### Large Language Model

* [nullclaw/nullclaw](https://github.com/nullclaw/nullclaw) ⭐ 8,092 | 🐛 95 | 🌐 Zig | 📅 2026-07-19 - Fastest, smallest, and fully autonomous AI assistant infrastructure written in Zig.
* [ddalcu/mlx-serve](https://github.com/ddalcu/mlx-serve) ⭐ 1,309 | 🐛 35 | 🌐 Zig | 📅 2026-09-16 - Native LLM inference server for Apple Silicon (MLX + GGUF) with OpenAI- and Anthropic-compatible APIs; ships MLX Core, a macOS menu-bar app. MIT.
* [cgbur/LLaMa2.zig](https://github.com/cgbur/llama2.zig) ⭐ 221 | 🐛 2 | 🌐 Zig | 📅 2026-08-02 - Inference LLaMA 2 in one file of pure Zig.
...
* [EugenHotaj/zig\_gpt2](https://github.com/EugenHotaj/zig_gpt2) ⭐ 40 | 🐛 0 | 🌐 Zig | 📅 2023-07-24 - Neural Network Inference Engine in Zig. GPT2 inference engine written in Zig. The inference engine can run [NanoGPT](https://github.com/karpathy/nanoGPT) ⭐ 63,148 | 🐛 349 | 🌐 Python | 📅 2025-11-12.
...
* [anomalyco/opentui](https://github.com/anomalyco/opentui) ⭐ 13,316 | 🐛 142 | 🌐 TypeScript | 📅 2026-09-16 - A library for building terminal user interfaces.
...
* [vancluever/z2d](https://github.com/vancluever/z2d) ⭐ 297 | 🐛 11 | 🌐 Zig | 📅 2026-09-02 - A pure Zig 2D graphics library.
...
* [david-vanderson/dvui](https://github.com/david-vanderson/dvui) ⭐ 1,659 | 🐛 104 | 🌐 Zig | 📅 2026-09-15 - Easy to Integrate Immediate Mode GUI for Zig.
...
* [meszmate/zigzag](https://github.com/meszmate/zigzag) ⭐ 551 | 🐛 8 | 🌐 Zig | 📅 2026-09-03 - The TUI Framework for Zig.
* [rcalixte/libqt6zig](https://github.com/rcalixte/libqt6zig) ⭐ 265 | 🐛 0 | 🌐 Zig | 📅 2026-09-15 - Qt 6 for Zig.
...
* [Mach](https://github.com/hexops/mach) ⭐ 4,840 | 🐛 167 | 🌐 Zig | 📅 2026-05-23 - A game engine & graphics toolkit for the future. machengine.org.
* [PixelGuys/Cubyz](https://github.com/PixelGuys/Cubyz) ⭐ 3,664 | 🐛 916 | 🌐 Zig | 📅 2026-09-15 - Voxel sandbox game with a large render distance, procedurally generated content and some cool graphical effects.
...
* [dmtrKovalenko/odiff](https://github.com/dmtrKovalenko/odiff) ⭐ 3,194 | 🐛 15 | 🌐 Zig | 📅 2026-08-24 - ODiff - A very fast SIMD-first image comparison library (with Node.js API).
...
* [bfactory-ai/zignal](https://github.com/bfactory-ai/zignal) ⭐ 458 | 🐛 0 | 🌐 Zig | 📅 2026-09-15 - Image processing library in Zig, heavily inspired by dlib.
...
* [fulcrum-so/ziggy-pydust](https://github.com/fulcrum-so/ziggy-pydust) ⭐ 787 | 🐛 46 | 🌐 Zig | 📅 2026-09-15 - A toolkit for building Python extensions in Zig. [pydust.fulcrum.so/](https://pydust.fulcrum.so/).
* [floooh/sokol-zig](https://github.com/floooh/sokol-zig) ⭐ 727 | 🐛 13 | 🌐 C | 📅 2026-09-14 - Zig bindings for the sokol headers.
...
* [sackosoft/zig-luajit](https://github.com/sackosoft/zig-luajit) ⭐ 85 | 🐛 2 | 🌐 Zig | 📅 2026-05-08 - Zig bindings for the LuaJIT C API.
...
* [raylib](https://github.com/raysan5/raylib/) ⭐ 34,748 | 🐛 17 | 🌐 C | 📅 2026-09-15 - A simple and easy-to-use library to enjoy videogames programming.
