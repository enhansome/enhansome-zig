...
* [zigtools/zls](https://github.com/zigtools/zls) ⭐ 5,110 | 🐛 172 | 🌐 Zig | 📅 2026-09-03 - The @ziglang language server for all your Zig editor tooling needs, from autocomplete to goto-def! [installation](https://zigtools.org/zls/install/).
* [neurocyte/flow](https://github.com/neurocyte/flow) ⭐ 2,206 | 🐛 79 | 🌐 Zig | 📅 2026-08-29 - Flow Control - a programmer's text editor written in Zig.
...
* [KurtWagner/zlinter](https://github.com/KurtWagner/zlinter) ⭐ 92 | 🐛 5 | 🌐 Zig | 📅 2026-08-20 - Zig linter that is integrated from source into your `build.zig`.
...
* [sb2bg/marionette](https://github.com/sb2bg/marionette) ⭐ 81 | 🐛 1 | 🌐 Zig | 📅 2026-09-02 - Deterministic simulation testing for Zig with a `std.Io` implementation, letting you inject faults and replay failures from seeds.
...
* [tristanisham/zvm](https://github.com/tristanisham/zvm) ⭐ 1,055 | 🐛 3 | 🌐 Go | 📅 2026-09-03 - Lets you easily install/upgrade between different versions of Zig. ZLS install can be included. (written in Go).
* [nektro/zigmod](https://github.com/nektro/zigmod) ⭐ 942 | 🐛 19 | 🌐 Zig | 📅 2026-06-10 - A package manager for the Zig programming language.
* [mitchellh/zig-overlay](https://github.com/mitchellh/zig-overlay) ⭐ 541 | 🐛 10 | 🌐 Nix | 📅 2026-09-04 - Nix flake for the Zig compiler.
...
* [Cloudef/zig2nix](https://github.com/Cloudef/zig2nix) ⭐ 188 | 🐛 6 | 🌐 Zig | 📅 2026-09-04 - Flake for packaging, building and running Zig projects.
...
* [asdf-community/asdf-zig](https://github.com/asdf-community/asdf-zig) ⭐ 82 | 🐛 0 | 🌐 Python | 📅 2026-08-14 - Zig plugin for the [asdf](https://github.com/asdf-vm/asdf) ⭐ 25,565 | 🐛 149 | 🌐 Go | 📅 2026-09-03 version manager.
...
* [ghostty](https://github.com/ghostty-org/ghostty) ⭐ 60,691 | 🐛 244 | 🌐 Zig | 📅 2026-09-03 - Modern terminal emulator written in Zig.
* [NilsIrl/dockerc](https://github.com/NilsIrl/dockerc) ⭐ 4,917 | 🐛 25 | 🌐 Zig | 📅 2025-01-02 - Container image to single executable compiler.
* [zmx](https://github.com/neurosnap/zmx) ⭐ 2,112 | 🐛 20 | 🌐 Zig | 📅 2026-09-04 - Session persistence for terminal processes.
* [Illusionna/LocalTransfer](https://github.com/Illusionna/LocalTransfer) ⭐ 580 | 🐛 0 | 🌐 Zig | 📅 2026-09-03 - A fast cross-platform HTTP file server.
...
* [zlist](https://github.com/here-Leslie-Lau/zlist) ⭐ 58 | 🐛 3 | 🌐 Zig | 📅 2026-09-01 - A simple, colorful alternative to ls built with Zig.
...
* [bare-devcontainer/templates](https://github.com/bare-devcontainer/templates/tree/main/src/zig) ⭐ 1 | 🐛 1 | 🌐 Shell | 📅 2026-09-04 - Security-focused Zig dev container with zls integration and a persistent build cache. The base image is available at [bare-devcontainer/images](https://github.com/bare-devcontainer/images/tree/main/zig) ⭐ 2 | 🐛 3 | 🌐 Shell | 📅 2026-09-04.
...
* [dweiller/zimalloc](https://github.com/dweiller/zimalloc) ⭐ 48 | 🐛 7 | 🌐 Zig | 📅 2025-10-07 - A general purpose allocator for Zig, inspired by [mimalloc](https://github.com/microsoft/mimalloc) ⭐ 13,347 | 🐛 307 | 🌐 C | 📅 2026-09-04.
...
* [hello-algo-zig](https://github.com/codingonion/hello-algo-zig) ⭐ 82 | 🐛 0 | 🌐 Zig | 📅 2023-07-16 - Zig programming language codes for the famous public project [《Hello, Algorithm》|《 Hello，算法 》](https://github.com/krahets/hello-algo) ⭐ 129,843 | 🐛 42 | 🌐 Java | 📅 2026-08-17 about data structures and algorithms.
...
* [karlseguin/log.zig](https://github.com/karlseguin/log.zig) ⭐ 194 | 🐛 0 | 🌐 Zig | 📅 2026-06-20 - A structured logger for Zig.
...
* [ziglibs/s2s](https://github.com/ziglibs/s2s) ⭐ 164 | 🐛 3 | 🌐 Zig | 📅 2026-05-03 - A Zig binary serialization format.
...
* [OrlovEvgeny/serde.zig](https://github.com/OrlovEvgeny/serde.zig) ⭐ 83 | 🐛 5 | 🌐 Zig | 📅 2026-08-11 - Comptime serialization framework for Zig supporting JSON, MessagePack, TOML, YAML, ZON, and CSV.
...
* [scento/zig-date](https://github.com/scento/zig-date) ⭐ 7 | 🐛 0 | 🌐 Zig | 📅 2023-03-26 - Time and date for Zig. Zig-date is a date and time library for the Zig, inspired by the popular Rust library [chrono](https://github.com/chronotope/chrono) ⭐ 3,905 | 🐛 194 | 🌐 Rust | 📅 2026-08-03.
...
* [Hejsil/zig-clap](https://github.com/Hejsil/zig-clap) ⭐ 1,607 | 🐛 7 | 🌐 Zig | 📅 2026-08-31 - A simple and easy to use command line argument parser library for Zig.
...
* [lupyuen/pinephone-nuttx](https://github.com/lupyuen/pinephone-nuttx) ⭐ 102 | 🐛 0 | 🌐 Zig | 📅 2026-09-04 - Apache NuttX RTOS for PinePhone. Apache NuttX is a lightweight Real-Time Operating System (RTOS) that runs on PINE64 PinePhone. [lupyuen.github.io/articles/what](https://lupyuen.github.io/articles/what).
...
* [Aro](https://github.com/Vexu/arocc) ⭐ 1,805 | 🐛 47 | 🌐 Zig | 📅 2026-08-30 - A C compiler with the goal of providing fast compilation and low memory usage with good diagnostics.
...
* [Element 0](https://github.com/Element0Lang/element-0) ⭐ 29 | 🐛 3 | 🌐 Zig | 📅 2026-09-02 - A small embeddable Lisp dialect written in Zig.
* [Fun](https://github.com/omdxp/fun) ⭐ 25 | 🐛 1 | 🌐 Zig | 📅 2026-09-04 - A statically-typed language that transpiles to C, combining safety and performance with C's efficiency.
...
* [sleep3r/mtproto.zig](https://github.com/sleep3r/mtproto.zig) ⭐ 1,622 | 🐛 2 | 🌐 Zig | 📅 2026-08-27 - High-performance Telegram MTProto proxy written in Zig.
...
* [lightpanda-io/browser](https://github.com/lightpanda-io/browser) ⭐ 34,421 | 🐛 96 | 🌐 Zig | 📅 2026-09-04 - Headless browser designed for AI and automation.

### Web Framework

* [zigzap/zap](https://github.com/zigzap/zap) ⭐ 3,416 | 🐛 29 | 🌐 C | 📅 2026-06-01 - Blazingly fast web backends in Zig.
* [kristoff-it/zine](https://github.com/kristoff-it/zine) ⭐ 1,559 | 🐛 53 | 🌐 Zig | 📅 2026-09-03 - Static Site Generator written in Zig.
...
* [nurulhudaapon/zx](https://github.com/nurulhudaapon/zx) ⭐ 329 | 🐛 31 | 🌐 Zig | 📅 2026-08-30 - A full-stack web framework for Zig.
...
* [im-ng/zero](https://github.com/im-ng/zero) ⭐ 21 | 🐛 3 | 🌐 Zig | 📅 2026-09-04 - Simple and opinionated web framework written in Zig and aims to make microservices development in Zig easier.
...
* [StrobeLabs/eth.zig](https://github.com/StrobeLabs/eth.zig) ⭐ 83 | 🐛 22 | 🌐 C | 📅 2026-09-02 - Pure Zig Ethereum client library. Zero dependencies, comptime-first.
...
* [blockblaz/ssz.zig](https://github.com/blockblaz/ssz.zig) ⭐ 34 | 🐛 17 | 🌐 Zig | 📅 2026-09-01 - A Zig implementation of the [SSZ serialization protocol](https://github.com/ethereum/eth2.0-specs/blob/dev/ssz/simple-serialize.md) ⭐ 3,959 | 🐛 57 | 🌐 Python | 📅 2026-09-03.
...
* [zwasm](https://github.com/zwasm/zwasm) ⭐ 173 | 🐛 51 | 🌐 Zig | 📅 2026-09-04 - From-scratch WebAssembly runtime in Zig. Full WebAssembly 3.0 with 100% spec conformance, WASI 0.1/0.2/0.3, and interpreter + JIT (arm64/x86\_64) + AOT backends.
...
* [tigerbeetle](https://github.com/tigerbeetle/tigerbeetle) ⭐ 16,953 | 🐛 102 | 🌐 Zig | 📅 2026-08-31 - The distributed financial accounting database designed for mission critical safety and performance. [tigerbeetle.com](https://tigerbeetle.com/).
...
* [zml](https://github.com/zml/zml) ⭐ 4,017 | 🐛 49 | 🌐 Zig | 📅 2026-09-04 - A high performance machine learning stack for Zig.
...
* [ggml-zig](https://github.com/codingonion/ggml-zig) - A replacement for [ggml: Tensor library for machine learning](https://github.com/ggerganov/ggml) ⭐ 15,294 | 🐛 357 | 🌐 C++ | 📅 2026-09-04 written in Zig.

### Large Language Model

* [nullclaw/nullclaw](https://github.com/nullclaw/nullclaw) ⭐ 8,065 | 🐛 93 | 🌐 Zig | 📅 2026-07-19 - Fastest, smallest, and fully autonomous AI assistant infrastructure written in Zig.
* [ddalcu/mlx-serve](https://github.com/ddalcu/mlx-serve) ⭐ 1,115 | 🐛 49 | 🌐 Zig | 📅 2026-09-04 - Native LLM inference server for Apple Silicon (MLX + GGUF) with OpenAI- and Anthropic-compatible APIs; ships MLX Core, a macOS menu-bar app. MIT.
...
* [EugenHotaj/zig\_gpt2](https://github.com/EugenHotaj/zig_gpt2) ⭐ 40 | 🐛 0 | 🌐 Zig | 📅 2023-07-24 - Neural Network Inference Engine in Zig. GPT2 inference engine written in Zig. The inference engine can run [NanoGPT](https://github.com/karpathy/nanoGPT) ⭐ 62,801 | 🐛 348 | 🌐 Python | 📅 2025-11-12.
...
* [Snektron/vulkan-zig](https://github.com/Snektron/vulkan-zig) ⭐ 906 | 🐛 24 | 🌐 Zig | 📅 2026-08-30 - Vulkan binding generator for Zig.
...
* [anomalyco/opentui](https://github.com/anomalyco/opentui) ⭐ 13,228 | 🐛 136 | 🌐 TypeScript | 📅 2026-09-04 - A library for building terminal user interfaces.
* [rockorager/libvaxis](https://github.com/rockorager/libvaxis) ⭐ 1,987 | 🐛 35 | 🌐 Zig | 📅 2026-08-20 - Modern TUI library written in Zig.
...
* [Mach](https://github.com/hexops/mach) ⭐ 4,834 | 🐛 167 | 🌐 Zig | 📅 2026-05-23 - A game engine & graphics toolkit for the future. machengine.org.
* [PixelGuys/Cubyz](https://github.com/PixelGuys/Cubyz) ⭐ 3,646 | 🐛 916 | 🌐 Zig | 📅 2026-08-30 - Voxel sandbox game with a large render distance, procedurally generated content and some cool graphical effects.
...
* [floooh/sokol-zig](https://github.com/floooh/sokol-zig) ⭐ 725 | 🐛 13 | 🌐 C | 📅 2026-08-30 - Zig bindings for the sokol headers.
...
* [raylib](https://github.com/raysan5/raylib/) ⭐ 34,582 | 🐛 20 | 🌐 C | 📅 2026-09-04 - A simple and easy-to-use library to enjoy videogames programming.
