...
* [Zigistry/Zigistry](https://github.com/Zigistry/Zigistry) ⭐ 709 | 🐛 5 | 🌐 Svelte | 📅 2026-08-23 - A place where you can find all the libraries that suit your Zig lang needs.
...
* [zigtools/zls](https://github.com/zigtools/zls) ⭐ 5,113 | 🐛 168 | 🌐 Zig | 📅 2026-09-04 - The @ziglang language server for all your Zig editor tooling needs, from autocomplete to goto-def! [installation](https://zigtools.org/zls/install/).
* [neurocyte/flow](https://github.com/neurocyte/flow) ⭐ 2,211 | 🐛 82 | 🌐 Zig | 📅 2026-08-29 - Flow Control - a programmer's text editor written in Zig.
...
* [DonIsaac/zlint](https://github.com/DonIsaac/zlint) ⭐ 309 | 🐛 35 | 🌐 Zig | 📅 2026-09-06 - Linter for the Zig programming language.
* [KurtWagner/zlinter](https://github.com/KurtWagner/zlinter) ⭐ 93 | 🐛 5 | 🌐 Zig | 📅 2026-08-20 - Zig linter that is integrated from source into your `build.zig`.
* [forketyfork/zwanzig](https://github.com/forketyfork/zwanzig) ⭐ 28 | 🐛 1 | 🌐 Zig | 📅 2026-09-04 - Static analyzer for Zig with CFG-based checks (leaks, double-free, optional unwrap, stack escapes).
...
* [sb2bg/marionette](https://github.com/sb2bg/marionette) ⭐ 82 | 🐛 1 | 🌐 Zig | 📅 2026-09-04 - Deterministic simulation testing for Zig with a `std.Io` implementation, letting you inject faults and replay failures from seeds.
...
* [justrach/nanobrew](https://github.com/justrach/nanobrew) ⭐ 1,114 | 🐛 14 | 🌐 Zig | 📅 2026-08-15 - A fast macOS package manager written in Zig.
* [tristanisham/zvm](https://github.com/tristanisham/zvm) ⭐ 1,056 | 🐛 3 | 🌐 Go | 📅 2026-09-06 - Lets you easily install/upgrade between different versions of Zig. ZLS install can be included. (written in Go).
* [nektro/zigmod](https://github.com/nektro/zigmod) ⭐ 945 | 🐛 18 | 🌐 Zig | 📅 2026-09-04 - A package manager for the Zig programming language.
* [mitchellh/zig-overlay](https://github.com/mitchellh/zig-overlay) ⭐ 543 | 🐛 10 | 🌐 Nix | 📅 2026-09-05 - Nix flake for the Zig compiler.
...
* [Cloudef/zig2nix](https://github.com/Cloudef/zig2nix) ⭐ 190 | 🐛 6 | 🌐 Zig | 📅 2026-09-06 - Flake for packaging, building and running Zig projects.
* [indaco/malt](https://github.com/indaco/malt) ⭐ 164 | 🐛 2 | 🌐 Zig | 📅 2026-09-01 - Homebrew's whole ecosystem, none of its weight: a single Zig binary with native post\_install and a themeable TUI and CLI.
...
* [vezel-dev/zig-sdk](https://github.com/vezel-dev/zig-sdk) ⭐ 110 | 🐛 19 | 🌐 C# | 📅 2026-08-31 - An MSBuild SDK for building Zig, C, and C++ projects using the Zig compiler.
* [zigtools/zpm](https://github.com/zigtools/zpm) ⭐ 104 | 🐛 0 | 🌐 Nix | 📅 2024-05-29 - Zig package manager helper.
* [asdf-community/asdf-zig](https://github.com/asdf-community/asdf-zig) ⭐ 82 | 🐛 0 | 🌐 Python | 📅 2026-08-14 - Zig plugin for the [asdf](https://github.com/asdf-vm/asdf) ⭐ 25,565 | 🐛 144 | 🌐 Go | 📅 2026-09-03 version manager.
...
* [ghostty](https://github.com/ghostty-org/ghostty) ⭐ 60,761 | 🐛 247 | 🌐 Zig | 📅 2026-09-06 - Modern terminal emulator written in Zig.
* [NilsIrl/dockerc](https://github.com/NilsIrl/dockerc) ⭐ 4,919 | 🐛 25 | 🌐 Zig | 📅 2025-01-02 - Container image to single executable compiler.
* [zmx](https://github.com/neurosnap/zmx) ⭐ 2,117 | 🐛 21 | 🌐 Zig | 📅 2026-09-05 - Session persistence for terminal processes.
* [Illusionna/LocalTransfer](https://github.com/Illusionna/LocalTransfer) ⭐ 585 | 🐛 0 | 🌐 Zig | 📅 2026-09-03 - A fast cross-platform HTTP file server.
...
* [midasdf/zt](https://github.com/midasdf/zt) ⭐ 65 | 🐛 0 | 🌐 Zig | 📅 2026-07-04 - Ultra-fast, minimal terminal emulator written in Zig with fbdev, X11, Wayland, and macOS backends.
* [zlist](https://github.com/here-Leslie-Lau/zlist) ⭐ 61 | 🐛 3 | 🌐 Zig | 📅 2026-09-01 - A simple, colorful alternative to ls built with Zig.
* [forketyfork/architect](https://github.com/forketyfork/architect) ⭐ 50 | 🐛 8 | 🌐 Zig | 📅 2026-09-04 - A flexible terminal grid for multi-agent AI workflows.
...
* [bare-devcontainer/templates](https://github.com/bare-devcontainer/templates/tree/main/src/zig) ⭐ 1 | 🐛 1 | 🌐 Shell | 📅 2026-09-06 - Security-focused Zig dev container with zls integration and a persistent build cache. The base image is available at [bare-devcontainer/images](https://github.com/bare-devcontainer/images/tree/main/zig) ⭐ 2 | 🐛 1 | 🌐 Shell | 📅 2026-09-06.
...
* [andrewrk/poop](https://github.com/andrewrk/poop) ⭐ 2,037 | 🐛 29 | 🌐 Zig | 📅 2026-05-04 - CLI Performance Observer written in Zig.
* [ziglang/gotta-go-fast](https://github.com/ziglang/gotta-go-fast) ⚠️ Archived - Performance Tracking for Zig.
* [hendriknielaender/zBench](https://github.com/hendriknielaender/zBench) ⭐ 224 | 🐛 8 | 🌐 Zig | 📅 2026-06-24 - Simple benchmarking library.
...
* [dweiller/zimalloc](https://github.com/dweiller/zimalloc) ⭐ 48 | 🐛 7 | 🌐 Zig | 📅 2025-10-07 - A general purpose allocator for Zig, inspired by [mimalloc](https://github.com/microsoft/mimalloc) ⭐ 13,352 | 🐛 306 | 🌐 C | 📅 2026-09-06.
...
* [hello-algo-zig](https://github.com/codingonion/hello-algo-zig) ⭐ 82 | 🐛 0 | 🌐 Zig | 📅 2023-07-16 - Zig programming language codes for the famous public project [《Hello, Algorithm》|《 Hello，算法 》](https://github.com/krahets/hello-algo) ⭐ 129,904 | 🐛 42 | 🌐 Java | 📅 2026-08-17 about data structures and algorithms.
...
* [JakubSzark/zig-string](https://github.com/JakubSzark/zig-string) ⭐ 577 | 🐛 2 | 🌐 Zig | 📅 2026-06-24 - Zig String (A UTF-8 String Library). This library is a UTF-8 compatible string library for the Zig programming language.
...
* [muhammad-fiaz/logly.zig](https://github.com/muhammad-fiaz/logly.zig) ⭐ 69 | 🐛 6 | 🌐 Zig | 📅 2026-09-05 - A modern, production-grade, high-performance structured logging library for Zig, built for speed and scalability.
...
* [Arwalk/zig-protobuf](https://github.com/Arwalk/zig-protobuf) ⭐ 430 | 🐛 22 | 🌐 Zig | 📅 2026-07-14 - A protobuf 3 implementation for Zig.
...
* [karlseguin/log.zig](https://github.com/karlseguin/log.zig) ⭐ 195 | 🐛 0 | 🌐 Zig | 📅 2026-06-20 - A structured logger for Zig.
...
* [sam701/zig-toml](https://github.com/sam701/zig-toml) ⭐ 134 | 🐛 5 | 🌐 Zig | 📅 2026-08-07 - Zig TOML (v1.0.0) parser.
...
* [OrlovEvgeny/serde.zig](https://github.com/OrlovEvgeny/serde.zig) ⭐ 83 | 🐛 6 | 🌐 Zig | 📅 2026-08-11 - Comptime serialization framework for Zig supporting JSON, MessagePack, TOML, YAML, ZON, and CSV.
...
* [nDimensional/zig-flatbuffers](https://github.com/nDimensional/zig-flatbuffers) ⭐ 11 | 🐛 1 | 🌐 Zig | 📅 2026-06-01 - FlatBuffers codegen for Zig, in Zig.
...
* [rockorager/zeit](https://github.com/rockorager/zeit) ⭐ 235 | 🐛 5 | 🌐 Zig | 📅 2026-08-17 - Generic date/time library, including time zone loading and conversion.
...
* [nektro/zig-time](https://github.com/nektro/zig-time) ⭐ 77 | 🐛 1 | 🌐 Zig | 📅 2026-09-01 - A date and time parsing and formatting library for Zig.
...
* [scento/zig-date](https://github.com/scento/zig-date) ⭐ 7 | 🐛 0 | 🌐 Zig | 📅 2023-03-26 - Time and date for Zig. Zig-date is a date and time library for the Zig, inspired by the popular Rust library [chrono](https://github.com/chronotope/chrono) ⭐ 3,906 | 🐛 194 | 🌐 Rust | 📅 2026-08-03.
* [leroycep/chrono-zig](https://github.com/leroycep/chrono-zig) ⭐ 6 | 🐛 0 | 🌐 Zig | 📅 2024-04-24 - Zig port of the Rust chrono crate.
* [travisstaloch/date-zig](https://github.com/travisstaloch/date-zig) ⭐ 5 | 🐛 0 | 🌐 Zig | 📅 2023-12-17 - Fast calendar algorithms ported to Zig (Cassio Neri's [EAF](https://github.com/cassioneri/eaf) ⭐ 61 | 🐛 0 | 🌐 C++ | 📅 2026-06-27).
...
* [Hejsil/zig-clap](https://github.com/Hejsil/zig-clap) ⭐ 1,609 | 🐛 7 | 🌐 Zig | 📅 2026-08-31 - A simple and easy to use command line argument parser library for Zig.
* [sam701/zig-cli](https://github.com/sam701/zig-cli) ⭐ 354 | 🐛 7 | 🌐 Zig | 📅 2026-08-30 - A simple package for building command line apps in Zig.
* [xcaeser/zli](https://github.com/xcaeser/zli) ⭐ 335 | 🐛 1 | 🌐 Zig | 📅 2026-08-29 - Zig command-line interfaces made easy. A blazing fast CLI framework. Build ergonomic, high-performance command-line tools with Zig.
* [MasterQ32/zig-args](https://github.com/MasterQ32/zig-args) ⭐ 308 | 🐛 10 | 🌐 Zig | 📅 2026-05-21 - Simple-to-use argument parser with struct-based config.
...
* [mitchellh/libxev](https://github.com/mitchellh/libxev) ⭐ 3,581 | 🐛 60 | 🌐 Zig | 📅 2026-07-17 - A cross-platform, high-performance event loop that provides abstractions for non-blocking IO, timers, events, and more and works on Linux (io\_uring or epoll), macOS (kqueue), and WebAssembly + WASI. Available as both a Zig and C API.
...
* [ZigEmbeddedGroup/microzig](https://github.com/ZigEmbeddedGroup/microzig) ⭐ 2,274 | 🐛 79 | 🌐 Zig | 📅 2026-09-04 - Unified abstraction layer and HAL for several microcontrollers.
...
* [lupyuen/pinephone-nuttx](https://github.com/lupyuen/pinephone-nuttx) ⭐ 102 | 🐛 0 | 🌐 Zig | 📅 2026-09-06 - Apache NuttX RTOS for PinePhone. Apache NuttX is a lightweight Real-Time Operating System (RTOS) that runs on PINE64 PinePhone. [lupyuen.github.io/articles/what](https://lupyuen.github.io/articles/what).
...
* [Aro](https://github.com/Vexu/arocc) ⭐ 1,803 | 🐛 48 | 🌐 Zig | 📅 2026-08-30 - A C compiler with the goal of providing fast compilation and low memory usage with good diagnostics.
* [buzz](https://github.com/buzz-language/buzz) ⭐ 1,529 | 🐛 80 | 🌐 Zig | 📅 2026-08-27 - A small/lightweight statically typed scripting language.
* [fubark/cyber](https://github.com/fubark/cyber) ⭐ 1,522 | 🐛 37 | 🌐 Zig | 📅 2025-12-21 - Fast and concurrent scripting.
...
* [Element 0](https://github.com/Element0Lang/element-0) ⭐ 29 | 🐛 4 | 🌐 Zig | 📅 2026-09-05 - A small embeddable Lisp dialect written in Zig.
* [Fun](https://github.com/omdxp/fun) ⭐ 26 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-06 - A statically-typed language that transpiles to C, combining safety and performance with C's efficiency.
* [fury](https://github.com/fury-lang/fury) ⭐ 15 | 🐛 10 | 🌐 Zig | 📅 2025-03-11 - A gradual, safe systems language.
* [zish](https://github.com/rotkonetworks/zish) ⭐ 7 | 🐛 0 | 🌐 Zig | 📅 2026-09-02 - An opinionated shell written in Zig.
...
* [sleep3r/mtproto.zig](https://github.com/sleep3r/mtproto.zig) ⭐ 1,657 | 🐛 5 | 🌐 Zig | 📅 2026-09-05 - High-performance Telegram MTProto proxy written in Zig.
* [karlseguin/http.zig](https://github.com/karlseguin/http.zig) ⭐ 1,596 | 🐛 15 | 🌐 Zig | 📅 2026-08-26 - An HTTP/1.1 server for Zig.
* [tardy-org/zzz](https://github.com/tardy-org/zzz) ⭐ 778 | 🐛 18 | 🌐 Zig | 📅 2026-09-05 - A framework for writing performant and reliable networked services in Zig. Supports HTTP and HTTPS.
...
* [muhammad-fiaz/httpx.zig](https://github.com/muhammad-fiaz/httpx.zig) ⭐ 89 | 🐛 5 | 🌐 Zig | 📅 2026-08-31 - Production-ready HTTP/1.x/2/3 client and server runtime for Zig with proxy support, concurrency, and protocol primitives.
...
* [lightpanda-io/browser](https://github.com/lightpanda-io/browser) ⭐ 34,576 | 🐛 104 | 🌐 Zig | 📅 2026-09-06 - Headless browser designed for AI and automation.

### Web Framework

* [zigzap/zap](https://github.com/zigzap/zap) ⭐ 3,417 | 🐛 29 | 🌐 C | 📅 2026-06-01 - Blazingly fast web backends in Zig.
* [kristoff-it/zine](https://github.com/kristoff-it/zine) ⭐ 1,562 | 🐛 53 | 🌐 Zig | 📅 2026-09-03 - Static Site Generator written in Zig.
* [jetzig-framework/jetzig](https://github.com/jetzig-framework/jetzig) ⭐ 1,513 | 🐛 40 | 🌐 Zig | 📅 2026-06-12 - Jetzig is a web framework written in Zig.
* [cztomsik/tokamak](https://github.com/cztomsik/tokamak) ⭐ 635 | 🐛 5 | 🌐 Zig | 📅 2026-08-28 - Web framework that leverages dependency injection for clean, modular application development.
...
* [nurulhudaapon/zx](https://github.com/nurulhudaapon/zx) ⭐ 332 | 🐛 31 | 🌐 Zig | 📅 2026-08-30 - A full-stack web framework for Zig.
...
* [deatil/zig-jwt](https://github.com/deatil/zig-jwt) ⭐ 21 | 🐛 0 | 🌐 Zig | 📅 2026-09-03 - A JWT(JSON Web Token) library for Zig.
* [im-ng/zero](https://github.com/im-ng/zero) ⭐ 21 | 🐛 3 | 🌐 Zig | 📅 2026-09-05 - Simple and opinionated web framework written in Zig and aims to make microservices development in Zig easier.
...
* [deatil/zig-paseto](https://github.com/deatil/zig-paseto) ⭐ 3 | 🐛 0 | 🌐 Zig | 📅 2026-09-03 - A PASETO (Platform-Agnostic SEcurity TOkens) library for Zig.
...
* [Syndica/sig](https://github.com/Syndica/sig) ⭐ 404 | 🐛 93 | 🌐 Zig | 📅 2026-07-31 - A Solana Zig RPC Client implementation.
...
* [StrobeLabs/eth.zig](https://github.com/StrobeLabs/eth.zig) ⭐ 84 | 🐛 22 | 🌐 C | 📅 2026-09-02 - Pure Zig Ethereum client library. Zero dependencies, comptime-first.
...
* [blockblaz/ssz.zig](https://github.com/blockblaz/ssz.zig) ⭐ 34 | 🐛 17 | 🌐 Zig | 📅 2026-09-01 - A Zig implementation of the [SSZ serialization protocol](https://github.com/ethereum/eth2.0-specs/blob/dev/ssz/simple-serialize.md) ⭐ 3,960 | 🐛 58 | 🌐 Python | 📅 2026-09-04.
...
* [zwasm](https://github.com/zwasm/zwasm) ⭐ 172 | 🐛 54 | 🌐 Zig | 📅 2026-09-06 - From-scratch WebAssembly runtime in Zig. Full WebAssembly 3.0 with 100% spec conformance, WASI 0.1/0.2/0.3, and interpreter + JIT (arm64/x86\_64) + AOT backends.
...
* [tigerbeetle](https://github.com/tigerbeetle/tigerbeetle) ⭐ 16,962 | 🐛 103 | 🌐 Zig | 📅 2026-08-31 - The distributed financial accounting database designed for mission critical safety and performance. [tigerbeetle.com](https://tigerbeetle.com/).
* [vrischmann/zig-sqlite](https://github.com/vrischmann/zig-sqlite) ⭐ 618 | 🐛 6 | 🌐 C | 📅 2026-07-24 - Zig-SQLite is a small wrapper around SQLite's C API, making it easier to use with Zig.
* [karlseguin/pg.zig](https://github.com/karlseguin/pg.zig) ⭐ 592 | 🐛 4 | 🌐 Zig | 📅 2026-08-26 - Native PostgreSQL driver / client for Zig.
...
* [speed2exe/myzql](https://github.com/speed2exe/myzql) ⭐ 75 | 🐛 4 | 🌐 Zig | 📅 2026-09-04 - MySQL and MariaDB driver in native Zig.
...
* [seqor/seqor](https://github.com/seqor/seqor) ⭐ 61 | 🐛 1 | 🌐 Zig | 📅 2026-09-05 - Seqor is a cost-effective, Loki compatible database for logs.
...
* [kooparse/zalgebra](https://github.com/kooparse/zalgebra) ⭐ 329 | 🐛 1 | 🌐 Zig | 📅 2026-07-28 - Linear algebra library for games and real-time graphics.
...
* [zml](https://github.com/zml/zml) ⭐ 4,018 | 🐛 50 | 🌐 Zig | 📅 2026-09-06 - A high performance machine learning stack for Zig.
* [Zigrad](https://github.com/Marco-Christiani/zigrad) ⭐ 196 | 🐛 14 | 🌐 Zig | 📅 2026-09-06 - A deep learning framework built on an autograd engine with high level abstractions and low level control. Trains neural networks 2.5x faster than PyTorch on Apple Silicon and 1.5x faster on CPU.
...
* [ggml-zig](https://github.com/codingonion/ggml-zig) - A replacement for [ggml: Tensor library for machine learning](https://github.com/ggerganov/ggml) ⭐ 15,297 | 🐛 358 | 🌐 C++ | 📅 2026-09-04 written in Zig.

### Large Language Model

* [nullclaw/nullclaw](https://github.com/nullclaw/nullclaw) ⭐ 8,066 | 🐛 94 | 🌐 Zig | 📅 2026-07-19 - Fastest, smallest, and fully autonomous AI assistant infrastructure written in Zig.
* [ddalcu/mlx-serve](https://github.com/ddalcu/mlx-serve) ⭐ 1,140 | 🐛 59 | 🌐 Zig | 📅 2026-09-06 - Native LLM inference server for Apple Silicon (MLX + GGUF) with OpenAI- and Anthropic-compatible APIs; ships MLX Core, a macOS menu-bar app. MIT.
...
* [EugenHotaj/zig\_gpt2](https://github.com/EugenHotaj/zig_gpt2) ⭐ 40 | 🐛 0 | 🌐 Zig | 📅 2023-07-24 - Neural Network Inference Engine in Zig. GPT2 inference engine written in Zig. The inference engine can run [NanoGPT](https://github.com/karpathy/nanoGPT) ⭐ 62,844 | 🐛 348 | 🌐 Python | 📅 2025-11-12.
...
* [Snektron/vulkan-zig](https://github.com/Snektron/vulkan-zig) ⭐ 907 | 🐛 24 | 🌐 Zig | 📅 2026-08-30 - Vulkan binding generator for Zig.
* [hexops/mach-gpu](https://github.com/hexops/mach-gpu) ⭐ 204 | 🐛 0 | 🌐 Zig | 📅 2024-07-08 - Provides a truly cross-platform graphics API for Zig (desktop, mobile, and web) with unified low-level graphics & compute backed by Vulkan, Metal, D3D12, and OpenGL (as a best-effort fallback).
...
* [anomalyco/opentui](https://github.com/anomalyco/opentui) ⭐ 13,248 | 🐛 130 | 🌐 TypeScript | 📅 2026-09-06 - A library for building terminal user interfaces.
* [rockorager/libvaxis](https://github.com/rockorager/libvaxis) ⭐ 1,989 | 🐛 34 | 🌐 Zig | 📅 2026-09-06 - Modern TUI library written in Zig.
...
* [vancluever/z2d](https://github.com/vancluever/z2d) ⭐ 295 | 🐛 11 | 🌐 Zig | 📅 2026-09-02 - A pure Zig 2D graphics library.
...
* [andrewrk/zig-vulkan-triangle](https://github.com/andrewrk/zig-vulkan-triangle) ⭐ 160 | 🐛 0 | 🌐 Zig | 📅 2026-07-02 - Simple triangle displayed using Vulkan, glfw, and Zig.
...
* [zsdl3](https://github.com/felixuxx/zsdl3) ⭐ 32 | 🐛 4 | 🌐 Zig | 📅 2026-07-05 - SDL3 bindings for Zig.
...
* [Capy](https://github.com/capy-ui/capy) ⭐ 2,689 | 🐛 25 | 🌐 Zig | 📅 2025-12-25 - Build one codebase and get native UI on Windows, Linux and Web. [capy-ui.org](https://capy-ui.org/).
* [david-vanderson/dvui](https://github.com/david-vanderson/dvui) ⭐ 1,650 | 🐛 98 | 🌐 Zig | 📅 2026-09-05 - Easy to Integrate Immediate Mode GUI for Zig.
...
* [meszmate/zigzag](https://github.com/meszmate/zigzag) ⭐ 541 | 🐛 7 | 🌐 Zig | 📅 2026-09-03 - The TUI Framework for Zig.
* [rcalixte/libqt6zig](https://github.com/rcalixte/libqt6zig) ⭐ 264 | 🐛 0 | 🌐 Zig | 📅 2026-08-31 - Qt 6 for Zig.
...
* [kotsutsumi/zylix](https://github.com/kotsutsumi/zylix) ⭐ 72 | 🐛 7 | 🌐 Zig | 📅 2026-03-15 - Zig powered cross-platform UI framework with Virtual DOM.
...
* [Mach](https://github.com/hexops/mach) ⭐ 4,835 | 🐛 167 | 🌐 Zig | 📅 2026-05-23 - A game engine & graphics toolkit for the future. machengine.org.
* [PixelGuys/Cubyz](https://github.com/PixelGuys/Cubyz) ⭐ 3,651 | 🐛 916 | 🌐 Zig | 📅 2026-09-06 - Voxel sandbox game with a large render distance, procedurally generated content and some cool graphical effects.
...
* [foxnne/aftersun](https://github.com/foxnne/aftersun) ⭐ 303 | 🐛 3 | 🌐 Zig | 📅 2024-06-10 - Top-down 2D RPG.
...
* [zkburke/quanta](https://github.com/zkburke/quanta) ⭐ 18 | 🐛 0 | 🌐 Zig | 📅 2025-11-18 - A game engine/framework written in and for Zig.
...
* [dmtrKovalenko/odiff](https://github.com/dmtrKovalenko/odiff) ⭐ 3,183 | 🐛 15 | 🌐 Zig | 📅 2026-08-24 - ODiff - A very fast SIMD-first image comparison library (with Node.js API).
* [zigimg/zigimg](https://github.com/zigimg/zigimg) ⭐ 840 | 🐛 49 | 🌐 Zig | 📅 2026-08-18 - Zig library for reading and writing different image formats.
* [freref/fancy-cat](https://github.com/freref/fancy-cat) ⭐ 561 | 🐛 20 | 🌐 Zig | 📅 2026-08-03 - PDF reader inside the terminal.
* [bfactory-ai/zignal](https://github.com/bfactory-ai/zignal) ⭐ 460 | 🐛 0 | 🌐 Zig | 📅 2026-09-04 - Image processing library in Zig, heavily inspired by dlib.
...
* [fulcrum-so/ziggy-pydust](https://github.com/fulcrum-so/ziggy-pydust) ⭐ 787 | 🐛 44 | 🌐 Zig | 📅 2026-09-06 - A toolkit for building Python extensions in Zig. [pydust.fulcrum.so/](https://pydust.fulcrum.so/).
* [floooh/sokol-zig](https://github.com/floooh/sokol-zig) ⭐ 725 | 🐛 14 | 🌐 C | 📅 2026-09-04 - Zig bindings for the sokol headers.
* [natecraddock/ziglua](https://github.com/natecraddock/ziglua) ⭐ 522 | 🐛 9 | 🌐 Zig | 📅 2026-09-03 - Zig bindings for the Lua C API.
* [mitchellh/zig-objc](https://github.com/mitchellh/zig-objc) ⭐ 348 | 🐛 3 | 🌐 Zig | 📅 2026-04-17 - Objective-C runtime bindings for Zig (Zig calling ObjC).
...
* [happystraw/phpz](https://github.com/happystraw/phpz) ⭐ 5 | 🐛 1 | 🌐 Zig | 📅 2026-09-04 - Build PHP extensions with Zig.
...
* [raylib](https://github.com/raysan5/raylib/) ⭐ 34,604 | 🐛 18 | 🌐 C | 📅 2026-09-05 - A simple and easy-to-use library to enjoy videogames programming.
