...
* [zigtools/zls](https://github.com/zigtools/zls) ⭐ 5,078 | 🐛 158 | 🌐 Zig | 📅 2026-08-14 - The @ziglang language server for all your Zig editor tooling needs, from autocomplete to goto-def! [installation](https://zigtools.org/zls/install/).
...
* [KurtWagner/zlinter](https://github.com/KurtWagner/zlinter) ⭐ 90 | 🐛 5 | 🌐 Zig | 📅 2026-08-19 - Zig linter that is integrated from source into your `build.zig`.
...
* [tristanisham/zvm](https://github.com/tristanisham/zvm) ⭐ 1,045 | 🐛 6 | 🌐 Go | 📅 2026-08-15 - Lets you easily install/upgrade between different versions of Zig. ZLS install can be included. (written in Go).
* [nektro/zigmod](https://github.com/nektro/zigmod) ⭐ 941 | 🐛 19 | 🌐 Zig | 📅 2026-06-10 - A package manager for the Zig programming language.
* [mitchellh/zig-overlay](https://github.com/mitchellh/zig-overlay) ⭐ 537 | 🐛 10 | 🌐 Nix | 📅 2026-08-19 - Nix flake for the Zig compiler.
...
* [indaco/malt](https://github.com/indaco/malt) ⭐ 152 | 🐛 9 | 🌐 Zig | 📅 2026-08-19 - Homebrew's whole ecosystem, none of its weight: a single Zig binary with native post\_install and a themeable TUI and CLI.
...
* [asdf-community/asdf-zig](https://github.com/asdf-community/asdf-zig) ⭐ 81 | 🐛 0 | 🌐 Python | 📅 2026-08-14 - Zig plugin for the [asdf](https://github.com/asdf-vm/asdf) ⭐ 25,533 | 🐛 151 | 🌐 Go | 📅 2026-08-12 version manager.
...
* [ghostty](https://github.com/ghostty-org/ghostty) ⭐ 59,867 | 🐛 253 | 🌐 Zig | 📅 2026-08-19 - Modern terminal emulator written in Zig.
...
* [zlist](https://github.com/here-Leslie-Lau/zlist) ⭐ 58 | 🐛 5 | 🌐 Zig | 📅 2026-08-19 - A simple, colorful alternative to ls built with Zig.
...
* [dweiller/zimalloc](https://github.com/dweiller/zimalloc) ⭐ 48 | 🐛 7 | 🌐 Zig | 📅 2025-10-07 - A general purpose allocator for Zig, inspired by [mimalloc](https://github.com/microsoft/mimalloc) ⭐ 13,303 | 🐛 318 | 🌐 C | 📅 2026-08-19.
...
* [hello-algo-zig](https://github.com/codingonion/hello-algo-zig) ⭐ 82 | 🐛 0 | 🌐 Zig | 📅 2023-07-16 - Zig programming language codes for the famous public project [《Hello, Algorithm》|《 Hello，算法 》](https://github.com/krahets/hello-algo) ⭐ 129,474 | 🐛 42 | 🌐 Java | 📅 2026-08-17 about data structures and algorithms.
...
* [mitchellh/libxev](https://github.com/mitchellh/libxev) ⭐ 3,559 | 🐛 57 | 🌐 Zig | 📅 2026-07-17 - A cross-platform, high-performance event loop that provides abstractions for non-blocking IO, timers, events, and more and works on Linux (io\_uring or epoll), macOS (kqueue), and WebAssembly + WASI. Available as both a Zig and C API.
...
* [buzz](https://github.com/buzz-language/buzz) ⭐ 1,524 | 🐛 80 | 🌐 Zig | 📅 2026-08-19 - A small/lightweight statically typed scripting language.
...
* [Fun](https://github.com/omdxp/fun) ⭐ 23 | 🐛 1 | 🌐 Zig | 📅 2026-08-19 - A statically-typed language that transpiles to C, combining safety and performance with C's efficiency.
...
* [muhammad-fiaz/httpx.zig](https://github.com/muhammad-fiaz/httpx.zig) ⭐ 82 | 🐛 5 | 🌐 Zig | 📅 2026-08-18 - Production-ready HTTP/1.x/2/3 client and server runtime for Zig with proxy support, concurrency, and protocol primitives.
...
* [lightpanda-io/browser](https://github.com/lightpanda-io/browser) ⭐ 34,107 | 🐛 85 | 🌐 Zig | 📅 2026-08-19 - Headless browser designed for AI and automation.
...
* [StrobeLabs/eth.zig](https://github.com/StrobeLabs/eth.zig) ⭐ 80 | 🐛 18 | 🌐 C | 📅 2026-08-19 - Pure Zig Ethereum client library. Zero dependencies, comptime-first.
...
* [zwasm](https://github.com/zwasm/zwasm) ⭐ 162 | 🐛 2 | 🌐 Zig | 📅 2026-08-19 - From-scratch WebAssembly runtime in Zig. Full WebAssembly 3.0 with 100% spec conformance, WASI 0.1/0.2/0.3, and interpreter + JIT (arm64/x86\_64) + AOT backends.
...
* [tigerbeetle](https://github.com/tigerbeetle/tigerbeetle) ⭐ 16,844 | 🐛 125 | 🌐 Zig | 📅 2026-08-18 - The distributed financial accounting database designed for mission critical safety and performance. [tigerbeetle.com](https://tigerbeetle.com/).
...
* [zml](https://github.com/zml/zml) ⭐ 3,990 | 🐛 40 | 🌐 Zig | 📅 2026-08-19 - A high performance machine learning stack for Zig.
...
* [ggml-zig](https://github.com/codingonion/ggml-zig) - A replacement for [ggml: Tensor library for machine learning](https://github.com/ggerganov/ggml) ⭐ 15,201 | 🐛 347 | 🌐 C++ | 📅 2026-08-18 written in Zig.

### Large Language Model

* [nullclaw/nullclaw](https://github.com/nullclaw/nullclaw) ⭐ 8,034 | 🐛 87 | 🌐 Zig | 📅 2026-07-19 - Fastest, smallest, and fully autonomous AI assistant infrastructure written in Zig.
* [ddalcu/mlx-serve](https://github.com/ddalcu/mlx-serve) ⭐ 745 | 🐛 31 | 🌐 Zig | 📅 2026-08-19 - Native LLM inference server for Apple Silicon (MLX + GGUF) with OpenAI- and Anthropic-compatible APIs; ships MLX Core, a macOS menu-bar app. MIT.
...
* [EugenHotaj/zig\_gpt2](https://github.com/EugenHotaj/zig_gpt2) ⭐ 39 | 🐛 0 | 🌐 Zig | 📅 2023-07-24 - Neural Network Inference Engine in Zig. GPT2 inference engine written in Zig. The inference engine can run [NanoGPT](https://github.com/karpathy/nanoGPT) ⭐ 62,207 | 🐛 351 | 🌐 Python | 📅 2025-11-12.
...
* [anomalyco/opentui](https://github.com/anomalyco/opentui) ⭐ 13,080 | 🐛 219 | 🌐 TypeScript | 📅 2026-08-19 - A library for building terminal user interfaces.
...
* [fabioarnold/nanovg-zig](https://github.com/fabioarnold/nanovg-zig) ⭐ 246 | 🐛 1 | 🌐 C | 📅 2026-01-29 - [NanoVG](https://github.com/memononen/nanovg) ⭐ 5,692 | 🐛 321 | 🌐 C | 📅 2026-02-19 - Zig Version. A small anti-aliased hardware-accelerated vector graphics library. [fabioarnold.github.io/nanovg-zig/](https://fabioarnold.github.io/nanovg-zig/).
...
* [david-vanderson/dvui](https://github.com/david-vanderson/dvui) ⭐ 1,632 | 🐛 97 | 🌐 Zig | 📅 2026-08-19 - Easy to Integrate Immediate Mode GUI for Zig.
...
* [dmtrKovalenko/odiff](https://github.com/dmtrKovalenko/odiff) ⭐ 3,158 | 🐛 17 | 🌐 Zig | 📅 2026-07-23 - ODiff - A very fast SIMD-first image comparison library (with Node.js API).
...
* [raylib](https://github.com/raysan5/raylib/) ⭐ 34,396 | 🐛 31 | 🌐 C | 📅 2026-08-18 - A simple and easy-to-use library to enjoy videogames programming.
