...
* [zigtools/zls](https://github.com/zigtools/zls) ⭐ 5,134 | 🐛 169 | 🌐 Zig | 📅 2026-09-11 - The @ziglang language server for all your Zig editor tooling needs, from autocomplete to goto-def! [installation](https://zigtools.org/zls/install/).
* [neurocyte/flow](https://github.com/neurocyte/flow) ⭐ 2,381 | 🐛 79 | 🌐 Zig | 📅 2026-09-18 - Flow Control - a programmer's text editor written in Zig.
...
* [DonIsaac/zlint](https://github.com/DonIsaac/zlint) ⭐ 311 | 🐛 32 | 🌐 Zig | 📅 2026-09-17 - Linter for the Zig programming language.
...
* [forketyfork/zwanzig](https://github.com/forketyfork/zwanzig) ⭐ 30 | 🐛 1 | 🌐 Zig | 📅 2026-09-18 - Static analyzer for Zig with CFG-based checks (leaks, double-free, optional unwrap, stack escapes).
...
* [justrach/nanobrew](https://github.com/justrach/nanobrew) ⭐ 1,121 | 🐛 3 | 🌐 Zig | 📅 2026-09-18 - A fast macOS package manager written in Zig.
* [tristanisham/zvm](https://github.com/tristanisham/zvm) ⭐ 1,063 | 🐛 3 | 🌐 Go | 📅 2026-09-17 - Lets you easily install/upgrade between different versions of Zig. ZLS install can be included. (written in Go).
* [nektro/zigmod](https://github.com/nektro/zigmod) ⭐ 946 | 🐛 18 | 🌐 Zig | 📅 2026-09-04 - A package manager for the Zig programming language.
* [mitchellh/zig-overlay](https://github.com/mitchellh/zig-overlay) ⭐ 548 | 🐛 10 | 🌐 Nix | 📅 2026-09-17 - Nix flake for the Zig compiler.
...
* [Cloudef/zig2nix](https://github.com/Cloudef/zig2nix) ⭐ 191 | 🐛 7 | 🌐 Zig | 📅 2026-09-18 - Flake for packaging, building and running Zig projects.
* [indaco/malt](https://github.com/indaco/malt) ⭐ 166 | 🐛 0 | 🌐 Zig | 📅 2026-09-18 - Homebrew's whole ecosystem, none of its weight: a single Zig binary with native post\_install and a themeable TUI and CLI.
...
* [asdf-community/asdf-zig](https://github.com/asdf-community/asdf-zig) ⭐ 82 | 🐛 1 | 🌐 Python | 📅 2026-08-14 - Zig plugin for the [asdf](https://github.com/asdf-vm/asdf) ⭐ 25,591 | 🐛 145 | 🌐 Go | 📅 2026-09-03 version manager.
...
* [ghostty](https://github.com/ghostty-org/ghostty) ⭐ 61,248 | 🐛 258 | 🌐 Zig | 📅 2026-09-18 - Modern terminal emulator written in Zig.
* [NilsIrl/dockerc](https://github.com/NilsIrl/dockerc) ⭐ 4,918 | 🐛 25 | 🌐 Zig | 📅 2025-01-02 - Container image to single executable compiler.
* [zmx](https://github.com/neurosnap/zmx) ⭐ 2,155 | 🐛 27 | 🌐 Zig | 📅 2026-09-12 - Session persistence for terminal processes.
* [Illusionna/LocalTransfer](https://github.com/Illusionna/LocalTransfer) ⭐ 607 | 🐛 0 | 🌐 Zig | 📅 2026-09-03 - A fast cross-platform HTTP file server.
...
* [midasdf/zt](https://github.com/midasdf/zt) ⭐ 69 | 🐛 0 | 🌐 Zig | 📅 2026-07-04 - Ultra-fast, minimal terminal emulator written in Zig with fbdev, X11, Wayland, and macOS backends.
...
* [bare-devcontainer/templates](https://github.com/bare-devcontainer/templates/tree/main/src/zig) ⭐ 1 | 🐛 1 | 🌐 Shell | 📅 2026-09-17 - Security-focused Zig dev container with zls integration and a persistent build cache. The base image is available at [bare-devcontainer/images](https://github.com/bare-devcontainer/images/tree/main/zig) ⭐ 2 | 🐛 1 | 🌐 Shell | 📅 2026-09-18.
...
* [deatil/zig-rsa](https://github.com/deatil/zig-rsa) ⭐ 0 | 🐛 0 | 🌐 Zig | 📅 2026-09-18 - An RSA library for Zig. No-AI.
...
* [dweiller/zimalloc](https://github.com/dweiller/zimalloc) ⭐ 48 | 🐛 7 | 🌐 Zig | 📅 2025-10-07 - A general purpose allocator for Zig, inspired by [mimalloc](https://github.com/microsoft/mimalloc) ⭐ 13,372 | 🐛 299 | 🌐 C | 📅 2026-09-17.
...
* [hello-algo-zig](https://github.com/codingonion/hello-algo-zig) ⭐ 82 | 🐛 0 | 🌐 Zig | 📅 2023-07-16 - Zig programming language codes for the famous public project [《Hello, Algorithm》|《 Hello，算法 》](https://github.com/krahets/hello-algo) ⭐ 130,250 | 🐛 40 | 🌐 Java | 📅 2026-08-17 about data structures and algorithms.
...
* [nDimensional/zig-flatbuffers](https://github.com/nDimensional/zig-flatbuffers) ⭐ 11 | 🐛 2 | 🌐 Zig | 📅 2026-06-01 - FlatBuffers codegen for Zig, in Zig.
...
* [pedronaugusto/strand](https://github.com/pedronaugusto/strand) ⭐ 0 | 🐛 0 | 🌐 Zig | 📅 2026-09-14 - Typed JSON Lines for Zig: one JSON value per line, read and written for append-only logs, line protocols and event streams. AI-assisted.
...
* [scento/zig-date](https://github.com/scento/zig-date) ⭐ 7 | 🐛 0 | 🌐 Zig | 📅 2023-03-26 - Time and date for Zig. Zig-date is a date and time library for the Zig, inspired by the popular Rust library [chrono](https://github.com/chronotope/chrono) ⭐ 3,909 | 🐛 193 | 🌐 Rust | 📅 2026-09-07.
...
* [Hejsil/zig-clap](https://github.com/Hejsil/zig-clap) ⭐ 1,619 | 🐛 7 | 🌐 Zig | 📅 2026-08-31 - A simple and easy to use command line argument parser library for Zig.
* [sam701/zig-cli](https://github.com/sam701/zig-cli) ⭐ 354 | 🐛 8 | 🌐 Zig | 📅 2026-08-30 - A simple package for building command line apps in Zig.
...
* [mitchellh/libxev](https://github.com/mitchellh/libxev) ⭐ 3,582 | 🐛 66 | 🌐 Zig | 📅 2026-07-17 - A cross-platform, high-performance event loop that provides abstractions for non-blocking IO, timers, events, and more and works on Linux (io\_uring or epoll), macOS (kqueue), and WebAssembly + WASI. Available as both a Zig and C API.
...
* [ZigEmbeddedGroup/microzig](https://github.com/ZigEmbeddedGroup/microzig) ⭐ 2,280 | 🐛 82 | 🌐 Zig | 📅 2026-09-16 - Unified abstraction layer and HAL for several microcontrollers.
...
* [lupyuen/pinephone-nuttx](https://github.com/lupyuen/pinephone-nuttx) ⭐ 102 | 🐛 0 | 🌐 Zig | 📅 2026-09-18 - Apache NuttX RTOS for PinePhone. Apache NuttX is a lightweight Real-Time Operating System (RTOS) that runs on PINE64 PinePhone. [lupyuen.github.io/articles/what](https://lupyuen.github.io/articles/what).
...
* [marlersoft/zigwin32](https://github.com/marlersoft/zigwin32) ⭐ 450 | 🐛 30 | 🌐 Zig | 📅 2026-07-23 - A complete autogenerated set of Zig bindings for the Win32 API.
...
* [pedronaugusto/conduit](https://github.com/pedronaugusto/conduit) ⭐ 0 | 🐛 0 | 🌐 Zig | 📅 2026-09-14 - Starts child processes and gives them pseudo-terminals, on a pty in their own session with a window size, or on pipes killed and reaped with a deadline. AI-assisted.
* [pedronaugusto/lookout](https://github.com/pedronaugusto/lookout) ⭐ 0 | 🐛 0 | 🌐 Zig | 📅 2026-09-14 - A file-system watcher for Zig: one Watcher type over each platform's own notification interface, and a polling backend that needs nothing from the kernel. AI-assisted.
* [javiorfo/zig-syslinfo](https://github.com/javiorfo/zig-syslinfo) - Linux sysinfo Zig library.

### Compilers and Interpreters

* [Aro](https://github.com/Vexu/arocc) ⭐ 1,808 | 🐛 47 | 🌐 Zig | 📅 2026-09-16 - A C compiler with the goal of providing fast compilation and low memory usage with good diagnostics.
...
* [Fun](https://github.com/omdxp/fun) ⭐ 359 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-18 - A statically-typed language that transpiles to C, combining safety and performance with C's efficiency.
...
* [sleep3r/mtproto.zig](https://github.com/sleep3r/mtproto.zig) ⭐ 1,894 | 🐛 5 | 🌐 Zig | 📅 2026-09-08 - High-performance Telegram MTProto proxy written in Zig.
* [karlseguin/http.zig](https://github.com/karlseguin/http.zig) ⭐ 1,601 | 🐛 15 | 🌐 Zig | 📅 2026-08-26 - An HTTP/1.1 server for Zig.
* [tardy-org/zzz](https://github.com/tardy-org/zzz) ⭐ 785 | 🐛 18 | 🌐 Zig | 📅 2026-09-16 - A framework for writing performant and reliable networked services in Zig. Supports HTTP and HTTPS.
...
* [YUX/floo](https://github.com/YUX/floo) ⭐ 60 | 🐛 1 | 🌐 Zig | 📅 2026-08-19 - High-throughput, token-authenticated tunneling built in Zig. Multiplexes TCP and UDP services through a Noise-protected transport with 29+ Gbit/s encrypted throughput.
...
* [lightpanda-io/browser](https://github.com/lightpanda-io/browser) ⭐ 35,422 | 🐛 79 | 🌐 Zig | 📅 2026-09-18 - Headless browser designed for AI and automation.

### Web Framework

* [zigzap/zap](https://github.com/zigzap/zap) ⚠️ Archived - Blazingly fast web backends in Zig.
* [kristoff-it/zine](https://github.com/kristoff-it/zine) ⭐ 1,570 | 🐛 56 | 🌐 Zig | 📅 2026-09-03 - Static Site Generator written in Zig.
...
* [karlseguin/websocket.zig](https://github.com/karlseguin/websocket.zig) ⭐ 518 | 🐛 10 | 🌐 Zig | 📅 2026-08-23 - A WebSocket implementation for Zig.
* [nurulhudaapon/zx](https://github.com/nurulhudaapon/zx) ⭐ 337 | 🐛 31 | 🌐 Zig | 📅 2026-09-16 - A full-stack web framework for Zig.
* [zon-dev/zinc](https://github.com/zon-dev/zinc) ⭐ 185 | 🐛 2 | 🌐 Zig | 📅 2026-04-15 - Zinc is a web framework written in pure Zig with a focus on high performance, usability, security, and extensibility.
...
* [im-ng/zero](https://github.com/im-ng/zero) ⭐ 29 | 🐛 2 | 🌐 Zig | 📅 2026-09-18 - Simple and opinionated web framework written in Zig and aims to make microservices development in Zig easier.
...
* [blockblaz/ssz.zig](https://github.com/blockblaz/ssz.zig) ⭐ 34 | 🐛 17 | 🌐 Zig | 📅 2026-09-01 - A Zig implementation of the [SSZ serialization protocol](https://github.com/ethereum/eth2.0-specs/blob/dev/ssz/simple-serialize.md) ⭐ 3,966 | 🐛 66 | 🌐 Python | 📅 2026-09-16.
...
* [zwasm](https://github.com/zwasm/zwasm) ⭐ 179 | 🐛 55 | 🌐 Zig | 📅 2026-09-14 - From-scratch WebAssembly runtime in Zig. Full WebAssembly 3.0 with 100% spec conformance, WASI 0.1/0.2/0.3, and interpreter + JIT (arm64/x86\_64) + AOT backends.
...
* [tigerbeetle](https://github.com/tigerbeetle/tigerbeetle) ⭐ 17,040 | 🐛 109 | 🌐 Zig | 📅 2026-08-31 - The distributed financial accounting database designed for mission critical safety and performance. [tigerbeetle.com](https://tigerbeetle.com/).
...
* [karlseguin/pg.zig](https://github.com/karlseguin/pg.zig) ⭐ 596 | 🐛 5 | 🌐 Zig | 📅 2026-09-18 - Native PostgreSQL driver / client for Zig.
...
* [pedronaugusto/chronicle](https://github.com/pedronaugusto/chronicle) ⭐ 0 | 🐛 0 | 🌐 Zig | 📅 2026-09-14 - An append-only event log for Zig, where a journal is a directory of segment files holding one JSON object per line. AI-assisted.
...
* [zml](https://github.com/zml/zml) ⭐ 4,064 | 🐛 51 | 🌐 Zig | 📅 2026-09-18 - A high performance machine learning stack for Zig.
* [Zigrad](https://github.com/Marco-Christiani/zigrad) ⭐ 195 | 🐛 14 | 🌐 Zig | 📅 2026-09-13 - A deep learning framework built on an autograd engine with high level abstractions and low level control. Trains neural networks 2.5x faster than PyTorch on Apple Silicon and 1.5x faster on CPU.
...
* [ggml-zig](https://github.com/codingonion/ggml-zig) - A replacement for [ggml: Tensor library for machine learning](https://github.com/ggerganov/ggml) ⭐ 15,369 | 🐛 363 | 🌐 C++ | 📅 2026-09-14 written in Zig.

### Large Language Model

* [nullclaw/nullclaw](https://github.com/nullclaw/nullclaw) ⭐ 8,098 | 🐛 95 | 🌐 Zig | 📅 2026-07-19 - Fastest, smallest, and fully autonomous AI assistant infrastructure written in Zig.
* [ddalcu/mlx-serve](https://github.com/ddalcu/mlx-serve) ⭐ 1,379 | 🐛 42 | 🌐 Zig | 📅 2026-09-18 - Native LLM inference server for Apple Silicon (MLX + GGUF) with OpenAI- and Anthropic-compatible APIs; ships MLX Core, a macOS menu-bar app. MIT.
...
* [EugenHotaj/zig\_gpt2](https://github.com/EugenHotaj/zig_gpt2) ⭐ 40 | 🐛 0 | 🌐 Zig | 📅 2023-07-24 - Neural Network Inference Engine in Zig. GPT2 inference engine written in Zig. The inference engine can run [NanoGPT](https://github.com/karpathy/nanoGPT) ⭐ 63,202 | 🐛 349 | 🌐 Python | 📅 2025-11-12.
...
* [MasterQ32/zig-network](https://github.com/MasterQ32/zig-network) ⭐ 639 | 🐛 17 | 🌐 Zig | 📅 2025-12-23 - A smallest-common-subset of socket functions for crossplatform networking, TCP & UDP.
...
* [anomalyco/opentui](https://github.com/anomalyco/opentui) ⭐ 13,338 | 🐛 145 | 🌐 TypeScript | 📅 2026-09-18 - A library for building terminal user interfaces.
* [rockorager/libvaxis](https://github.com/rockorager/libvaxis) ⭐ 2,008 | 🐛 34 | 🌐 Zig | 📅 2026-09-08 - Modern TUI library written in Zig.
...
* [vancluever/z2d](https://github.com/vancluever/z2d) ⭐ 298 | 🐛 11 | 🌐 Zig | 📅 2026-09-18 - A pure Zig 2D graphics library.
* [fabioarnold/nanovg-zig](https://github.com/fabioarnold/nanovg-zig) ⭐ 246 | 🐛 1 | 🌐 C | 📅 2026-01-29 - [NanoVG](https://github.com/memononen/nanovg) ⭐ 5,704 | 🐛 321 | 🌐 C | 📅 2026-02-19 - Zig Version. A small anti-aliased hardware-accelerated vector graphics library. [fabioarnold.github.io/nanovg-zig/](https://fabioarnold.github.io/nanovg-zig/).
...
* [pedronaugusto/morse](https://github.com/pedronaugusto/morse) ⭐ 0 | 🐛 0 | 🌐 Zig | 📅 2026-09-14 - Writes terminal control sequences and parses the bytes a terminal sends back: keys, mouse reports, and the replies to questions a program asks. AI-assisted.
...
* [david-vanderson/dvui](https://github.com/david-vanderson/dvui) ⭐ 1,662 | 🐛 105 | 🌐 Zig | 📅 2026-09-18 - Easy to Integrate Immediate Mode GUI for Zig.
...
* [meszmate/zigzag](https://github.com/meszmate/zigzag) ⭐ 555 | 🐛 8 | 🌐 Zig | 📅 2026-09-03 - The TUI Framework for Zig.
* [rcalixte/libqt6zig](https://github.com/rcalixte/libqt6zig) ⭐ 268 | 🐛 0 | 🌐 Zig | 📅 2026-09-17 - Qt 6 for Zig.
...
* [PixelGuys/Cubyz](https://github.com/PixelGuys/Cubyz) ⭐ 3,665 | 🐛 913 | 🌐 Zig | 📅 2026-09-17 - Voxel sandbox game with a large render distance, procedurally generated content and some cool graphical effects.
...
* [foxnne/aftersun](https://github.com/foxnne/aftersun) ⭐ 304 | 🐛 3 | 🌐 Zig | 📅 2024-06-10 - Top-down 2D RPG.
...
* [dmtrKovalenko/odiff](https://github.com/dmtrKovalenko/odiff) ⭐ 3,199 | 🐛 15 | 🌐 Zig | 📅 2026-08-24 - ODiff - A very fast SIMD-first image comparison library (with Node.js API).
...
* [bfactory-ai/zignal](https://github.com/bfactory-ai/zignal) ⭐ 459 | 🐛 0 | 🌐 Zig | 📅 2026-09-17 - Image processing library in Zig, heavily inspired by dlib.
...
* [floooh/sokol-zig](https://github.com/floooh/sokol-zig) ⭐ 729 | 🐛 13 | 🌐 C | 📅 2026-09-14 - Zig bindings for the sokol headers.
...
* [raylib](https://github.com/raysan5/raylib/) ⭐ 34,780 | 🐛 13 | 🌐 C | 📅 2026-09-18 - A simple and easy-to-use library to enjoy videogames programming.
