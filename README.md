...
* [zigtools/zls](https://github.com/zigtools/zls) ⭐ 5,106 | 🐛 168 | 🌐 Zig | 📅 2026-08-14 - The @ziglang language server for all your Zig editor tooling needs, from autocomplete to goto-def! [installation](https://zigtools.org/zls/install/).
* [neurocyte/flow](https://github.com/neurocyte/flow) ⭐ 2,200 | 🐛 78 | 🌐 Zig | 📅 2026-08-29 - Flow Control - a programmer's text editor written in Zig.
...
* [tristanisham/zvm](https://github.com/tristanisham/zvm) ⭐ 1,053 | 🐛 3 | 🌐 Go | 📅 2026-09-02 - Lets you easily install/upgrade between different versions of Zig. ZLS install can be included. (written in Go).
* [nektro/zigmod](https://github.com/nektro/zigmod) ⭐ 941 | 🐛 19 | 🌐 Zig | 📅 2026-06-10 - A package manager for the Zig programming language.
* [mitchellh/zig-overlay](https://github.com/mitchellh/zig-overlay) ⭐ 542 | 🐛 10 | 🌐 Nix | 📅 2026-09-02 - Nix flake for the Zig compiler.
...
* [Cloudef/zig2nix](https://github.com/Cloudef/zig2nix) ⭐ 188 | 🐛 6 | 🌐 Zig | 📅 2026-09-02 - Flake for packaging, building and running Zig projects.
...
* [asdf-community/asdf-zig](https://github.com/asdf-community/asdf-zig) ⭐ 82 | 🐛 0 | 🌐 Python | 📅 2026-08-14 - Zig plugin for the [asdf](https://github.com/asdf-vm/asdf) ⭐ 25,561 | 🐛 154 | 🌐 Go | 📅 2026-09-01 version manager.
...
* [ghostty](https://github.com/ghostty-org/ghostty) ⭐ 60,589 | 🐛 246 | 🌐 Zig | 📅 2026-09-02 - Modern terminal emulator written in Zig.
* [NilsIrl/dockerc](https://github.com/NilsIrl/dockerc) ⭐ 4,916 | 🐛 25 | 🌐 Zig | 📅 2025-01-02 - Container image to single executable compiler.
* [zmx](https://github.com/neurosnap/zmx) ⭐ 2,109 | 🐛 20 | 🌐 Zig | 📅 2026-08-30 - Session persistence for terminal processes.
* [Illusionna/LocalTransfer](https://github.com/Illusionna/LocalTransfer) ⭐ 579 | 🐛 1 | 🌐 Zig | 📅 2026-08-09 - A fast cross-platform HTTP file server.
...
* [forketyfork/architect](https://github.com/forketyfork/architect) ⭐ 50 | 🐛 9 | 🌐 Zig | 📅 2026-09-02 - A flexible terminal grid for multi-agent AI workflows.
...
* [bare-devcontainer/templates](https://github.com/bare-devcontainer/templates/tree/main/src/zig) ⭐ 1 | 🐛 1 | 🌐 Shell | 📅 2026-09-02 - Security-focused Zig dev container with zls integration and a persistent build cache. The base image is available at [bare-devcontainer/images](https://github.com/bare-devcontainer/images/tree/main/zig) ⭐ 2 | 🐛 4 | 🌐 Shell | 📅 2026-09-02.
...
* [andrewrk/poop](https://github.com/andrewrk/poop) ⭐ 2,034 | 🐛 29 | 🌐 Zig | 📅 2026-05-04 - CLI Performance Observer written in Zig.
...
* [dweiller/zimalloc](https://github.com/dweiller/zimalloc) ⭐ 48 | 🐛 7 | 🌐 Zig | 📅 2025-10-07 - A general purpose allocator for Zig, inspired by [mimalloc](https://github.com/microsoft/mimalloc) ⭐ 13,346 | 🐛 310 | 🌐 C | 📅 2026-09-01.
...
* [hello-algo-zig](https://github.com/codingonion/hello-algo-zig) ⭐ 82 | 🐛 0 | 🌐 Zig | 📅 2023-07-16 - Zig programming language codes for the famous public project [《Hello, Algorithm》|《 Hello，算法 》](https://github.com/krahets/hello-algo) ⭐ 129,762 | 🐛 42 | 🌐 Java | 📅 2026-08-17 about data structures and algorithms.
...
* [ezequielramis/zimdjson](https://github.com/ezequielramis/zimdjson) ⭐ 173 | 🐛 9 | 🌐 Zig | 📅 2026-04-18 - Parsing gigabytes of JSON per second. Zig port of simdjson with fundamental features.
...
* [sam701/zig-toml](https://github.com/sam701/zig-toml) ⭐ 133 | 🐛 5 | 🌐 Zig | 📅 2026-08-07 - Zig TOML (v1.0.0) parser.
...
* [rockorager/zeit](https://github.com/rockorager/zeit) ⭐ 234 | 🐛 5 | 🌐 Zig | 📅 2026-08-17 - Generic date/time library, including time zone loading and conversion.
...
* [scento/zig-date](https://github.com/scento/zig-date) ⭐ 7 | 🐛 0 | 🌐 Zig | 📅 2023-03-26 - Time and date for Zig. Zig-date is a date and time library for the Zig, inspired by the popular Rust library [chrono](https://github.com/chronotope/chrono) ⭐ 3,904 | 🐛 194 | 🌐 Rust | 📅 2026-08-03.
...
* [Hejsil/zig-clap](https://github.com/Hejsil/zig-clap) ⭐ 1,605 | 🐛 7 | 🌐 Zig | 📅 2026-08-31 - A simple and easy to use command line argument parser library for Zig.
...
* [mitchellh/libxev](https://github.com/mitchellh/libxev) ⭐ 3,579 | 🐛 60 | 🌐 Zig | 📅 2026-07-17 - A cross-platform, high-performance event loop that provides abstractions for non-blocking IO, timers, events, and more and works on Linux (io\_uring or epoll), macOS (kqueue), and WebAssembly + WASI. Available as both a Zig and C API.
...
* [ZigEmbeddedGroup/microzig](https://github.com/ZigEmbeddedGroup/microzig) ⭐ 2,272 | 🐛 80 | 🌐 Zig | 📅 2026-08-31 - Unified abstraction layer and HAL for several microcontrollers.
...
* [lupyuen/pinephone-nuttx](https://github.com/lupyuen/pinephone-nuttx) ⭐ 102 | 🐛 0 | 🌐 Zig | 📅 2026-09-02 - Apache NuttX RTOS for PinePhone. Apache NuttX is a lightweight Real-Time Operating System (RTOS) that runs on PINE64 PinePhone. [lupyuen.github.io/articles/what](https://lupyuen.github.io/articles/what).
...
* [Element 0](https://github.com/Element0Lang/element-0) ⭐ 29 | 🐛 3 | 🌐 Zig | 📅 2026-08-30 - A small embeddable Lisp dialect written in Zig.
* [Fun](https://github.com/omdxp/fun) ⭐ 25 | 🐛 1 | 🌐 Zig | 📅 2026-09-02 - A statically-typed language that transpiles to C, combining safety and performance with C's efficiency.
* [fury](https://github.com/fury-lang/fury) ⭐ 15 | 🐛 10 | 🌐 Zig | 📅 2025-03-11 - A gradual, safe systems language.
* [zish](https://github.com/rotkonetworks/zish) ⭐ 7 | 🐛 0 | 🌐 Zig | 📅 2026-08-30 - An opinionated shell written in Zig.
...
* [karlseguin/http.zig](https://github.com/karlseguin/http.zig) ⭐ 1,593 | 🐛 15 | 🌐 Zig | 📅 2026-08-26 - An HTTP/1.1 server for Zig.
* [sleep3r/mtproto.zig](https://github.com/sleep3r/mtproto.zig) ⭐ 1,570 | 🐛 0 | 🌐 Zig | 📅 2026-08-27 - High-performance Telegram MTProto proxy written in Zig.
* [tardy-org/zzz](https://github.com/tardy-org/zzz) ⭐ 776 | 🐛 17 | 🌐 Zig | 📅 2026-09-01 - A framework for writing performant and reliable networked services in Zig. Supports HTTP and HTTPS.
...
* [lightpanda-io/browser](https://github.com/lightpanda-io/browser) ⭐ 34,376 | 🐛 95 | 🌐 Zig | 📅 2026-09-02 - Headless browser designed for AI and automation.

### Web Framework

* [zigzap/zap](https://github.com/zigzap/zap) ⭐ 3,415 | 🐛 29 | 🌐 C | 📅 2026-06-01 - Blazingly fast web backends in Zig.
* [kristoff-it/zine](https://github.com/kristoff-it/zine) ⭐ 1,552 | 🐛 54 | 🌐 Zig | 📅 2026-09-02 - Static Site Generator written in Zig.
* [jetzig-framework/jetzig](https://github.com/jetzig-framework/jetzig) ⭐ 1,510 | 🐛 40 | 🌐 Zig | 📅 2026-06-12 - Jetzig is a web framework written in Zig.
...
* [uzyn/passcay](https://github.com/uzyn/passcay) ⭐ 38 | 🐛 0 | 🌐 Zig | 📅 2026-06-23 - Secure Passkey authentication (WebAuthn) library for Zig.
...
* [im-ng/zero](https://github.com/im-ng/zero) ⭐ 21 | 🐛 3 | 🌐 Zig | 📅 2026-09-01 - Simple and opinionated web framework written in Zig and aims to make microservices development in Zig easier.
...
* [StrobeLabs/eth.zig](https://github.com/StrobeLabs/eth.zig) ⭐ 82 | 🐛 15 | 🌐 C | 📅 2026-08-19 - Pure Zig Ethereum client library. Zero dependencies, comptime-first.
...
* [blockblaz/ssz.zig](https://github.com/blockblaz/ssz.zig) ⭐ 34 | 🐛 17 | 🌐 Zig | 📅 2026-09-01 - A Zig implementation of the [SSZ serialization protocol](https://github.com/ethereum/eth2.0-specs/blob/dev/ssz/simple-serialize.md) ⭐ 3,959 | 🐛 56 | 🌐 Python | 📅 2026-09-01.
...
* [zwasm](https://github.com/zwasm/zwasm) ⭐ 172 | 🐛 51 | 🌐 Zig | 📅 2026-09-02 - From-scratch WebAssembly runtime in Zig. Full WebAssembly 3.0 with 100% spec conformance, WASI 0.1/0.2/0.3, and interpreter + JIT (arm64/x86\_64) + AOT backends.
...
* [tigerbeetle](https://github.com/tigerbeetle/tigerbeetle) ⭐ 16,942 | 🐛 102 | 🌐 Zig | 📅 2026-08-31 - The distributed financial accounting database designed for mission critical safety and performance. [tigerbeetle.com](https://tigerbeetle.com/).
...
* [Axion](https://github.com/YUX/axion) ⭐ 25 | 🐛 1 | 🌐 Zig | 📅 2025-12-03 - High-Performance, Embeddable Storage Engine for Zig & SQLite.
...
* [zml](https://github.com/zml/zml) ⭐ 4,015 | 🐛 47 | 🌐 Zig | 📅 2026-09-02 - A high performance machine learning stack for Zig.
...
* [ggml-zig](https://github.com/codingonion/ggml-zig) - A replacement for [ggml: Tensor library for machine learning](https://github.com/ggerganov/ggml) ⭐ 15,281 | 🐛 351 | 🌐 C++ | 📅 2026-08-31 written in Zig.

### Large Language Model

* [nullclaw/nullclaw](https://github.com/nullclaw/nullclaw) ⭐ 8,059 | 🐛 93 | 🌐 Zig | 📅 2026-07-19 - Fastest, smallest, and fully autonomous AI assistant infrastructure written in Zig.
* [ddalcu/mlx-serve](https://github.com/ddalcu/mlx-serve) ⭐ 1,073 | 🐛 47 | 🌐 Zig | 📅 2026-09-01 - Native LLM inference server for Apple Silicon (MLX + GGUF) with OpenAI- and Anthropic-compatible APIs; ships MLX Core, a macOS menu-bar app. MIT.
...
* [EugenHotaj/zig\_gpt2](https://github.com/EugenHotaj/zig_gpt2) ⭐ 40 | 🐛 0 | 🌐 Zig | 📅 2023-07-24 - Neural Network Inference Engine in Zig. GPT2 inference engine written in Zig. The inference engine can run [NanoGPT](https://github.com/karpathy/nanoGPT) ⭐ 62,730 | 🐛 348 | 🌐 Python | 📅 2025-11-12.
...
* [anomalyco/opentui](https://github.com/anomalyco/opentui) ⭐ 13,208 | 🐛 136 | 🌐 TypeScript | 📅 2026-09-02 - A library for building terminal user interfaces.
* [rockorager/libvaxis](https://github.com/rockorager/libvaxis) ⭐ 1,986 | 🐛 35 | 🌐 Zig | 📅 2026-08-20 - Modern TUI library written in Zig.
...
* [andrewrk/zig-vulkan-triangle](https://github.com/andrewrk/zig-vulkan-triangle) ⭐ 159 | 🐛 0 | 🌐 Zig | 📅 2026-07-02 - Simple triangle displayed using Vulkan, glfw, and Zig.
...
* [Capy](https://github.com/capy-ui/capy) ⭐ 2,685 | 🐛 25 | 🌐 Zig | 📅 2025-12-25 - Build one codebase and get native UI on Windows, Linux and Web. [capy-ui.org](https://capy-ui.org/).
* [david-vanderson/dvui](https://github.com/david-vanderson/dvui) ⭐ 1,647 | 🐛 100 | 🌐 Zig | 📅 2026-08-31 - Easy to Integrate Immediate Mode GUI for Zig.
...
* [meszmate/zigzag](https://github.com/meszmate/zigzag) ⭐ 536 | 🐛 2 | 🌐 Zig | 📅 2026-08-28 - The TUI Framework for Zig.
...
* [PixelGuys/Cubyz](https://github.com/PixelGuys/Cubyz) ⭐ 3,645 | 🐛 935 | 🌐 Zig | 📅 2026-08-30 - Voxel sandbox game with a large render distance, procedurally generated content and some cool graphical effects.
...
* [dmtrKovalenko/odiff](https://github.com/dmtrKovalenko/odiff) ⭐ 3,180 | 🐛 15 | 🌐 Zig | 📅 2026-08-24 - ODiff - A very fast SIMD-first image comparison library (with Node.js API).
...
* [freref/fancy-cat](https://github.com/freref/fancy-cat) ⭐ 560 | 🐛 20 | 🌐 Zig | 📅 2026-08-03 - PDF reader inside the terminal.
* [bfactory-ai/zignal](https://github.com/bfactory-ai/zignal) ⭐ 461 | 🐛 0 | 🌐 Zig | 📅 2026-09-01 - Image processing library in Zig, heavily inspired by dlib.
...
* [raylib](https://github.com/raysan5/raylib/) ⭐ 34,555 | 🐛 15 | 🌐 C | 📅 2026-09-02 - A simple and easy-to-use library to enjoy videogames programming.
