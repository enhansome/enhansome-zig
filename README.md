...
* [zigtools/zls](https://github.com/zigtools/zls) ⭐ 5,110 | 🐛 168 | 🌐 Zig | 📅 2026-09-04 - The @ziglang language server for all your Zig editor tooling needs, from autocomplete to goto-def! [installation](https://zigtools.org/zls/install/).
* [neurocyte/flow](https://github.com/neurocyte/flow) ⭐ 2,208 | 🐛 79 | 🌐 Zig | 📅 2026-08-29 - Flow Control - a programmer's text editor written in Zig.
...
* [DonIsaac/zlint](https://github.com/DonIsaac/zlint) ⭐ 309 | 🐛 35 | 🌐 Zig | 📅 2026-08-23 - Linter for the Zig programming language.
...
* [justrach/nanobrew](https://github.com/justrach/nanobrew) ⭐ 1,113 | 🐛 14 | 🌐 Zig | 📅 2026-08-15 - A fast macOS package manager written in Zig.
* [tristanisham/zvm](https://github.com/tristanisham/zvm) ⭐ 1,055 | 🐛 3 | 🌐 Go | 📅 2026-09-05 - Lets you easily install/upgrade between different versions of Zig. ZLS install can be included. (written in Go).
* [nektro/zigmod](https://github.com/nektro/zigmod) ⭐ 943 | 🐛 18 | 🌐 Zig | 📅 2026-09-04 - A package manager for the Zig programming language.
* [mitchellh/zig-overlay](https://github.com/mitchellh/zig-overlay) ⭐ 542 | 🐛 10 | 🌐 Nix | 📅 2026-09-05 - Nix flake for the Zig compiler.
* [mlugg/setup-zig](https://github.com/mlugg/setup-zig) ⭐ 237 | 🐛 2 | 🌐 JavaScript | 📅 2026-01-19 - Install a Zig compiler for usage in GitHub Actions workflows.
* [Cloudef/zig2nix](https://github.com/Cloudef/zig2nix) ⭐ 190 | 🐛 6 | 🌐 Zig | 📅 2026-09-05 - Flake for packaging, building and running Zig projects.
...
* [asdf-community/asdf-zig](https://github.com/asdf-community/asdf-zig) ⭐ 82 | 🐛 0 | 🌐 Python | 📅 2026-08-14 - Zig plugin for the [asdf](https://github.com/asdf-vm/asdf) ⭐ 25,564 | 🐛 144 | 🌐 Go | 📅 2026-09-03 version manager.
...
* [ghostty](https://github.com/ghostty-org/ghostty) ⭐ 60,726 | 🐛 244 | 🌐 Zig | 📅 2026-09-04 - Modern terminal emulator written in Zig.
* [NilsIrl/dockerc](https://github.com/NilsIrl/dockerc) ⭐ 4,917 | 🐛 25 | 🌐 Zig | 📅 2025-01-02 - Container image to single executable compiler.
* [zmx](https://github.com/neurosnap/zmx) ⭐ 2,114 | 🐛 22 | 🌐 Zig | 📅 2026-09-05 - Session persistence for terminal processes.
* [Illusionna/LocalTransfer](https://github.com/Illusionna/LocalTransfer) ⭐ 583 | 🐛 0 | 🌐 Zig | 📅 2026-09-03 - A fast cross-platform HTTP file server.
...
* [zlist](https://github.com/here-Leslie-Lau/zlist) ⭐ 60 | 🐛 3 | 🌐 Zig | 📅 2026-09-01 - A simple, colorful alternative to ls built with Zig.
...
* [bare-devcontainer/templates](https://github.com/bare-devcontainer/templates/tree/main/src/zig) ⭐ 1 | 🐛 3 | 🌐 Shell | 📅 2026-09-05 - Security-focused Zig dev container with zls integration and a persistent build cache. The base image is available at [bare-devcontainer/images](https://github.com/bare-devcontainer/images/tree/main/zig) ⭐ 2 | 🐛 2 | 🌐 Shell | 📅 2026-09-05.
...
* [andrewrk/poop](https://github.com/andrewrk/poop) ⭐ 2,035 | 🐛 29 | 🌐 Zig | 📅 2026-05-04 - CLI Performance Observer written in Zig.
...
* [dweiller/zimalloc](https://github.com/dweiller/zimalloc) ⭐ 48 | 🐛 7 | 🌐 Zig | 📅 2025-10-07 - A general purpose allocator for Zig, inspired by [mimalloc](https://github.com/microsoft/mimalloc) ⭐ 13,350 | 🐛 307 | 🌐 C | 📅 2026-09-04.
...
* [hello-algo-zig](https://github.com/codingonion/hello-algo-zig) ⭐ 82 | 🐛 0 | 🌐 Zig | 📅 2023-07-16 - Zig programming language codes for the famous public project [《Hello, Algorithm》|《 Hello，算法 》](https://github.com/krahets/hello-algo) ⭐ 129,877 | 🐛 42 | 🌐 Java | 📅 2026-08-17 about data structures and algorithms.
...
* [Arwalk/zig-protobuf](https://github.com/Arwalk/zig-protobuf) ⭐ 429 | 🐛 22 | 🌐 Zig | 📅 2026-07-14 - A protobuf 3 implementation for Zig.
...
* [nektro/zig-time](https://github.com/nektro/zig-time) ⭐ 76 | 🐛 1 | 🌐 Zig | 📅 2026-09-01 - A date and time parsing and formatting library for Zig.
...
* [Hejsil/zig-clap](https://github.com/Hejsil/zig-clap) ⭐ 1,608 | 🐛 7 | 🌐 Zig | 📅 2026-08-31 - A simple and easy to use command line argument parser library for Zig.
...
* [mitchellh/libxev](https://github.com/mitchellh/libxev) ⭐ 3,580 | 🐛 60 | 🌐 Zig | 📅 2026-07-17 - A cross-platform, high-performance event loop that provides abstractions for non-blocking IO, timers, events, and more and works on Linux (io\_uring or epoll), macOS (kqueue), and WebAssembly + WASI. Available as both a Zig and C API.
...
* [ZigEmbeddedGroup/microzig](https://github.com/ZigEmbeddedGroup/microzig) ⭐ 2,274 | 🐛 80 | 🌐 Zig | 📅 2026-09-04 - Unified abstraction layer and HAL for several microcontrollers.
...
* [lupyuen/pinephone-nuttx](https://github.com/lupyuen/pinephone-nuttx) ⭐ 102 | 🐛 0 | 🌐 Zig | 📅 2026-09-05 - Apache NuttX RTOS for PinePhone. Apache NuttX is a lightweight Real-Time Operating System (RTOS) that runs on PINE64 PinePhone. [lupyuen.github.io/articles/what](https://lupyuen.github.io/articles/what).
...
* [Aro](https://github.com/Vexu/arocc) ⭐ 1,804 | 🐛 48 | 🌐 Zig | 📅 2026-08-30 - A C compiler with the goal of providing fast compilation and low memory usage with good diagnostics.
...
* [Element 0](https://github.com/Element0Lang/element-0) ⭐ 29 | 🐛 3 | 🌐 Zig | 📅 2026-09-05 - A small embeddable Lisp dialect written in Zig.
* [Fun](https://github.com/omdxp/fun) ⭐ 26 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-05 - A statically-typed language that transpiles to C, combining safety and performance with C's efficiency.
...
* [sleep3r/mtproto.zig](https://github.com/sleep3r/mtproto.zig) ⭐ 1,634 | 🐛 8 | 🌐 Zig | 📅 2026-09-05 - High-performance Telegram MTProto proxy written in Zig.
* [karlseguin/http.zig](https://github.com/karlseguin/http.zig) ⭐ 1,594 | 🐛 15 | 🌐 Zig | 📅 2026-08-26 - An HTTP/1.1 server for Zig.
* [tardy-org/zzz](https://github.com/tardy-org/zzz) ⭐ 777 | 🐛 17 | 🌐 Zig | 📅 2026-09-01 - A framework for writing performant and reliable networked services in Zig. Supports HTTP and HTTPS.
...
* [muhammad-fiaz/httpx.zig](https://github.com/muhammad-fiaz/httpx.zig) ⭐ 88 | 🐛 5 | 🌐 Zig | 📅 2026-08-31 - Production-ready HTTP/1.x/2/3 client and server runtime for Zig with proxy support, concurrency, and protocol primitives.
...
* [lightpanda-io/browser](https://github.com/lightpanda-io/browser) ⭐ 34,438 | 🐛 92 | 🌐 Zig | 📅 2026-09-05 - Headless browser designed for AI and automation.

### Web Framework

* [zigzap/zap](https://github.com/zigzap/zap) ⭐ 3,416 | 🐛 29 | 🌐 C | 📅 2026-06-01 - Blazingly fast web backends in Zig.
* [kristoff-it/zine](https://github.com/kristoff-it/zine) ⭐ 1,560 | 🐛 53 | 🌐 Zig | 📅 2026-09-03 - Static Site Generator written in Zig.
...
* [nurulhudaapon/zx](https://github.com/nurulhudaapon/zx) ⭐ 331 | 🐛 31 | 🌐 Zig | 📅 2026-08-30 - A full-stack web framework for Zig.
...
* [blockblaz/ssz.zig](https://github.com/blockblaz/ssz.zig) ⭐ 34 | 🐛 17 | 🌐 Zig | 📅 2026-09-01 - A Zig implementation of the [SSZ serialization protocol](https://github.com/ethereum/eth2.0-specs/blob/dev/ssz/simple-serialize.md) ⭐ 3,959 | 🐛 57 | 🌐 Python | 📅 2026-09-04.
...
* [zwasm](https://github.com/zwasm/zwasm) ⭐ 172 | 🐛 57 | 🌐 Zig | 📅 2026-09-05 - From-scratch WebAssembly runtime in Zig. Full WebAssembly 3.0 with 100% spec conformance, WASI 0.1/0.2/0.3, and interpreter + JIT (arm64/x86\_64) + AOT backends.
...
* [tigerbeetle](https://github.com/tigerbeetle/tigerbeetle) ⭐ 16,958 | 🐛 103 | 🌐 Zig | 📅 2026-08-31 - The distributed financial accounting database designed for mission critical safety and performance. [tigerbeetle.com](https://tigerbeetle.com/).
...
* [karlseguin/pg.zig](https://github.com/karlseguin/pg.zig) ⭐ 591 | 🐛 4 | 🌐 Zig | 📅 2026-08-26 - Native PostgreSQL driver / client for Zig.
...
* [seqor/seqor](https://github.com/seqor/seqor) ⭐ 60 | 🐛 1 | 🌐 Zig | 📅 2026-08-21 - Seqor is a cost-effective, Loki compatible database for logs.
...
* [zml](https://github.com/zml/zml) ⭐ 4,019 | 🐛 50 | 🌐 Zig | 📅 2026-09-05 - A high performance machine learning stack for Zig.
* [Zigrad](https://github.com/Marco-Christiani/zigrad) ⭐ 196 | 🐛 14 | 🌐 Zig | 📅 2026-08-31 - A deep learning framework built on an autograd engine with high level abstractions and low level control. Trains neural networks 2.5x faster than PyTorch on Apple Silicon and 1.5x faster on CPU.
...
* [ggml-zig](https://github.com/codingonion/ggml-zig) - A replacement for [ggml: Tensor library for machine learning](https://github.com/ggerganov/ggml) ⭐ 15,295 | 🐛 357 | 🌐 C++ | 📅 2026-09-04 written in Zig.

### Large Language Model

* [nullclaw/nullclaw](https://github.com/nullclaw/nullclaw) ⭐ 8,066 | 🐛 93 | 🌐 Zig | 📅 2026-07-19 - Fastest, smallest, and fully autonomous AI assistant infrastructure written in Zig.
* [ddalcu/mlx-serve](https://github.com/ddalcu/mlx-serve) ⭐ 1,127 | 🐛 56 | 🌐 Zig | 📅 2026-09-04 - Native LLM inference server for Apple Silicon (MLX + GGUF) with OpenAI- and Anthropic-compatible APIs; ships MLX Core, a macOS menu-bar app. MIT.
...
* [EugenHotaj/zig\_gpt2](https://github.com/EugenHotaj/zig_gpt2) ⭐ 40 | 🐛 0 | 🌐 Zig | 📅 2023-07-24 - Neural Network Inference Engine in Zig. GPT2 inference engine written in Zig. The inference engine can run [NanoGPT](https://github.com/karpathy/nanoGPT) ⭐ 62,821 | 🐛 348 | 🌐 Python | 📅 2025-11-12.
...
* [MasterQ32/zig-network](https://github.com/MasterQ32/zig-network) ⭐ 641 | 🐛 17 | 🌐 Zig | 📅 2025-12-23 - A smallest-common-subset of socket functions for crossplatform networking, TCP & UDP.
...
* [anomalyco/opentui](https://github.com/anomalyco/opentui) ⭐ 13,241 | 🐛 130 | 🌐 TypeScript | 📅 2026-09-04 - A library for building terminal user interfaces.
* [rockorager/libvaxis](https://github.com/rockorager/libvaxis) ⭐ 1,987 | 🐛 34 | 🌐 Zig | 📅 2026-09-04 - Modern TUI library written in Zig.
...
* [Capy](https://github.com/capy-ui/capy) ⭐ 2,687 | 🐛 25 | 🌐 Zig | 📅 2025-12-25 - Build one codebase and get native UI on Windows, Linux and Web. [capy-ui.org](https://capy-ui.org/).
* [david-vanderson/dvui](https://github.com/david-vanderson/dvui) ⭐ 1,650 | 🐛 99 | 🌐 Zig | 📅 2026-09-03 - Easy to Integrate Immediate Mode GUI for Zig.
...
* [meszmate/zigzag](https://github.com/meszmate/zigzag) ⭐ 539 | 🐛 0 | 🌐 Zig | 📅 2026-09-03 - The TUI Framework for Zig.
* [rcalixte/libqt6zig](https://github.com/rcalixte/libqt6zig) ⭐ 265 | 🐛 0 | 🌐 Zig | 📅 2026-08-31 - Qt 6 for Zig.
...
* [PixelGuys/Cubyz](https://github.com/PixelGuys/Cubyz) ⭐ 3,650 | 🐛 918 | 🌐 Zig | 📅 2026-08-30 - Voxel sandbox game with a large render distance, procedurally generated content and some cool graphical effects.
...
* [bfactory-ai/zignal](https://github.com/bfactory-ai/zignal) ⭐ 461 | 🐛 0 | 🌐 Zig | 📅 2026-09-04 - Image processing library in Zig, heavily inspired by dlib.
...
* [fulcrum-so/ziggy-pydust](https://github.com/fulcrum-so/ziggy-pydust) ⭐ 787 | 🐛 44 | 🌐 Zig | 📅 2026-09-04 - A toolkit for building Python extensions in Zig. [pydust.fulcrum.so/](https://pydust.fulcrum.so/).
* [floooh/sokol-zig](https://github.com/floooh/sokol-zig) ⭐ 725 | 🐛 14 | 🌐 C | 📅 2026-09-04 - Zig bindings for the sokol headers.
* [natecraddock/ziglua](https://github.com/natecraddock/ziglua) ⭐ 520 | 🐛 9 | 🌐 Zig | 📅 2026-09-03 - Zig bindings for the Lua C API.
* [mitchellh/zig-objc](https://github.com/mitchellh/zig-objc) ⭐ 347 | 🐛 3 | 🌐 Zig | 📅 2026-04-17 - Objective-C runtime bindings for Zig (Zig calling ObjC).
...
* [raylib](https://github.com/raysan5/raylib/) ⭐ 34,597 | 🐛 18 | 🌐 C | 📅 2026-09-04 - A simple and easy-to-use library to enjoy videogames programming.
